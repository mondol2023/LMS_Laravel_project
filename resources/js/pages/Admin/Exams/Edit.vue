                ...
                <div class="px-4 py-5 sm:p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="rounded-md bg-gray-50 p-4">
                            <h3 class="mb-2 text-sm font-medium text-gray-900">Exam Information</h3>
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                                <div>
                                    <dt class="text-sm text-gray-500">Created</dt>
                                    <dd class="text-sm text-gray-900">{{ new Date(exam.created_at).toLocaleString() }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm text-gray-500">Current ID</dt>
                                    <dd class="text-sm text-gray-900">{{ exam.exam_id }}</dd>
                                </div>
                            </dl>
                        </div>
