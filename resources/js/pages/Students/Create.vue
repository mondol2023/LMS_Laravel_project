    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="min-h-screen bg-white p-6">
            <div class="mx-auto">
                <!-- Header Section -->
                <div class="mb-8">
                    <h1 class="mb-2 text-4xl font-bold text-gray-900">Add New Student</h1>
                    <p class="text-lg text-gray-600">Register a new student to the system</p>
                </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="col-span-2 mt-8 flex justify-end gap-4 border-t border-gray-200 pt-6">
                            ...
                            <button
                                ...
                                class="inline-flex items-center border border-gray-700 bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-200 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                <svg
                                    v-if="form.processing"
                                    class="mr-3 -ml-1 h-4 w-4 animate-spin text-gray-700"
