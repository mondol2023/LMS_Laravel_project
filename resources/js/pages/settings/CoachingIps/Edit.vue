...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit IP',
        href: `/settings/coaching-ips/${props.coachingIp.id}/edit`,
    },
];
</script>
        ...
        <div class="px-4 py-6 sm:px-6 lg:px-8">
            <div class="mx-auto">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Edit Coaching IP</h1>
                        <p class="mt-1 text-sm text-gray-500">Update coaching center IP address settings</p>
                    </div>
                    <Link
                        href="/settings/coaching-ips"
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                    <Form :action="`/settings/coaching-ips/${coachingIp.id}`" method="put" #default="{ errors, processing }">
