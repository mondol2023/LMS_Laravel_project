...
const partQuestions = Array.from({ length: 13 }, (_, i) => i + 1);
...
<template>
    <Head title="Reading Test 5 - Part 1" />
            ...
            <div class="border-t border-gray-200 bg-white px-2 py-3">
                <div class="flex items-center justify-center">
                    ...
                    <div class="mx-6 flex items-center gap-1">
                        <span class="mr-3 text-base font-bold text-black">Part 1</span>
