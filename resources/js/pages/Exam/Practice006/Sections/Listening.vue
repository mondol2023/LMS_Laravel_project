...
import C19Test2ListeningFooter from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningFooter.vue';
import C19Test2ListeningHeader from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningHeader.vue';
import C19Test2ListeningPart1 from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningPart1.vue';
import C19Test2ListeningPart2 from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningPart2.vue';
import C19Test2ListeningPart3 from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningPart3.vue';
import C19Test2ListeningPart4 from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningPart4.vue';
import C19Test2ListeningReviewModal from '@/components/Exam/Practice/C19/Test2/Listening/C19Test2ListeningReviewModal.vue';
...
// ================================
// Correct answers for Cambridge 19 Test 2 Listening
// ================================
const correctAnswers: Record<number, string> = {
    // Part 1: Guitar Group (Questions 1-10)
    1: 'engineer',
    2: 'podcast',
    3: 'jazz',
    4: 'mother',
    ...
    // Part 2: Lifeboat Volunteer MCQ (Questions 11-16)
    11: 'B',
    12: 'A',
    13: 'C',
    14: 'B',
    15: 'A',
    16: 'C',
    // Part 2: Choose TWO (Questions 17-20)
    17: 'A/D',
    18: 'A/D',
    19: 'B/E',
    20: 'B/E',

    // Part 3: Recycling Footwear (Questions 21-24)
    21: 'C',
    22: 'B',
    23: 'A',
    24: 'C',
    // Part 3: Matching (Questions 25-28)
    25: 'E',
    26: 'B',
    27: 'A',
    28: 'D',
    // Part 3: Multiple Choice (Questions 29-30)
    29: 'B',
    30: 'A',

    // Part 4: Tardigrades (Questions 31-40)
    31: 'bears',
    32: 'claws',
    33: 'moss',
    34: 'vacuum',
...
const handleFocusNote = async (note: { part: string; selectedText: string; start: number; end: number }) => {
    ...
    setTimeout(() => {
        ...
        if (foundMark) {
            ...
            foundMark.classList.add('ring-4', 'ring-cyan-400', 'ring-offset-2', 'transition-all');
            setTimeout(() => {
                foundMark?.classList.remove('ring-4', 'ring-cyan-400', 'ring-offset-2');
            }, 2500);
        } else {
            ...
            for (const contentArea of contentAreas) {
                ...
                while ((node = walker.nextNode())) {
                    ...
                    if (index !== -1 && node.parentElement) {
                        ...
                        tempMark.className = 'bg-cyan-200 ring-4 ring-cyan-400 ring-offset-2 transition-all px-1 rounded';
...
const handleConfirmSubmit = async () => {
    ...
    try {
        ...
        router.post('/practice/results/listening/6', {
...
<template>
    <Head title="C19 Test 2 Listening Section - Nextive Solution" />

    <div class="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-teal-50 text-black">
        <C19Test2ListeningHeader
            :is-time-up="isTimeUp"
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C19Test2ListeningPart1 ref="listeningPart1Ref" :phone="userPhone" :exam-id="examId" :correct-answers="part1CorrectAnswers" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C19Test2ListeningPart2 ref="listeningPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C19Test2ListeningPart3 ref="listeningPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <C19Test2ListeningPart4 ref="listeningPart4Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <C19Test2ListeningFooter
