...
import WritingFooter from '@/components/Exam/WritingGT001/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingGT001/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingGT001/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingGT001/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingGT001/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
  ...
  const questionAnswers = [
        {
            q: 'Mrs Barrett, an English-speaking woman who lives in your town, has advertised for someone to help her in her home for a few hours a day next summer.  Write a letter to Mrs Barrett. In your letter\n\n• suggest how you could help her in her home\n• say why you would like to do this work\n• explain when you will and will not be available',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Plastic bags, plastic bottles and plastic packaging are bad for the environment.  What damage does plastic do to the environment? What can be done by governments and individuals to solve this problem?   Give reasons for your answer and include any relevant examples from your own knowledge or experience.  Write at least 250 words.',
...
const handleForceSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: `Mrs Barrett, an English-speaking woman who lives in your town, has advertised for someone to help her in her home for a few hours a day next summer.
