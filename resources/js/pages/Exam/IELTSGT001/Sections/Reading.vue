...
import ReadingFooter from '@/components/Exam/ReadingGT001/ReadingFooter.vue';
import ReadingHeader from '@/components/Exam/ReadingGT001/ReadingHeader.vue';
import ReadingPart1 from '@/components/Exam/ReadingGT001/ReadingPart1.vue';
import ReadingPart2 from '@/components/Exam/ReadingGT001/ReadingPart2.vue';
import ReadingPart3 from '@/components/Exam/ReadingGT001/ReadingPart3.vue';
import ReadingReviewModal from '@/components/Exam/ReadingGT001/ReadingReviewModal.vue';
import ReadingSubmitModal from '@/components/Exam/ReadingGT001/ReadingSubmitModalIELTS001.vue';
...
const handleScrollToQuestion = async (questionNumber: number) => {
    ...
    else if (questionNumber <= 28) activePart.value = 'part2';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
