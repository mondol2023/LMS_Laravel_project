...
import WritingFooter013 from '@/components/Exam/WritingIELTS013/WritingFooter013.vue';
import WritingHeader013 from '@/components/Exam/WritingIELTS013/WritingHeader013.vue';
import WritingPart1IELTS013 from '@/components/Exam/WritingIELTS013/WritingPart1IELTS013.vue';
import WritingPart2IELTS013 from '@/components/Exam/WritingIELTS013/WritingPart2IELTS013.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The graph and bar chart below show the average monthly rainfall and temperature for one region of East Africa. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Meat Production requires relatively more lands than crop production. Some people think as land is becoming scare, the world’s meat consumption should be reduced. What measures could be taken to reduce world’s meat consumption? What kind of problem such measures caused? Give reasons for your answer and include any relevant examples from your own knowledge or experience. Write at least 250 words.',
...
onMounted(() => {
    ...
    // Store interval ID for cleanup - reduced frequency to prevent UI issues
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }" class="w-full">
            <WritingPart1IELTS013 ref="writingPart1Ref" @word-count-change="handlePart1WordCount" @notes-change="handlePart1NotesChange" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }" class="w-full">
            <WritingPart2IELTS013 ref="writingPart2Ref" @word-count-change="handlePart2WordCount" @notes-change="handlePart2NotesChange" />
        </div>

        <!-- Pass function to footer -->
        <WritingFooter013 :active-part="activePart" @navigate="handleNavigate" />
