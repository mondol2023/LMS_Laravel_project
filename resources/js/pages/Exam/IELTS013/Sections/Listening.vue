...
import ListeningFooterIELTS013 from '@/components/Exam/ListeningIELTS013/ListeningFooterIELTS013.vue';
import ListeningHeaderIELTS013 from '@/components/Exam/ListeningIELTS013/ListeningHeaderIELTS013.vue';
import ListeningPart1IELTS013 from '@/components/Exam/ListeningIELTS013/ListeningPart1IELTS013.vue';
import ListeningPart2IELTS013 from '@/components/Exam/ListeningIELTS013/ListeningPart2IELTS013.vue';
import ListeningPart3IELTS013 from '@/components/Exam/ListeningIELTS013/ListeningPart3IELTS013.vue';
import ListeningPart4IELTS013 from '@/components/Exam/ListeningIELTS013/ListeningPart4IELTS013.vue';
import ListeningReviewModalIELTS013 from '@/components/Exam/ListeningIELTS013/ListeningReviewModalIELTS013.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <ListeningPart1IELTS013 ref="listeningPart1Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <ListeningPart2IELTS013 ref="listeningPart2Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <ListeningPart3IELTS013 ref="listeningPart3Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <ListeningPart4IELTS013 ref="listeningPart4Ref" />
        </div>

        <ListeningFooterIELTS013
