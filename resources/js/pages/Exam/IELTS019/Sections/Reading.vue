...
import ReadingHeaderIELTS019 from '@/components/Exam/ReadingIELTS019/ReadingHeaderIELTS019.vue';
import ReadingPart1IELTS019 from '@/components/Exam/ReadingIELTS019/ReadingPart1IELTS019.vue';
import ReadingPart2IELTS019 from '@/components/Exam/ReadingIELTS019/ReadingPart2IELTS019.vue';
import ReadingPart3IELTS019 from '@/components/Exam/ReadingIELTS019/ReadingPart3IELTS019.vue';
import ReadingFooterIELTS019 from '@/components/Exam/ReadingIELTS019/ReadingFooterIELTS019.vue';
import ReadingReviewModalIELTS019 from '@/components/Exam/ReadingIELTS019/ReadingReviewModalIELTS019.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS019 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS019 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS019 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS019
