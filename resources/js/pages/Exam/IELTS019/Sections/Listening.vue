...
import ListeningHeaderIELTS019 from '@/components/Exam/ListeningIELTS019/ListeningHeaderIELTS019.vue';
import ListeningPart1IELTS019 from '@/components/Exam/ListeningIELTS019/ListeningPart1IELTS019.vue';
import ListeningPart2IELTS019 from '@/components/Exam/ListeningIELTS019/ListeningPart2IELTS019.vue';
import ListeningPart3IELTS019 from '@/components/Exam/ListeningIELTS019/ListeningPart3IELTS019.vue';
import ListeningPart4IELTS019 from '@/components/Exam/ListeningIELTS019/ListeningPart4IELTS019.vue';
import ListeningFooterIELTS019 from '@/components/Exam/ListeningIELTS019/ListeningFooterIELTS019.vue';
import ListeningReviewModalIELTS019 from '@/components/Exam/ListeningIELTS019/ListeningReviewModalIELTS019.vue';
import ListeningSubmitModalIELTS019 from '@/components/Exam/ListeningIELTS019/ListeningSubmitModalIELTS019.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS019 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS019 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS019 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS019 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
