...
import WritingFooterIELTS019 from '@/components/Exam/WritingIELTS019/WritingFooterIELTS019.vue';
import WritingHeaderIELTS019 from '@/components/Exam/WritingIELTS019/WritingHeaderIELTS019.vue';
import WritingPart1IELTS019 from '@/components/Exam/WritingIELTS019/WritingPart1IELTS019.vue';
import WritingPart2IELTS019 from '@/components/Exam/WritingIELTS019/WritingPart2IELTS019.vue';
import WritingSubmitModalIELTS019 from '@/components/Exam/WritingIELTS019/WritingSubmitModalIELTS019.vue';
...
const handleConfirmSubmit = async () => {
    ...
    {
        q: `The four pie charts below show the proportion of Australians aged 17 to 65 who watched television. The bar chart shows how much time people in different age groups spent watching TV. Summarize the information by selecting and reporting the main features, and making comparisons where relevant. Write at least 150 words.`,
        ans: part1Answers.part1 || '',
    },
    {
        q: `Scientists are saying that the earth’s energy resources are running out, but people still do not show much concern about this problem. What can be done to make people more aware of this issue and encourage them to act responsibly ? Write at least 250 words.`,
