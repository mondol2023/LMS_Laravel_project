...
import ListeningFooterIELTS005 from '@/components/Exam/ListeningIELTS005/ListeningFooterIELTS005.vue';
import ListeningHeaderIELTS005 from '@/components/Exam/ListeningIELTS005/ListeningHeaderIELTS005.vue';
import ListeningPart1IELTS005 from '@/components/Exam/ListeningIELTS005/ListeningPart1IELTS005.vue';
import ListeningPart2IELTS005 from '@/components/Exam/ListeningIELTS005/ListeningPart2IELTS005.vue';
import ListeningPart3IELTS005 from '@/components/Exam/ListeningIELTS005/ListeningPart3IELTS005.vue';
import ListeningPart4IELTS005 from '@/components/Exam/ListeningIELTS005/ListeningPart4IELTS005.vue';
import ListeningSubmitModalIELTS005 from '@/components/Exam/ListeningIELTS005/ListeningSubmitModalIELTS005.vue';
...
// ================================
// Correct answers (IELTS005 specific)
// ================================
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS005 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS005 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS005 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS005 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
