...
import ReadingFooterIELTS005 from '@/components/Exam/ReadingIELTS005/ReadingFooterIELTS005.vue';
import ReadingHeaderIELTS005 from '@/components/Exam/ReadingIELTS005/ReadingHeaderIELTS005.vue';
import ReadingPart1IELTS005 from '@/components/Exam/ReadingIELTS005/ReadingPart1IELTS005.vue';
import ReadingPart2IELTS005 from '@/components/Exam/ReadingIELTS005/ReadingPart2IELTS005.vue';
import ReadingPart3IELTS005 from '@/components/Exam/ReadingIELTS005/ReadingPart3IELTS005.vue';
...
const handleScrollToQuestion = async (questionNumber: number) => {
    ...
    // IELTS005 question ranges: Part1: 1-14, Part2: 15-27, Part3: 28-40
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS005 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS005 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS005 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS005
