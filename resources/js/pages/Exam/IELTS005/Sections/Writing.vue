...
import WritingFooter from '@/components/Exam/WritingIELTS005/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS005/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS005/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS005/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS005/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: `TThe charts below give information about the way in which water was used in differentcountries in 2000.Summarise the information by selecting and reporting the main features, and make comparisonswhere relevant You should write at least 150 words.`,
            ans: part1Answers.part1 || '',
            image: '/images/writing/writing005.png',
        },
        {
            q: 'Young people in the modern world seem to have more power and influence than previousyoung generation.Why is this case?What impact does this have on the relationship between old and young peopleTo what extent do you agree or disagree? Give reasons for your answers and include any relevant examples from your own knowledge or experiences. You should write at least 250 words.',
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        ...
        <WritingFooter :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />
