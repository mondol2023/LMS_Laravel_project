...
import WritingFooter from '@/components/Exam/WritingIELTS002/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS002/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS002/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS002/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS002/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The diagrams below show the development of small fishing village its surrounding area into a large European tourist resort. Summarise the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Music is played in every society and culture in the world today. Some people think that music brings only benefits to the individuals and societies. Others, however, think that music can have a negative influence on both. Discuss both these views and give your own opinion. Give reasons for your answer and include any relevant examples from your own knowledge or experience.',
