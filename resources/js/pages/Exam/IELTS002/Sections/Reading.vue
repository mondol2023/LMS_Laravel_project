...
import ReadingFooterIELTS002 from '@/components/Exam/ReadingIELTS002/ReadingFooterIELTS002.vue';
import ReadingHeaderIELTS002 from '@/components/Exam/ReadingIELTS002/ReadingHeaderIELTS002.vue';
import ReadingPart1IELTS002 from '@/components/Exam/ReadingIELTS002/ReadingPart1IELTS002.vue';
import ReadingPart2IELTS002 from '@/components/Exam/ReadingIELTS002/ReadingPart2IELTS002.vue';
import ReadingPart3IELTS002 from '@/components/Exam/ReadingIELTS002/ReadingPart3IELTS002.vue';
...
const handleScrollToQuestion = async (questionNumber: number) => {
    ...
    // IELTS002 question ranges: Part1: 1-14, Part2: 15-27, Part3: 28-40
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS002 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS002 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS002 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS002
