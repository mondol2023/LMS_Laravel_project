...
import ListeningFooterIELTS002 from '@/components/Exam/ListeningIELTS002/ListeningFooterIELTS002.vue';
import ListeningHeaderIELTS002 from '@/components/Exam/ListeningIELTS002/ListeningHeaderIELTS002.vue';
import ListeningPart1IELTS002 from '@/components/Exam/ListeningIELTS002/ListeningPart1IELTS002.vue';
import ListeningPart2IELTS002 from '@/components/Exam/ListeningIELTS002/ListeningPart2IELTS002.vue';
import ListeningPart3IELTS002 from '@/components/Exam/ListeningIELTS002/ListeningPart3IELTS002.vue';
import ListeningPart4IELTS002 from '@/components/Exam/ListeningIELTS002/ListeningPart4IELTS002.vue';
import ListeningSubmitModalIELTS002 from '@/components/Exam/ListeningIELTS002/ListeningSubmitModalIELTS002.vue';
...
// ================================
// Correct answers (IELTS002 specific)
// ================================
                ...
                while ((node = walker.nextNode())) {
                    ...
                    if (index !== -1 && node.parentElement) {
                        ...
                        try {
                            ...
                            // If surroundContents fails (e.g., spans multiple elements), try next node
                        }
                    }
                }
            }
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS002 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS002 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS002 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS002 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
