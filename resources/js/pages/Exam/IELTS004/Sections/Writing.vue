...
import WritingFooter from '@/components/Exam/WritingIELTS004/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS004/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS004/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS004/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS004/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The chart shows the proportion of people in a UK survey carried out in three different years who said they were interested in certain sports. Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Some people believe that it is more important to teach children the literature of their own country than other countries. Do you agree or disagree?Give reasons for your answer and include any relevant examples from your own knowledge or experience.You should write at least 250 words',
