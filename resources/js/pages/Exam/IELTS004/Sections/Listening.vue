...
import ListeningFooterIELTS004 from '@/components/Exam/ListeningIELTS004/ListeningFooterIELTS004.vue';
import ListeningHeaderIELTS004 from '@/components/Exam/ListeningIELTS004/ListeningHeaderIELTS004.vue';
import ListeningPart1IELTS004 from '@/components/Exam/ListeningIELTS004/ListeningPart1IELTS004.vue';
import ListeningPart2IELTS004 from '@/components/Exam/ListeningIELTS004/ListeningPart2IELTS004.vue';
import ListeningPart3IELTS004 from '@/components/Exam/ListeningIELTS004/ListeningPart3IELTS004.vue';
import ListeningPart4IELTS004 from '@/components/Exam/ListeningIELTS004/ListeningPart4IELTS004.vue';
import ListeningSubmitModalIELTS004 from '@/components/Exam/ListeningIELTS004/ListeningSubmitModalIELTS004.vue';
...
// ================================
// Correct answers (IELTS004 specific)
// ================================
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS004 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS004 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS004 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS004 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
