...
import ReadingFooterIELTS004 from '@/components/Exam/ReadingIELTS004/ReadingFooterIELTS004.vue';
import ReadingHeaderIELTS004 from '@/components/Exam/ReadingIELTS004/ReadingHeaderIELTS004.vue';
import ReadingPart1IELTS004 from '@/components/Exam/ReadingIELTS004/ReadingPart1IELTS004.vue';
import ReadingPart2IELTS004 from '@/components/Exam/ReadingIELTS004/ReadingPart2IELTS004.vue';
import ReadingPart3IELTS004 from '@/components/Exam/ReadingIELTS004/ReadingPart3IELTS004.vue';
...
const handleScrollToQuestion = async (questionNumber: number) => {
    ...
    // IELTS004 question ranges: Part1: 1-14, Part2: 15-27, Part3: 28-40
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS004 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS004 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS004 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS004
