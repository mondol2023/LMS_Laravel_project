...
import ListeningFooterIELTS003 from '@/components/Exam/ListeningIELTS003/ListeningFooterIELTS003.vue';
import ListeningHeaderIELTS003 from '@/components/Exam/ListeningIELTS003/ListeningHeaderIELTS003.vue';
import ListeningPart1IELTS003 from '@/components/Exam/ListeningIELTS003/ListeningPart1IELTS003.vue';
import ListeningPart2IELTS003 from '@/components/Exam/ListeningIELTS003/ListeningPart2IELTS003.vue';
import ListeningPart3IELTS003 from '@/components/Exam/ListeningIELTS003/ListeningPart3IELTS003.vue';
import ListeningPart4IELTS003 from '@/components/Exam/ListeningIELTS003/ListeningPart4IELTS003.vue';
import ListeningSubmitModalIELTS003 from '@/components/Exam/ListeningIELTS003/ListeningSubmitModalIELTS003.vue';
...
// ================================
// Correct answers (IELTS003 specific)
// ================================
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS003 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS003 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS003 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS003 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
