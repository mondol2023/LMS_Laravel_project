...
import ReadingFooterIELTS003 from '@/components/Exam/ReadingIELTS003/ReadingFooterIELTS003.vue';
import ReadingHeaderIELTS003 from '@/components/Exam/ReadingIELTS003/ReadingHeaderIELTS003.vue';
import ReadingPart1IELTS003 from '@/components/Exam/ReadingIELTS003/ReadingPart1IELTS003.vue';
import ReadingPart2IELTS003 from '@/components/Exam/ReadingIELTS003/ReadingPart2IELTS003.vue';
import ReadingPart3IELTS003 from '@/components/Exam/ReadingIELTS003/ReadingPart3IELTS003.vue';
...
const part1Notes = ref<any[]>([]);
const part2Notes = ref<any[]>([]);
const part3Notes = ref<any[]>([]);
...
const handleScrollToQuestion = async (questionNumber: number) => {
    ...
    // IELTS003 question ranges: Part1: 1-14, Part2: 15-27, Part3: 28-40
...
onMounted(() => {
    ...
    // Update notes from child components
    if (readingPart1Ref.value?.notes) {
        part1Notes.value = readingPart1Ref.value.notes;
    }
    if (readingPart2Ref.value?.notes) {
        part2Notes.value = readingPart2Ref.value.notes;
    }
    if (readingPart3Ref.value?.notes) {
        part3Notes.value = readingPart3Ref.value.notes;
    }
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS003 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS003 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS003 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS003
