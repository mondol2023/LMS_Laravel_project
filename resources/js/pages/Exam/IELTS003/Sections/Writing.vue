...
import WritingFooter from '@/components/Exam/WritingIELTS003/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS003/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS003/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS003/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS003/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The charts below show the percentage of monthly household income spent on various items by two different groups in one European country. Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Modern technology has made it easier for individuals to download copyrighted music and books from the internet for no charge.\n\nTo what extent is this a positive or a negative development?\n\nGive reasons for your answer and include any relevant examples from your own knowledge or experience. You should write at least 250 words.',
