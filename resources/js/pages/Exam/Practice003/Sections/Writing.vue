...
import WritingFooterIELTS011 from '@/components/Exam/WritingIELTS011/WritingFooter011.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 text-black">
        ...
        <WritingFooterIELTS011 :active-part="activePart" @navigate="handleNavigate" />
