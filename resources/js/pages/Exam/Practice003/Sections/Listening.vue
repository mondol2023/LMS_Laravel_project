...
import C20Test3ListeningFooter from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningFooter.vue';
import C20Test3ListeningHeader from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningHeader.vue';
import C20Test3ListeningPart1 from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningPart1.vue';
import C20Test3ListeningPart2 from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningPart2.vue';
import C20Test3ListeningPart3 from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningPart3.vue';
import C20Test3ListeningPart4 from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningPart4.vue';
import C20Test3ListeningReviewModal from '@/components/Exam/Practice/C20/Test3/Listening/C20Test3ListeningReviewModal.vue';
...
// ================================
// Correct answers for Test 3 (C20P003)
// ================================
...
const handleConfirmSubmit = async () => {
    ...
    try {
        ...
        router.post('/practice/results/listening/3', {
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C20Test3ListeningPart1 ref="listeningPart1Ref" :phone="userPhone" :exam-id="examId" :correct-answers="part1CorrectAnswers" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C20Test3ListeningPart2 ref="listeningPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C20Test3ListeningPart3 ref="listeningPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <C20Test3ListeningPart4 ref="listeningPart4Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <C20Test3ListeningFooter
            :active-part="activePart"
            :answered-questions="answeredQuestions"
            @navigate="handleNavigate"
            @scroll-to-question="handleScrollToQuestion"
        />
        <C20Test3ListeningReviewModal
