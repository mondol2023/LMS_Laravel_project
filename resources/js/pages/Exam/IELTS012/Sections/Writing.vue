...
import WritingFooterIELTS012 from '@/components/Exam/WritingIELTS012/WritingFooter012.vue';
import WritingHeaderIELTS012 from '@/components/Exam/WritingIELTS012/WritingHeader012.vue';
import WritingPart1IELTS012 from '@/components/Exam/WritingIELTS012/WritingPart1IELTS012.vue';
import WritingPart2IELTS012 from '@/components/Exam/WritingIELTS012/WritingPart2IELTS012.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The pie charts below give information on the ages of the populations of Oman and Spain in 2005 and projections for 2055 Summaries the information by selecting and reporting the main features and make comparisons where relevant. Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'More and more people in the city live in homes with small spaces or no outdoor areas. Do you think it is a negative or positive development? Give reasons for your answer and include any relevant examples from your own knowledge or experience. Write at least 250 words.',
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }" class="w-full">
            <WritingPart1IELTS012 ref="writingPart1Ref" @word-count-change="handlePart1WordCount" @notes-change="handlePart1NotesChange" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }" class="w-full">
            <WritingPart2IELTS012 ref="writingPart2Ref" @word-count-change="handlePart2WordCount" @notes-change="handlePart2NotesChange" />
        </div>

        <!-- Pass function to footer -->
        <WritingFooterIELTS012 :active-part="activePart" @navigate="handleNavigate" />
