...
import ListeningFooterIELTS012 from '@/components/Exam/ListeningIELTS012/ListeningFooterIELTS012.vue';
import ListeningHeaderIELTS012 from '@/components/Exam/ListeningIELTS012/ListeningHeaderIELTS012.vue';
import ListeningPart1IELTS012 from '@/components/Exam/ListeningIELTS012/ListeningPart1IELTS012.vue';
import ListeningPart2IELTS012 from '@/components/Exam/ListeningIELTS012/ListeningPart2IELTS012.vue';
import ListeningPart3IELTS012 from '@/components/Exam/ListeningIELTS012/ListeningPart3IELTS012.vue';
import ListeningPart4IELTS012 from '@/components/Exam/ListeningIELTS012/ListeningPart4IELTS012.vue';
import ListeningReviewModalIELTS012 from '@/components/Exam/ListeningIELTS012/ListeningReviewModalIELTS012.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <ListeningPart1IELTS012 ref="listeningPart1Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <ListeningPart2IELTS012 ref="listeningPart2Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <ListeningPart3IELTS012 ref="listeningPart3Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <ListeningPart4IELTS012 ref="listeningPart4Ref" />
        </div>
        <ListeningFooterIELTS012
