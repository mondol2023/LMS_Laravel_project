...
import ReadingFooterIELTS012 from '@/components/Exam/ReadingIELTS012/ReadingFooterIELTS012.vue';
import ReadingHeaderIELTS012 from '@/components/Exam/ReadingIELTS012/ReadingHeaderIELTS012.vue';
import ReadingPart1IELTS012 from '@/components/Exam/ReadingIELTS012/ReadingPart1IELTS012.vue';
import ReadingPart2IELTS012 from '@/components/Exam/ReadingIELTS012/ReadingPart2IELTS012.vue';
import ReadingPart3IELTS012 from '@/components/Exam/ReadingIELTS012/ReadingPart3IELTS012.vue';
import ReadingReviewModalIELTS012 from '@/components/Exam/ReadingIELTS012/ReadingReviewModalIELTS012.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <ReadingPart1IELTS012 ref="readingPart1Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <ReadingPart2IELTS012 ref="readingPart2Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <ReadingPart3IELTS012 ref="readingPart3Ref" />
        </div>

        <ReadingFooterIELTS012
