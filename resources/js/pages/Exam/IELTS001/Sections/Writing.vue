...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The graphs below show the number of men and women in full and part-timeemployment in Australia between 1973 and 1993.Write a report for a university lecturer describing the information shown below.You should write at least 150 words',
            ans: part1Answers.part1 || '',
            image: '/images/writing/writing1.png',
        },
        {
            q: 'The exploration and development of safe alternatives to fossil fuels should be the mostimportant global priority today.To what extent do you agree or disagree?Give reasons for your answers and include any relevant examples from your own knowledgeor experiences.You should write at least 250 words',
