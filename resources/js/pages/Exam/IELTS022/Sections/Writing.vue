...
import WritingFooter from '@/components/Exam/WritingIELTS022/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS022/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS022/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS022/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS022/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The diagram below shows how plastic waste is made into clothes. Summaries the information by selecting and reporting the main features, and make comparisons where relevant.Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Some people believe that mental training, such as building self-confidence, is more important for sportspeople than physical trainingTo what extent do you agree or disagree?Give reasons for your answer and include any relevant examples from your own knowledge or experience.You should write at least 250 words.',
