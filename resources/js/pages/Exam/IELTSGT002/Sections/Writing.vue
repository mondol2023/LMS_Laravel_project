...
import WritingFooter from '@/components/Exam/WritingGT002/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingGT002/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingGT002/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingGT002/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingGT002/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'You have seen an advertisement from a couple, who live in Australia, for someone to teach their two children your language for a year.  Write a letter to the couple. In your letter\n\n• explain why you think you would be suitable for the job\n• say what else you could do for the family\n• give your reasons for wanting the job',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'In many countries, paying for things using mobile phone (cellphone) apps is becoming increasingly common.\n\nDoes this development have more advantages or more disadvantages?\n\nGive reasons for your answer and include any relevant examples from your own knowledge or experience.',
