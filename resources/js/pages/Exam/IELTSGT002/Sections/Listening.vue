...
import ListeningFooter from '@/components/Exam/ListeningGT002/ListeningFooter.vue';
import ListeningHeader from '@/components/Exam/ListeningGT002/ListeningHeader.vue';
import ListeningPart1 from '@/components/Exam/ListeningGT002/ListeningPart1.vue';
import ListeningPart2 from '@/components/Exam/ListeningGT002/ListeningPart2.vue';
import ListeningPart3 from '@/components/Exam/ListeningGT002/ListeningPart3.vue';
import ListeningPart4 from '@/components/Exam/ListeningGT002/ListeningPart4.vue';
import ListeningReviewModal from '@/components/Exam/ListeningGT002/ListeningReviewModal.vue';
import ListeningSubmitModal from '@/components/Exam/ListeningGT002/ListeningSubmitModalIELTS002.vue';
...
const correctAnswers: Record<number, string> = {
    ...
    // Section 4: Note completion (Q31-40) - Climate Change
    31: 'petrol stations',
    32: 'Scotland ',
    33: 'head office',
    34: 'retrained',
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
