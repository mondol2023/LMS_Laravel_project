...
import WritingHeader from '@/components/Exam/Writing/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/Writing/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/Writing/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/Writing/WritingSubmitModalIELTS001.vue';
import WritingFooterIELTS021 from '@/components/Exam/WritingIELTS021/WritingFooterIELTS021.vue';
import WritingPart2IELTS021 from '@/components/Exam/WritingIELTS021/WritingPart2IELTS021.vue';
import WritingPart1IELTS021 from '@/components/Exam/WritingIELTS021/WritingPart1IELTS021.vue';
import WritingHeaderIELTS021 from '@/components/Exam/WritingIELTS021/WritingHeaderIELTS021.vue';
import WritingSubmitModalIELTS021 from '@/components/Exam/WritingIELTS021/WritingSubmitModalIELTS021.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The diagram below shows the design of a modern landfill for household waste. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Giving children mobile phones at an early age has become increasingly common. Do the advantages of this trend outweigh the disadvantages? Give reasons for your answer and include any relevant examples from your own knowledge or experience.',
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        ...
        <WritingFooterIELTS021 :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />

        <!-- Force Submit Modal (Reload/Back/Tab Switch Protection) -->
        <Teleport to="body">
            <div v-if="showForceSubmitModal" class="fixed inset-0 z-[10000] flex items-center justify-center bg-black/50 p-4">
                <div class="w-full max-w-md rounded border border-black bg-white p-6 text-center shadow">
                    ...
                    <!-- Message -->
                    <p class="mb-2 text-sm text-gray-600">You cannot reload, go back, switch tabs, or minimize during the exam.</p>
                    <p class="mb-4 text-sm font-semibold text-black">You must submit your exam answers to proceed.</p>

                    <!-- Button -->
                    <button
                        @click="handleForceSubmit"
                        class="w-full rounded bg-black py-2 text-sm font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-gray-800 active:scale-100"
                    >
                        Submit Exam Now
                    </button>
                </div>
        ...
        <!-- Submit Modal -->
        <WritingSubmitModalIELTS021 :is-visible="showSubmitModal" :is-time-up="isTimeUp" @close="handleCancelSubmit" @submit="handleConfirmSubmit" />
    </div>
</template>
