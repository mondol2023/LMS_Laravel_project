...
import ListeningHeaderIELTS021 from '@/components/Exam/ListeningIELTS021/ListeningHeaderIELTS021.vue';
import ListeningPart4IELTS021 from '@/components/Exam/ListeningIELTS021/ListeningPart4IELTS021.vue';
import ListeningPart3IELTS021 from '@/components/Exam/ListeningIELTS021/ListeningPart3IELTS021.vue';
import ListeningPart2IELTS021 from '@/components/Exam/ListeningIELTS021/ListeningPart2IELTS021.vue';
import ListeningPart1IELTS021 from '@/components/Exam/ListeningIELTS021/ListeningPart1IELTS021.vue';
import ListeningFooterIELTS021 from '@/components/Exam/ListeningIELTS021/ListeningFooterIELTS021.vue';
import ListeningReviewModalIELTS021 from '@/components/Exam/ListeningIELTS021/ListeningReviewModalIELTS021.vue';
import ListeningSubmitModalIELTS021 from '@/components/Exam/ListeningIELTS021/ListeningSubmitModalIELTS021.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS021 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS021 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS021 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS021 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
