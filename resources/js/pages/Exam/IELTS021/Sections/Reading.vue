...
import ReadingHeaderIELTS021 from '@/components/Exam/ReadingIELTS021/ReadingHeaderIELTS021.vue';
import ReadingPart3IELTS021 from '@/components/Exam/ReadingIELTS021/ReadingPart3IELTS021.vue';
import ReadingPart2IELTS021 from '@/components/Exam/ReadingIELTS021/ReadingPart2IELTS021.vue';
import ReadingPart1IELTS021 from '@/components/Exam/ReadingIELTS021/ReadingPart1IELTS021.vue';
import ReadingFooterIELTS021 from '@/components/Exam/ReadingIELTS021/ReadingFooterIELTS021.vue';
import ReadingSubmitModalIELTS021 from '@/components/Exam/ReadingIELTS021/ReadingSubmitModalIELTS021.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS021 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS021 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS021 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS021
