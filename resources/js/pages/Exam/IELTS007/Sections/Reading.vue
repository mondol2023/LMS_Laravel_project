...
import ReadingFooterIELTS007 from '@/components/Exam/ReadingIELTS007/ReadingFooterIELTS007.vue';
import ReadingHeaderIELTS007 from '@/components/Exam/ReadingIELTS007/ReadingHeaderIELTS007.vue';
import ReadingPart1IELTS007 from '@/components/Exam/ReadingIELTS007/ReadingPart1IELTS007.vue';
import ReadingPart2IELTS007 from '@/components/Exam/ReadingIELTS007/ReadingPart2IELTS007.vue';
import ReadingPart3IELTS007 from '@/components/Exam/ReadingIELTS007/ReadingPart3IELTS007.vue';
import ReadingSubmitModalIELTS007 from '@/components/Exam/ReadingIELTS007/ReadingSubmitModalIELTS007.vue';
...
<template>
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        <ReadingHeaderIELTS007 test-title="IELTS Academic Reading Test" current-section="Reading" :time-limit="60"
            :is-time-up="isTimeUp" :part1-notes="part1Notes" :part2-notes="part2Notes" :part3-notes="part3Notes"
            @show-submit-modal="handleShowSubmitModal" @time-up="handleTimeUp" @submit-test="handleConfirmSubmit"
            @focus-note="handleFocusNote" @delete-note="handleDeleteNote" @font-size-change="handleFontSizeChange"
            @bg-color-change="handleBgColorChange" @contrast-change="handleContrastChange" />
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS007 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions"
                    @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS007 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions"
                    @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS007 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions"
                    @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS007 :active-part="activePart" :answered-questions="answeredQuestions"
            :flagged-questions="flaggedQuestions" :selected-question="selectedQuestion" @navigate="handleNavigate"
            @scroll-to-question="handleScrollToQuestion" @exit="handleExit" />
        ...
        <!-- Submit Modal -->
        <ReadingSubmitModalIELTS007 :is-visible="showSubmitModal" :answered-count="answeredQuestions.size"
