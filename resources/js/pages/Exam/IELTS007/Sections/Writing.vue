...
import WritingFooterIELTS007 from '@/components/Exam/WritingIELTS007/WritingFooterIELTS007.vue';
import WritingHeaderIELTS007 from '@/components/Exam/WritingIELTS007/WritingHeaderIELTS007.vue';
import WritingPart1IELTS007 from '@/components/Exam/WritingIELTS007/WritingPart1IELTS007.vue';
import WritingPart2IELTS007 from '@/components/Exam/WritingIELTS007/WritingPart2IELTS007.vue';
import WritingSubmitModalIELTS007 from '@/components/Exam/WritingIELTS007/WritingSubmitModalIELTS007.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The graph below compares figures for the production and consumption of energy in the USfrom 1950 to 2000. It also predicts figures for 2025.Summarise the information by selecting and reporting the main features, and makecomaprisons where relevant. Write at least 150 words.',
            ans: part1Answers.part1 || '',
       },
        {
            q: 'The only way to reduce the amount of traffic in cities today is by reducing the need forpeople to travel from home for work, education or shopping.To what extent do you agree or disagree?' ,
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        <WritingHeaderIELTS007 :part1-word-count="part1WordCount" :part2-word-count="part2WordCount"
            :is-time-up="isTimeUp" :active-part="activePart" :part1-notes="part1Notes" :part2-notes="part2Notes"
            @show-submit-modal="handleShowSubmitModal" @time-up="handleTimeUp" @font-size-change="handleFontSizeChange"
            @bg-color-change="handleBgColorChange" @contrast-change="handleContrastChange" @focus-note="handleFocusNote"
            @delete-note="handleDeleteNote" />

        <!-- Keep both components mounted but show/hide them -->
        <div :class="{ hidden: activePart !== 'part1' }" class="w-full">
            <WritingPart1IELTS007 ref="writingPart1Ref" :font-size="fontSize" @word-count-change="handlePart1WordCount"
                @notes-change="handlePart1NotesChange" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }" class="w-full">
            <WritingPart2IELTS007 ref="writingPart2Ref" :font-size="fontSize" @word-count-change="handlePart2WordCount"
                @notes-change="handlePart2NotesChange" />
        </div>

        <!-- Pass function to footer -->
        <WritingFooterIELTS007 :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />
        ...
        <!-- Submit Modal -->
        <WritingSubmitModalIELTS007 :is-visible="showSubmitModal" :is-time-up="isTimeUp" @close="handleCancelSubmit"
