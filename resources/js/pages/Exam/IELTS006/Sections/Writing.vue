...
import WritingFooter from '@/components/Exam/WritingIELTS006/WritingFooterIELTS006.vue';
import WritingHeader from '@/components/Exam/WritingIELTS006/WritingHeaderIELTS006.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS006/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS006/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS006/WritingSubmitModalIELTS006.vue';
...
const handleConfirmSubmit = async () => {
   ...
   const questionAnswers = [
        {
            q: 'The graph below shows the number of enquiries received by the Tourist Information Office in one city over a six-month period in 2011.',
            ans: part1Answers.part1 || '',
            image: '/images/writing/IELTS008.png',
        },
        {
            q: 'Some people believe that it is more important to teach children the literature of their own country than other countries. Do you agree or disagree? Give reasons for your answer and include any relevant examples from your own knowledge or experience.\n\nWrite at least 250 words.',
