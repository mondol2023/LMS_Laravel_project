...
import ListeningHeaderIELTS006 from '@/components/Exam/ListeningIELTS006/ListeningHeaderIELTS006.vue';
import ListeningPart4IELTS006 from '@/components/Exam/ListeningIELTS006/ListeningPart4IELTS006.vue';
import ListeningPart3IELTS006 from '@/components/Exam/ListeningIELTS006/ListeningPart3IELTS006.vue';
import ListeningPart2IELTS006 from '@/components/Exam/ListeningIELTS006/ListeningPart2IELTS006.vue';
import ListeningPart1IELTS006 from '@/components/Exam/ListeningIELTS006/ListeningPart1IELTS006.vue';
import ListeningFooterIELTS006 from '@/components/Exam/ListeningIELTS006/ListeningFooterIELTS006.vue';
import ListeningReviewModal from '@/components/Exam/Listening/ListeningReviewModal.vue';
import ListeningSubmitModalIELTS006 from '@/components/Exam/ListeningIELTS006/ListeningSubmitModalIELTS006.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS006 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS006 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS006 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS006 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
