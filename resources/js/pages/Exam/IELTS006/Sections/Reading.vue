...
import ReadingHeaderIELTS006 from '@/components/Exam/ReadingIELTS006/ReadingHeaderIELTS006.vue';
import ReadingPart3IELTS006 from '@/components/Exam/ReadingIELTS006/ReadingPart3IELTS006.vue';
import ReadingPart2IELTS006 from '@/components/Exam/ReadingIELTS006/ReadingPart2IELTS006.vue';
import ReadingPart1IELTS006 from '@/components/Exam/ReadingIELTS006/ReadingPart1IELTS006.vue';
import ReadingFooterIELTS006 from '@/components/Exam/ReadingIELTS006/ReadingFooterIELTS006.vue';
import ReadingSubmitModalIELTS006 from '@/components/Exam/ReadingIELTS006/ReadingSubmitModalIELTS006.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS006 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS006 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS006 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS006
