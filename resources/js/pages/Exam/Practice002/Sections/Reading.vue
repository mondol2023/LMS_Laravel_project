...
import C20Test2ReadingPart1 from '@/components/Exam/Practice/C20/Test2/Reading/C20Test2ReadingPart1.vue';
import C20Test2ReadingPart2 from '@/components/Exam/Practice/C20/Test2/Reading/C20Test2ReadingPart2.vue';
import C20Test2ReadingPart3 from '@/components/Exam/Practice/C20/Test2/Reading/C20Test2ReadingPart3.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C20Test2ReadingPart1 ref="readingPart1Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C20Test2ReadingPart2 ref="readingPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C20Test2ReadingPart3 ref="readingPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
