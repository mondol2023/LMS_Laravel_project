...
import C20Test2ListeningFooter from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningFooter.vue';
import C20Test2ListeningHeader from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningHeader.vue';
import C20Test2ListeningPart1 from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningPart1.vue';
import C20Test2ListeningPart2 from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningPart2.vue';
import C20Test2ListeningPart3 from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningPart3.vue';
import C20Test2ListeningPart4 from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningPart4.vue';
import C20Test2ListeningReviewModal from '@/components/Exam/Practice/C20/Test2/Listening/C20Test2ListeningReviewModal.vue';
...
// ================================
// Correct answers for Test 2 (C20P002)
// ================================
...
const handleConfirmSubmit = async () => {
    ...
    try {
        ...
        router.post('/practice/results/listening/2', {
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C20Test2ListeningPart1 ref="listeningPart1Ref" :phone="userPhone" :exam-id="examId" :correct-answers="part1CorrectAnswers" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C20Test2ListeningPart2 ref="listeningPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C20Test2ListeningPart3 ref="listeningPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <C20Test2ListeningPart4 ref="listeningPart4Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <C20Test2ListeningFooter
            :active-part="activePart"
            :answered-questions="answeredQuestions"
            @navigate="handleNavigate"
            @scroll-to-question="handleScrollToQuestion"
        />
        <C20Test2ListeningReviewModal
