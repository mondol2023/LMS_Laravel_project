...
import C19Test1ReadingPart1 from '@/components/Exam/Practice/C19/Test1/Reading/C19Test1ReadingPart1.vue';
import C19Test1ReadingPart2 from '@/components/Exam/Practice/C19/Test1/Reading/C19Test1ReadingPart2.vue';
import C19Test1ReadingPart3 from '@/components/Exam/Practice/C19/Test1/Reading/C19Test1ReadingPart3.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C19Test1ReadingPart1 ref="readingPart1Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C19Test1ReadingPart2 ref="readingPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C19Test1ReadingPart3 ref="readingPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
