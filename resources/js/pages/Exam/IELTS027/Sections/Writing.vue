...
import WritingFooter from '@/components/Exam/WritingIELTS027/WritingFooter.vue';
import WritingHeader from '@/components/Exam/WritingIELTS027/WritingHeader.vue';
import WritingPart1 from '@/components/Exam/WritingIELTS027/WritingPart1.vue';
import WritingPart2 from '@/components/Exam/WritingIELTS027/WritingPart2.vue';
import WritingSubmitModal from '@/components/Exam/WritingIELTS027/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
   ...
   const questionAnswers = [
        {
            q: 'The pie charts illustrate the proportion of various types of pollutants in the years 1997 and 2007. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'While some believe that technological advances in education will eliminate the need for physical classrooms, others argue that direct interaction between teachers and students is essential.Discuss both views and give your opinion.',
