...
import ReadingHeaderIELTS018 from '@/components/Exam/ReadingIELTS018/ReadingHeaderIELTS018.vue';
import ReadingPart3IELTS018 from '@/components/Exam/ReadingIELTS018/ReadingPart3IELTS018.vue';
import ReadingPart2IELTS018 from '@/components/Exam/ReadingIELTS018/ReadingPart2IELTS018.vue';
import ReadingPart1IELTS018 from '@/components/Exam/ReadingIELTS018/ReadingPart1IELTS018.vue';
import ReadingReviewModalIELTS018 from '@/components/Exam/ReadingIELTS018/ReadingReviewModalIELTS018.vue';
import ReadingSubmitModalIELTS018 from '@/components/Exam/ReadingIELTS018/ReadingSubmitModalIELTS018.vue';
import ReadingFooterIELTS018 from '@/components/Exam/ReadingIELTS018/ReadingFooterIELTS018.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS018 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS018 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS018 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS018
