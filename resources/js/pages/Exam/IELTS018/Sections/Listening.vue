...
import ListeningFooterIELTS018 from '@/components/Exam/ListeningIELTS018/ListeningFooterIELTS018.vue';
import ListeningHeaderIELTS018 from '@/components/Exam/ListeningIELTS018/ListeningHeaderIELTS018.vue';
import ListeningPart1IELTS018 from '@/components/Exam/ListeningIELTS018/ListeningPart1IELTS018.vue';
import ListeningPart2IELTS018 from '@/components/Exam/ListeningIELTS018/ListeningPart2IELTS018.vue';
import ListeningPart3IELTS018 from '@/components/Exam/ListeningIELTS018/ListeningPart3IELTS018.vue';
import ListeningPart4IELTS018 from '@/components/Exam/ListeningIELTS018/ListeningPart4IELTS018.vue';
import ListeningReviewModalIELTS018 from '@/components/Exam/ListeningIELTS018/ListeningReviewModalIELTS018.vue';
import ListeningSubmitModalIELTS018 from '@/components/Exam/ListeningIELTS018/ListeningSubmitModalIELTS018.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS018 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS018 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS018 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS018 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
