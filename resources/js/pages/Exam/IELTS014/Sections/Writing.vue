...
import WritingFooterIELTS014 from '@/components/Exam/WritingIELTS014/WritingFooter014.vue';
import WritingHeaderIELTS014 from '@/components/Exam/WritingIELTS014/WritingHeader014.vue';
import WritingPart1IELTS014 from '@/components/Exam/WritingIELTS014/WritingPart1IELTS014.vue';
import WritingPart2IELTS014 from '@/components/Exam/WritingIELTS014/WritingPart2IELTS014.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'Plan A below shows a health centre in 2005. Plan B shows the same place in the present day. Summarise the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Some say that it would be better if the majority of employees worked from home instead of travelling to a work place every day. Do you think the advantages of working from home outweigh the disadvantages? Give reasons for your answer and include any relevant examples from your own knowledge or experience. Write at least 250 words.',
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }" class="w-full">
            <WritingPart1IELTS014 ref="writingPart1Ref" @word-count-change="handlePart1WordCount" @notes-change="handlePart1NotesChange" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }" class="w-full">
            <WritingPart2IELTS014 ref="writingPart2Ref" @word-count-change="handlePart2WordCount" @notes-change="handlePart2NotesChange" />
        </div>

        <!-- Pass function to footer -->
        <WritingFooterIELTS014 :active-part="activePart" @navigate="handleNavigate" />
