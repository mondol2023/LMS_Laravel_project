...
import ReadingFooterIELTS014 from '@/components/Exam/ReadingIELTS014/ReadingFooterIELTS014.vue';
import ReadingHeaderIELTS014 from '@/components/Exam/ReadingIELTS014/ReadingHeaderIELTS014.vue';
import ReadingPart1IELTS014 from '@/components/Exam/ReadingIELTS014/ReadingPart1IELTS014.vue';
import ReadingPart2IELTS014 from '@/components/Exam/ReadingIELTS014/ReadingPart2IELTS014.vue';
import ReadingPart3IELTS014 from '@/components/Exam/ReadingIELTS014/ReadingPart3IELTS014.vue';
import ReadingReviewModalIELTS014 from '@/components/Exam/ReadingIELTS014/ReadingReviewModalIELTS014.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <ReadingPart1IELTS014 ref="readingPart1Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <ReadingPart2IELTS014 ref="readingPart2Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <ReadingPart3IELTS014 ref="readingPart3Ref" />
        </div>

        <ReadingFooterIELTS014
