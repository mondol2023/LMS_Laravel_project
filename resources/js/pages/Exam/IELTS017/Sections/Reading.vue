...
import ReadingHeaderIELTS017 from '@/components/Exam/ReadingIELTS017/ReadingHeaderIELTS017.vue';
import ReadingPart1IELTS017 from '@/components/Exam/ReadingIELTS017/ReadingPart1IELTS017.vue';
import ReadingPart2IELTS017 from '@/components/Exam/ReadingIELTS017/ReadingPart2IELTS017.vue';
import ReadingPart3IELTS017 from '@/components/Exam/ReadingIELTS017/ReadingPart3IELTS017.vue';
import ReadingFooterIELTS017 from '@/components/Exam/ReadingIELTS017/ReadingFooterIELTS017.vue';
import ReadingReviewModalIELTS017 from '@/components/Exam/ReadingIELTS017/ReadingReviewModalIELTS017.vue';
import ReadingSubmitModalIELTS017 from '@/components/Exam/ReadingIELTS017/ReadingSubmitModalIELTS017.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS017 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS017 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS017 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS017
