...
import ReadingFooterIELTS010 from '@/components/Exam/ReadingIELTS010/ReadingFooterIELTS010.vue';
import ReadingHeaderIELTS010 from '@/components/Exam/ReadingIELTS010/ReadingHeaderIELTS010.vue';
import ReadingPart1IELTS010 from '@/components/Exam/ReadingIELTS010/ReadingPart1IELTS010.vue';
import ReadingPart2IELTS010 from '@/components/Exam/ReadingIELTS010/ReadingPart2IELTS010.vue';
import ReadingPart3IELTS010 from '@/components/Exam/ReadingIELTS010/ReadingPart3IELTS010.vue';
import ReadingSubmitModalIELTS010 from '@/components/Exam/ReadingIELTS010/ReadingSubmitModalIELTS010.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS010 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS010 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS010 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS010
