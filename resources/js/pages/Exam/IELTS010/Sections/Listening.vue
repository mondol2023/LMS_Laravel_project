...
import ListeningHeaderIELTS010 from '@/components/Exam/ListeningIELTS010/ListeningHeaderIELTS010.vue';
import ListeningFooterIELTS010 from '@/components/Exam/ListeningIELTS010/ListeningFooterIELTS010.vue';
import ListeningPart1IELTS010 from '@/components/Exam/ListeningIELTS010/ListeningPart1IELTS010.vue';
import ListeningPart2IELTS010 from '@/components/Exam/ListeningIELTS010/ListeningPart2IELTS010.vue';
import ListeningPart3IELTS010 from '@/components/Exam/ListeningIELTS010/ListeningPart3IELTS010.vue';
import ListeningPart4IELTS010 from '@/components/Exam/ListeningIELTS010/ListeningPart4IELTS010.vue';
import ListeningReviewModalIELTS010 from '@/components/Exam/ListeningIELTS010/ListeningReviewModalIELTS010.vue';
import ListeningSubmitModalIELTS010 from '@/components/Exam/ListeningIELTS010/ListeningSubmitModalIELTS010.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS010 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS010 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS010 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS010 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
