...
import ReadingFooterIELTS011 from '@/components/Exam/ReadingIELTS011/ReadingFooterIELTS011.vue';
import ReadingHeaderIELTS011 from '@/components/Exam/ReadingIELTS011/ReadingHeaderIELTS011.vue';
import ReadingPart1IELTS011 from '@/components/Exam/ReadingIELTS011/ReadingPart1IELTS011.vue';
import ReadingPart2IELTS011 from '@/components/Exam/ReadingIELTS011/ReadingPart2IELTS011.vue';
import ReadingPart3IELTS011 from '@/components/Exam/ReadingIELTS011/ReadingPart3IELTS011.vue';
import ReadingSubmitModalIELTS011 from '@/components/Exam/ReadingIELTS011/ReadingSubmitModalIELTS011.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS011 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS011 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS011 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS011
