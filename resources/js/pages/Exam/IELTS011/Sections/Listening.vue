...
import ListeningFooterIELTS011 from '@/components/Exam/ListeningIELTS011/ListeningFooterIELTS011.vue';
import ListeningHeaderIELTS011 from '@/components/Exam/ListeningIELTS011/ListeningHeaderIELTS011.vue';
import ListeningPart1IELTS011 from '@/components/Exam/ListeningIELTS011/ListeningPart1IELTS011.vue';
import ListeningPart2IELTS011 from '@/components/Exam/ListeningIELTS011/ListeningPart2IELTS011.vue';
import ListeningPart3IELTS011 from '@/components/Exam/ListeningIELTS011/ListeningPart3IELTS011.vue';
import ListeningPart4IELTS011 from '@/components/Exam/ListeningIELTS011/ListeningPart4IELTS011.vue';
import ListeningReviewModalIELTS011 from '@/components/Exam/ListeningIELTS011/ListeningReviewModalIELTS011.vue';
import ListeningSubmitModalIELTS011 from '@/components/Exam/ListeningIELTS011/ListeningSubmitModalIELTS011.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS011 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS011 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS011 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS011 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
