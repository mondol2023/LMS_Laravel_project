...
import WritingFooter011 from '@/components/Exam/WritingIELTS011/WritingFooter011.vue';
import WritingHeader011 from '@/components/Exam/WritingIELTS011/WritingHeader011.vue';
...
import WritingSubmitModalIELTS011 from '@/components/Exam/WritingIELTS011/WritingSubmitModalIELTS011.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The bar shows the percentage of people going to cinemas in one European country on different days. Write at least 150 words.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Research shows that business meetings, discussions and training are happening online nowadays. \n Do the advantages outweigh the disadvantages? \n Write at least 250 words.',
