...
import WritingHeaderIELTS023 from '@/components/Exam/WritingIELTS023/WritingHeaderIELTS023.vue';
import WritingPart1IELTS023 from '@/components/Exam/WritingIELTS023/WritingPart1IELTS023.vue';
import WritingFooterIELTS023 from '@/components/Exam/WritingIELTS023/WritingFooterIELTS023.vue';
import WritingPart2IELTS023 from '@/components/Exam/WritingIELTS023/WritingPart2IELTS023.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The bar graph illustrates the percentage of adults in various age brackets who used the internet between 2003 and 2006. Summarize the information by selecting and reporting the main features ,and make comparisons where relevant.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Globalization has led to the spread of similar cultures around the world. Do you think this is a positive or negative development? Give reasons and examples to support your answer.',
...
const handleForceSubmit = async () => {
    ...
    const questionAnswers = [
    {
        q: 'The bar graph illustrates the percentage of adults in various age brackets who used the internet between 2003 and 2006. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.',
        ans: part1Answers.part1 || '',
    },
    {
        q: 'Globalization has led to the spread of similar cultures around the world. Do you think this is a positive or negative development? Give reasons and examples to support your answer.',
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        ...
        <WritingFooterIELTS023 :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />
        ...
        <!-- Submit Modal -->
        <WritingSubmitModal :is-visible="showSubmitModal" :is-time-up="isTimeUp" @close="handleCancelSubmit" @submit="handleConfirmSubmit" />
    </div>
</template>
