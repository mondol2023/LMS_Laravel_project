...
import ListeningHeaderIELTS023 from '@/components/Exam/ListeningIELTS023/ListeningHeaderIELTS023.vue';
import ListeningPart1IELTS023 from '@/components/Exam/ListeningIELTS023/ListeningPart1IELTS023.vue';
import ListeningPart2IELTS023 from '@/components/Exam/ListeningIELTS023/ListeningPart2IELTS023.vue';
import ListeningPart3IELTS023 from '@/components/Exam/ListeningIELTS023/ListeningPart3IELTS023.vue';
import ListeningPart4IELTS023 from '@/components/Exam/ListeningIELTS023/ListeningPart4IELTS023.vue';
import ListeningFooterIELTS023 from '@/components/Exam/ListeningIELTS023/ListeningFooterIELTS023.vue';
import ListeningReviewModalIELTS023 from '@/components/Exam/ListeningIELTS023/ListeningReviewModalIELTS023.vue';
import ListeningSubmitModalIELTS023 from '@/components/Exam/ListeningIELTS023/ListeningSubmitModalIELTS023.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS023 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS023 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS023 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS023 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
