...
import ReadingHeaderIELTS023 from '@/components/Exam/ReadingIELTS023/ReadingHeaderIELTS023.vue';
import ReadingPart3IELTS023 from '@/components/Exam/ReadingIELTS023/ReadingPart3IELTS023.vue';
import ReadingPart2IELTS023 from '@/components/Exam/ReadingIELTS023/ReadingPart2IELTS023.vue';
import ReadingPart1IELTS023 from '@/components/Exam/ReadingIELTS023/ReadingPart1IELTS023.vue';
import ReadingFooterIELTS023 from '@/components/Exam/ReadingIELTS023/ReadingFooterIELTS023.vue';
import ReadingReviewModalIELTS023 from '@/components/Exam/ReadingIELTS023/ReadingReviewModalIELTS023.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS023 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS023 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS023 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS023
