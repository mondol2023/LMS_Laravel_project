...
import ListeningHeaderIELTS016 from '@/components/Exam/ListeningIELTS016/ListeningHeaderIELTS016.vue';
import ListeningPart4IELTS016 from '@/components/Exam/ListeningIELTS016/ListeningPart4IELTS016.vue';
import ListeningPart3IELTS016 from '@/components/Exam/ListeningIELTS016/ListeningPart3IELTS016.vue';
import ListeningPart1IELTS016 from '@/components/Exam/ListeningIELTS016/ListeningPart1IELTS016.vue';
import ListeningPart2IELTS016 from '@/components/Exam/ListeningIELTS016/ListeningPart2IELTS016.vue';
import ListeningFooterIELTS016 from '@/components/Exam/ListeningIELTS016/ListeningFooterIELTS016.vue';
import ListeningReviewModalIELTS016 from '@/components/Exam/ListeningIELTS016/ListeningReviewModalIELTS016.vue';
import ListeningSubmitModalIELTS016 from '@/components/Exam/ListeningIELTS016/ListeningSubmitModalIELTS016.vue';
...
const listeningHeaderRef = ref<any>();
...
const handleStartExam = () => {
    ...
    // Play audio directly from user click (required by browser autoplay policy)
    listeningHeaderRef.value?.playAudio();
};
...
<template>
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        <ListeningHeaderIELTS016
            ref="listeningHeaderRef"
            :is-time-up="isTimeUp"
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS016 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS016 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS016 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS016 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
