...
import WritingHeaderIELTS016 from '@/components/Exam/WritingIELTS016/WritingHeaderIELTS016.vue';
import WritingPart2IELTS016 from '@/components/Exam/WritingIELTS016/WritingPart2IELTS016.vue';
import WritingPart1IELTS016 from '@/components/Exam/WritingIELTS016/WritingPart1IELTS016.vue';
import WritingFooterIELTS016 from '@/components/Exam/WritingIELTS016/WritingFooterIELTS016.vue';
import WritingSubmitModalIELTS016 from '@/components/Exam/WritingIELTS016/WritingSubmitModalIELTS016.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: `The diagram below shows the recycling process of aluminum cans. Write at least 150 words`,
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Some people think that companies should have the same number of male and female employees. To what extent do you agree or disagree? You should write at least 250 words.',
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        ...
        <WritingFooterIELTS016 :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />
        ...
        <!-- Submit Modal -->
        <WritingSubmitModalIELTS016 :is-visible="showSubmitModal" :is-time-up="isTimeUp" @close="handleCancelSubmit" @submit="handleConfirmSubmit" />
    </div>
</template>
