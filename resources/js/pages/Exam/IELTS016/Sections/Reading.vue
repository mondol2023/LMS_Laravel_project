...
import ReadingHeaderIELTS016 from '@/components/Exam/ReadingIELTS016/ReadingHeaderIELTS016.vue';
import ReadingPart3IELTS016 from '@/components/Exam/ReadingIELTS016/ReadingPart3IELTS016.vue';
import ReadingPart2IELTS016 from '@/components/Exam/ReadingIELTS016/ReadingPart2IELTS016.vue';
import ReadingPart1IELTS016 from '@/components/Exam/ReadingIELTS016/ReadingPart1IELTS016.vue';
import ReadingFooterIELTS016 from '@/components/Exam/ReadingIELTS016/ReadingFooterIELTS016.vue';
import ReadingSubmitModalIELTS016 from '@/components/Exam/ReadingIELTS016/ReadingSubmitModalIELTS016.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS016 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS016 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS016 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS016
