...
import ReadingHeaderIELTS020 from '@/components/Exam/ReadingIELTS020/ReadingHeaderIELTS020.vue';
import ReadingPart1IELTS020 from '@/components/Exam/ReadingIELTS020/ReadingPart1IELTS020.vue';
import ReadingPart2IELTS020 from '@/components/Exam/ReadingIELTS020/ReadingPart2IELTS020.vue';
import ReadingPart3IELTS020 from '@/components/Exam/ReadingIELTS020/ReadingPart3IELTS020.vue';
import ReadingFooterIELTS020 from '@/components/Exam/ReadingIELTS020/ReadingFooterIELTS020.vue';
import ReadingSubmitModalIELTS020 from '@/components/Exam/ReadingIELTS020/ReadingSubmitModalIELTS020.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS020 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS020  ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS020   ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS020
