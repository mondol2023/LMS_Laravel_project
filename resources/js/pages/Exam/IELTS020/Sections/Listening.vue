...
import ListeningHeaderIELTS020 from '@/components/Exam/ListeningIELTS020/ListeningHeaderIELTS020.vue';
import ListeningPart4IELTS020 from '@/components/Exam/ListeningIELTS020/ListeningPart4IELTS020.vue';
import ListeningPart3IELTS020 from '@/components/Exam/ListeningIELTS020/ListeningPart3IELTS020.vue';
import ListeningPart2IELTS020 from '@/components/Exam/ListeningIELTS020/ListeningPart2IELTS020.vue';
import ListeningPart1IELTS020 from '@/components/Exam/ListeningIELTS020/ListeningPart1IELTS020.vue';
import ListeningFooterIELTS020 from '@/components/Exam/ListeningIELTS020/ListeningFooterIELTS020.vue';
import ListeningReviewModalIELTS020 from '@/components/Exam/ListeningIELTS020/ListeningReviewModalIELTS020.vue';
import ListeningSubmitModalIELTS020 from '@/components/Exam/ListeningIELTS020/ListeningSubmitModalIELTS020.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS020 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS020 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS020 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS020 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
