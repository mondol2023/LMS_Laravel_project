...
import WritingHeaderIELTS020 from '@/components/Exam/WritingIELTS020/WritingHeaderIELTS020.vue';
import WritingPart1IELTS020 from '@/components/Exam/WritingIELTS020/WritingPart1IELTS020.vue';
import WritingFooterIELTS020 from '@/components/Exam/WritingIELTS020/WritingFooterIELTS020.vue';
import WritingSubmitModalIELTS020 from '@/components/Exam/WritingIELTS020/WritingSubmitModalIELTS020.vue';
import WritingPart2IELTS020 from '@/components/Exam/WritingIELTS020/WritingPart2IELTS020.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The chart below shows the percentage of households in three countries (Japan, Canada, and the UK) that owned various types of electronic devices in 2015 and 2025. Write at least 150 words',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Medical research is essential to improve health and deal with diseases. What do you think should fund these researches: private companies, individuals, or governments? Give reasons for your answer and include any relevant examples from your own knowledge or experience.',
...
<template>
    ...
    <div class="min-h-screen" :class="contrastClasses">
        ...
        <WritingFooterIELTS020 :active-part="activePart" @navigate="handleNavigate" @exit="handleShowSubmitModal" />
        ...
        <!-- Submit Modal -->
        <WritingSubmitModalIELTS020 :is-visible="showSubmitModal" :is-time-up="isTimeUp" @close="handleCancelSubmit" @submit="handleConfirmSubmit" />
    </div>
</template>
