...
import WritingHeaderIELTS008 from '@/components/Exam/WritingIELTS008/WritingHeader.vue';
import WritingPart1IELTS008 from '@/components/Exam/WritingIELTS008/WritingPart1.vue';
import WritingPart2IELTS008 from '@/components/Exam/WritingIELTS008/WritingPart2.vue';
import WritingFooterIELTS008 from '@/components/Exam/WritingIELTS008/WritingFooter.vue';
import WritingSubmitModalIELTS008 from '@/components/Exam/WritingIELTS008/WritingSubmitModalIELTS001.vue';
...
const handleConfirmSubmit = async () => {
    ...
    const part2Answers = writingPart2Ref.value?.getAnswers() || { part2: null };
       ...
       const questionAnswers = [
        {
            q: 'The graph below shows the number of enquiries received by the TouristInformation Office in one city over a six-month period in 2011.Write at least 150 word',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Some people believe that it is more important to teach children the literature of their owncountry than other countries.Discuss both these views and give your own opinion.Give reasons for your answer and include any relevant examples from your own knowledge or experience.',
