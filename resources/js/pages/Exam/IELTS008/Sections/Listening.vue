...
import ListeningFooterIELTS008 from '@/components/Exam/ListeningIELTS008/ListeningFooterIELTS008.vue';
import ListeningHeaderIELTS008 from '@/components/Exam/ListeningIELTS008/ListeningHeaderIELTS008.vue';
import ListeningPart1IELTS008 from '@/components/Exam/ListeningIELTS008/ListeningPart1IELTS008.vue';
import ListeningPart2IELTS008 from '@/components/Exam/ListeningIELTS008/ListeningPart2IELTS008.vue';
import ListeningPart3IELTS008 from '@/components/Exam/ListeningIELTS008/ListeningPart3IELTS008.vue';
import ListeningPart4IELTS008 from '@/components/Exam/ListeningIELTS008/ListeningPart4IELTS008.vue';
import ListeningSubmitModalIELTS008 from '@/components/Exam/ListeningIELTS008/ListeningSubmitModalIELTS008.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS008 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS008 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS008 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS008 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
