...
import ListeningFooterIELTS015 from '@/components/Exam/ListeningIELTS015/ListeningFooterIELTS015.vue';
import ListeningHeaderIELTS015 from '@/components/Exam/ListeningIELTS015/ListeningHeaderIELTS015.vue';
import ListeningPart1IELTS015 from '@/components/Exam/ListeningIELTS015/ListeningPart1IELTS015.vue';
import ListeningPart2IELTS015 from '@/components/Exam/ListeningIELTS015/ListeningPart2IELTS015.vue';
import ListeningPart3IELTS015 from '@/components/Exam/ListeningIELTS015/ListeningPart3IELTS015.vue';
import ListeningPart4IELTS015 from '@/components/Exam/ListeningIELTS015/ListeningPart4IELTS015.vue';
import ListeningReviewModalIELTS015 from '@/components/Exam/ListeningIELTS015/ListeningReviewModalIELTS015.vue';
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-black">
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <ListeningPart1IELTS015 ref="listeningPart1Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <ListeningPart2IELTS015 ref="listeningPart2Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <ListeningPart3IELTS015 ref="listeningPart3Ref" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <ListeningPart4IELTS015 ref="listeningPart4Ref" />
        </div>
        <ListeningFooterIELTS015
