...
import C19Test4ListeningFooter from '@/components/Exam/Practice/C19/Test4/Listening/C19Test4ListeningFooter.vue';
import C19Test4ListeningHeader from '@/components/Exam/Practice/C19/Test4/Listening/C19Test4ListeningHeader.vue';
import C19Test4ListeningPart1 from '@/components/Exam/Practice/C19/Test4/Listening/C19Test4ListeningPart1.vue';
...
import C19Test4ListeningReviewModal from '@/components/Exam/Practice/C19/Test4/Listening/C19Test4ListeningReviewModal.vue';
...
// Correct answers for Cambridge 19 Test 4 Listening
const correctAnswers: Record<number, string> = {
    ...
    // Part 3: Bookshop discussion (Q21-30)
    21: 'A',
    22: 'C',
    23: 'A',
    24: 'B',
...
const handleFocusNote = async (note: { part: string; selectedText: string; start: number; end: number }) => {
    ...
    setTimeout(() => {
        ...
        if (foundMark) {
            ...
            foundMark.classList.add('ring-4', 'ring-teal-400', 'ring-offset-2', 'transition-all');
            setTimeout(() => {
                foundMark?.classList.remove('ring-4', 'ring-teal-400', 'ring-offset-2');
            }, 2500);
        }
    }, 100);
};
...
const handleConfirmSubmit = async () => {
    ...
    try {
        ...
        router.post('/practice/results/listening/8', {
...
<template>
    <Head title="C19 Test 4 Listening Section - Nextive Solution" />

    <div class="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50 text-black">
        <C19Test4ListeningHeader
            :is-time-up="isTimeUp"
        ...
        <div :class="{ hidden: activePart !== 'part1' }">
            <C19Test4ListeningPart1 ref="listeningPart1Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part2' }">
            <C19Test4ListeningPart2 ref="listeningPart2Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part3' }">
            <C19Test4ListeningPart3 ref="listeningPart3Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <div :class="{ hidden: activePart !== 'part4' }">
            <C19Test4ListeningPart4 ref="listeningPart4Ref" :phone="userPhone" :exam-id="examId" />
        </div>
        <C19Test4ListeningFooter
