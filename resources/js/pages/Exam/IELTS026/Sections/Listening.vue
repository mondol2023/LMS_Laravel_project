...
import ListeningHeaderIELTS026 from '@/components/Exam/ListeningIELTS026/ListeningHeaderIELTS026.vue';
import ListeningPart1IELTS026 from '@/components/Exam/ListeningIELTS026/ListeningPart1IELTS026.vue';
import ListeningPart2IELTS026 from '@/components/Exam/ListeningIELTS026/ListeningPart2IELTS026.vue';
import ListeningPart3IELTS026 from '@/components/Exam/ListeningIELTS026/ListeningPart3IELTS026.vue';
import ListeningPart4IELTS026 from '@/components/Exam/ListeningIELTS026/ListeningPart4IELTS026.vue';
import ListeningFooterIELTS026 from '@/components/Exam/ListeningIELTS026/ListeningFooterIELTS026.vue';
import ListeningReviewModalIELTS026 from '@/components/Exam/ListeningIELTS026/ListeningReviewModalIELTS026.vue';
import ListeningSubmitModalIELTS026 from '@/components/Exam/ListeningIELTS026/ListeningSubmitModalIELTS026.vue';
    ...
    <div class="relative min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div :class="[contrastClasses, 'parts-container min-h-screen transition-colors duration-300']" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ListeningPart1IELTS026 ref="listeningPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ListeningPart2IELTS026 ref="listeningPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ListeningPart3IELTS026 ref="listeningPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part4' }">
                <ListeningPart4IELTS026 ref="listeningPart4Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>
