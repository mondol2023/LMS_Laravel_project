...
import ReadingFooter from '@/components/Exam/Reading/ReadingFooter.vue';
import ReadingHeader from '@/components/Exam/Reading/ReadingHeader.vue';
import ReadingPart1 from '@/components/Exam/Reading/ReadingPart1.vue';
import ReadingPart2 from '@/components/Exam/Reading/ReadingPart2.vue';
import ReadingPart3 from '@/components/Exam/Reading/ReadingPart3.vue';
import ReadingReviewModal from '@/components/Exam/Reading/ReadingReviewModal.vue';
import ReadingSubmitModal from '@/components/Exam/Reading/ReadingSubmitModalIELTS001.vue';
import ReadingHeaderIELTS026 from '@/components/Exam/ReadingIELTS026/ReadingHeaderIELTS026.vue';
import ReadingPart1IELTS026 from '@/components/Exam/ReadingIELTS026/ReadingPart1IELTS026.vue';
import ReadingPart3IELTS026 from '@/components/Exam/ReadingIELTS026/ReadingPart3IELTS026.vue';
import ReadingPart2IELTS026 from '@/components/Exam/ReadingIELTS026/ReadingPart2IELTS026.vue';
import ReadingFooterIELTS026 from '@/components/Exam/ReadingIELTS026/ReadingFooterIELTS026.vue';
import ReadingReviewModalIELTS026 from '@/components/Exam/ReadingIELTS026/ReadingReviewModalIELTS026.vue';
import ReadingSubmitModalIELTS026 from '@/components/Exam/ReadingIELTS026/ReadingSubmitModalIELTS026.vue';
    ...
    <div class="hide-scrollbar min-h-screen text-black" :class="bgColor === 'gray' ? 'bg-gray-100' : 'bg-white'">
        ...
        <div class="parts-container" :class="contrastClasses" :data-theme="contrastTheme">
            <div :class="{ hidden: activePart !== 'part1' }">
                <ReadingPart1IELTS026 ref="readingPart1Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part2' }">
                <ReadingPart2IELTS026 ref="readingPart2Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
            <div :class="{ hidden: activePart !== 'part3' }">
                <ReadingPart3IELTS026 ref="readingPart3Ref" :font-size="fontSize" :flagged-questions="flaggedQuestions" @toggle-flag="handleToggleFlag" />
            </div>
        </div>

        <ReadingFooterIELTS026
