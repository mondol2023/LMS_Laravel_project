...
import WritingHeaderIELTS026 from '@/components/Exam/WritingIELTS026/WritingHeaderIELTS026.vue';
import WritingPart1IELTS026 from '@/components/Exam/WritingIELTS026/WritingPart1IELTS026.vue';
import WritingPart2IELTS026 from '@/components/Exam/WritingIELTS026/WritingPart2IELTS026.vue';
import WritingFooterIELTS026 from '@/components/Exam/WritingIELTS026/WritingFooterIELTS026.vue';
...
const handleConfirmSubmit = async () => {
  ...
  const questionAnswers = [
    {
        q: 'The line graph displays the trends in the number of students from the United States, the United Kingdom, and Australia who chose to pursue education in foreign universities from 2002 to 2007. Summarize the information by selecting and reporting the main features, and make comparisons where relevant.',
        ans: part1Answers.part1 || '',
    },
    {
        q: 'Environmental pollution is increasing despite public awareness campaigns. To what extent should governments, rather than individuals, be responsible for solving environmental problems? Give reasons for your answer and include any relevant examples from your own knowledge or experience.',
...
const handleForceSubmit = async () => {
    ...
    const questionAnswers = [
        {
            q: 'The line  graph compares the amount of money spent on research into renewable energy per person in Switzerland,Denmark, Spain, and the UK over a span of 25 years.Summarise the information by selecting and reporting the main features, and make comparisons where relevant.',
            ans: part1Answers.part1 || '',
        },
        {
            q: 'Modern lifestyles have made people less physically active than before.What problems does this cause, and what measures can be taken to encourage people to live more active lives?',
            ans: part2Answers.part2 || '',
        },
    ];
