...
<template>
    <Head title="Listening Test 8 - Part 1" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Questions 1-6: Write ONE WORD AND/OR A NUMBER</li>
                    <li>• Questions 7-10: Write ONE WORD ONLY</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C19Test4ListeningPart1 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
