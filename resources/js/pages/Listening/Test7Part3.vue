...
<template>
    <Head title="Listening Test 7 - Part 3" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Q21-25: Choose the correct letter A, B or C</li>
                    <li>• Q26-30: Complete the flowchart (choose A-H)</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C19Test3ListeningPart3 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
