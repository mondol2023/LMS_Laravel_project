...
const testNumber = 3;
const partNumber = 3;
const audioSrc = '/audio/Practice/C20T3P3.mp3'; // C20 Test 3 full audio
...
<template>
    <Head title="Listening Test 3 - Part 3" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Q21-26: Choose the correct letter A, B or C</li>
                    <li>• Q27-30: Match items with letters A-F</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C20Test3ListeningPart3 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
