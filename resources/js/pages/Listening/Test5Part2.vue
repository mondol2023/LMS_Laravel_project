...
<template>
    <Head title="Listening Test 5 - Part 2" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Q11-15: Choose the correct letter A, B or C</li>
                    <li>• Q16-20: Label the map with letters A-H</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C19Test1ListeningPart2 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
