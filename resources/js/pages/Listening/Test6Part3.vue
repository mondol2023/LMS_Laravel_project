...
const testNumber = 6;
const partNumber = 3;
const audioSrc = '/audio/listening16.mp3'; // C19 Test 2 full audio
...
<template>
    <Head title="Listening Test 6 - Part 3" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Q21-24, Q29-30: Choose the correct letter A, B or C</li>
                    <li>• Q25-28: Match items with statements A-F</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C19Test2ListeningPart3 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
