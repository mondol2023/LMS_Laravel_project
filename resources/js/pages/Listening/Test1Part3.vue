...
const testNumber = 1;
const partNumber = 3;
const audioSrc = '/audio/Practice/C20T1P3.mp3'; // C20 Test 1 full audio
...
<template>
    <Head title="Listening Test 1 - Part 3" />
        ...
        <div class="mx-auto max-w-7xl px-4 py-6">
            <div class="mb-4 rounded-lg bg-white p-4 shadow">
                ...
                <ul class="space-y-1 text-sm text-gray-600">
                    ...
                    <li>• Q21-26: Choose TWO letters for each question pair</li>
                    <li>• Q27-30: Choose the correct letter A, B or C</li>
                </ul>
            </div>

            <div class="rounded-lg bg-white shadow">
                <C20Test1ListeningPart3 ref="listeningPartRef" />
            </div>
        </div>
    </div>
</template>
