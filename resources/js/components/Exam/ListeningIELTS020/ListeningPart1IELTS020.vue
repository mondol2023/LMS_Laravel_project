...
const textSegments = ref([
    ...
    { id: 0, text: 'Questions 1–10', offset: 39 },
    { id: 1, text: 'Complete the notes below. Write ', offset: 53 },
    { id: 2, text: 'NO MORE THAN TWO WORDS AND/OR A NUMBER', offset: 85 },
    { id: 3, text: 'Freshopolis Supermarket — Job Information', offset: 123 },
    { id: 4, text: 'Job: filling shelves', offset: 164 },
    { id: 5, text: 'Job is', offset: 184 },
    { id: 6, text: '4 days a week', offset: 190 },
    { id: 7, text: 'Working days vary — some evenings and some', offset: 203 },
    { id: 8, text: 'mornings', offset: 245 },
    { id: 9, text: 'Location:', offset: 253 },
    { id: 10, text: 'Road branch; near the cinema', offset: 262 },
    { id: 11, text: 'Basic wages: £', offset: 290 },
    { id: 12, text: 'per hour', offset: 304 },
    { id: 13, text: 'Benefits:', offset: 312 },
    { id: 14, text: '20% on all supermarket items', offset: 321 },
    { id: 15, text: 'Lunch/dinner from', offset: 349 },
    { id: 16, text: 'Bus Voucher scheme — cheaper bus tickets', offset: 366 },
    { id: 17, text: 'scheme for cyclists', offset: 406 },
    { id: 18, text: 'Interview:', offset: 425 },
    { id: 19, text: 'Tuesday at', offset: 435 },
    { id: 20, text: 'Take', offset: 445 },
    { id: 21, text: 'to interview', offset: 449 },
    { id: 22, text: 'At Freshopolis office in city centre', offset: 461 },
    { id: 23, text: 'Ask for Alex', offset: 497 },
]);
                    ...
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-4">
                            ...
                            <div >
                                ...
                                <span class="mb-2 text-base text-gray-800" data-segment-id="4"
                                    v-html="getHighlightedSegmentById(4)"></span>
                                </div>

                                <div class="space-y-2 text-base leading-relaxed text-gray-800">

                                    <!-- Q1: Job is ___ 4 days a week -->
                                    <div id="question-1" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 1" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="5"
                                    ...
                                    <!-- Q2: Working days vary — some evenings and some ___ mornings -->
                                    <div id="question-2" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 2" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="7"
                                    ...
                                    <!-- Q3: Location: ___ Road branch; near the cinema -->
                                    <div id="question-3" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 3" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="9"
                                    ...
                                    <!-- Q4: Basic wages: £___ per hour -->
                                    <div id="question-4" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 4" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="11"
                            ...
                            <!-- Benefits Section -->
                            <div class=" pt-4">
                                <h3 class="mb-2 text-lg font-bold text-gray-900" data-segment-id="13"
                                    v-html="getHighlightedSegmentById(13)"></h3>

                                <div class="space-y-2 text-base leading-relaxed text-gray-800">

                                    <!-- Q5: ___ 20% on all supermarket items -->
                                    <div id="question-5" class="flex flex-wrap items-center gap-0.5"
                                    ...
                                    <!-- Q6: Lunch/dinner from ___ -->
                                    <div id="question-6" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 6" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="15"
                                    ...
                                    <!-- Bus Voucher (no question) -->
                                    <div class="flex flex-wrap items-center gap-0.5">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="16"
                                            v-html="getHighlightedSegmentById(16)"></span>
                                    </div>

                                    <!-- Q7: ___ scheme for cyclists -->
                                    <div id="question-7" class="flex flex-wrap items-center gap-0.5"
                            ...
                            <!-- Interview Section -->
                            <div class=" pt-4">
                                <h3 class="mb-2 text-lg font-bold text-gray-900" data-segment-id="18"
                                    v-html="getHighlightedSegmentById(18)"></h3>

                                <div class="space-y-2 text-base leading-relaxed text-gray-800">

                                    <!-- Q8: Tuesday at ___ -->
                                    <div id="question-8" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 8" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="19"
                                    ...
                                    <!-- Q9: Take ___ to interview -->
                                    <div id="question-9" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 9" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="20"
                                        ...
                                        <input v-model="answers.q9" type="text" spellcheck="false"
                                            ...
                                            @blur="hoveredQuestion = null" />
                                        <span class="text-gray-800" data-segment-id="21"
                                    ...
                                    <!-- At Freshopolis office (no question) -->
                                    <div class="flex flex-wrap items-center gap-0.5">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="22"
                                            v-html="getHighlightedSegmentById(22)"></span>
                                    </div>

                                    <!-- Q10: Ask for Alex ___ -->
                                    <div id="question-10" class="flex flex-wrap items-center gap-0.5"
                                        @mouseenter="hoveredQuestion = 10" @mouseleave="hoveredQuestion = null">
                                        <span class="text-gray-800">•</span>
                                        <span class="ml-1 text-gray-800" data-segment-id="23"
