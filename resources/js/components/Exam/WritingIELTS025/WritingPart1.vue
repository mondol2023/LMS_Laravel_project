...
const questionText = ref(`The pie charts below illustrate the distribution of water on Earth in different forms, while the bar graph compares the usuage  of water in three countries for domestic ,industrial, and agricultural purposes.
                ...
                <div class="max-h-screen overflow-y-auto p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/writing025.png" alt="Water usage charts by country" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
            ...
            <div ref="containerRef" class="relative hidden flex-col gap-0 lg:flex lg:flex-row" :class="{ 'select-none': isResizing }">
                ...
                <div class="question-panel mb-4 max-h-screen overflow-y-auto p-4 sm:p-6 lg:mb-0" :style="{ '--panel-width': `${leftPanelWidth}%` }">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/writing025.png" alt="Village development diagrams" class="mx-auto h-full" />
                        </div>
                ...
                <div class="answer-panel max-h-screen overflow-y-auto p-4 sm:p-6" :style="{ '--panel-width': `${leftPanelWidth}%` }">
                    <textarea
                        v-model="answer"
                        :style="textStyle"
                        class="h-[30vh] w-full resize-none border border-gray-400 p-3 text-black transition-all duration-200 focus:border-black focus:outline-none sm:h-[40vh] sm:p-4 lg:h-[55vh]"
                        placeholder="Write your answer here..."
                        spellcheck="false"
                    ></textarea>
                    <div class="mt-2 flex justify-end">
