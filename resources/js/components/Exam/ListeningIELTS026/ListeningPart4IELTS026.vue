...
// Listening Section 4 - Research on birds in Australia
const answers = ref({
    q31: '',
    q32: '',
    q33: '',
...
const textSegments = ref([
    // Part header
    { id: 'part4-title', text: 'SECTION 4', offset: 0 },
    { id: 'part4-desc', text: 'Listen and answer questions 31–40.', offset: 10 },
    // Instructions
    { id: 0, text: 'Questions 31–40', offset: 45 },
    { id: 1, text: 'Complete the notes below. Write ', offset: 61 },
    { id: 2, text: 'ONE WORD ONLY', offset: 93 },
    { id: 3, text: ' for each answer.', offset: 106 },
    // Title
    { id: 4, text: 'Research on birds in Australia', offset: 124 },
    // Study 1 header
    { id: 5, text: 'The study Cunningham in 1995', offset: 155 },
    { id: 6, text: 'It aimed to study birds which were', offset: 184 },
    { id: 7, text: 'in cities', offset: 219 },
    // Methodology
    { id: 8, text: 'Methodology', offset: 229 },
    { id: 9, text: '• Researchers were able to', offset: 242 },
    { id: 10, text: 'rather than count the number of birds by', offset: 277 },
    { id: 11, text: 'some methods, such as random sampling.', offset: 327 },
    { id: 12, text: '• Researchers studied bird\'s companionship habits using a', offset: 367 },
    { id: 13, text: 'system.', offset: 432 },
    { id: 14, text: '• Research attached tags to birds\' legs to identify their', offset: 441 },
    { id: 15, text: 'over time.', offset: 496 },
    // Findings
    { id: 16, text: 'Findings', offset: 507 },
    { id: 17, text: '• Birds tended to choose the same nesting site in which they were raised', offset: 517 },
    { id: 18, text: '• Human activities such', offset: 598 },
    { id: 19, text: 'had a negative effect on the reproduction', offset: 623 },
    { id: 20, text: 'of birds', offset: 673 },
    // Measures
    { id: 21, text: 'Measures taken by local organisation:', offset: 681 },
    { id: 22, text: '• To increase birds\' rate of', offset: 719 },
    { id: 23, text: 'in various ways', offset: 754 },
    { id: 24, text: '• To reduce the dangers caused by', offset: 771 },
    { id: 25, text: 'farms, e.g., colliding with', offset: 813 },
    // Study 2
    { id: 26, text: 'The study by Conway in 2006', offset: 842 },
    { id: 27, text: '• Researchers monitored the', offset: 870 },
    { id: 28, text: 'of birds\' nocturnal callings during', offset: 904 },
    { id: 29, text: 'flight', offset: 940 },
    { id: 30, text: '•', offset: 947 },
    { id: 31, text: 'were taken to listen to birds\'', offset: 955 },
    { id: 32, text: 'sounds', offset: 990 },
    { id: 33, text: '• Data could be collected through noise direction devices placed at a great', offset: 998 },
]);
    ...
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick" class="px-4 py-2 pb-24 select-text sm:px-6">
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <div class="mb-3 rounded border border-gray-200 bg-gray-100 px-4 py-3" @mouseup="handleContentTextSelect">
                <h3 class="text-base font-bold text-gray-900 select-text" data-segment-id="part4-title" v-html="getHighlightedSegmentById('part4-title')"></h3>
                <p class="text-sm text-gray-700 select-text" data-segment-id="part4-desc" v-html="getHighlightedSegmentById('part4-desc')"></p>
            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 text-base leading-relaxed text-gray-800">
                                    ...
                                    <div class="flex flex-wrap items-center gap-1">
                                        <span class="font-bold text-gray-800" data-segment-id="5" v-html="getHighlightedSegmentById(5)"></span>
                                    </div>

                                    <!-- Q31: birds which were ___ in cities (no bullet) -->
                                    ...
                                    <!-- Methodology -->
                                    <div class="flex flex-wrap items-center gap-1">
                                        <span class="font-bold text-gray-800" data-segment-id="8" v-html="getHighlightedSegmentById(8)"></span>
                                    </div>

                                    <!-- Q32: • Researchers were able to ___ rather than count... -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Q33: • Researchers studied bird's companionship habits using a ___ system. -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Q34: • Research attached tags to birds' legs to identify their ___ over time. -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Findings -->
                                    <div class="flex flex-wrap items-center gap-1">
                                        <span class="font-bold text-gray-800" data-segment-id="16" v-html="getHighlightedSegmentById(16)"></span>
                                    </div>
                                    ...
                                    <!-- Q35: • Human activities such ___ had a negative effect on the reproduction of birds -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Measures -->
                                    <div class="flex flex-wrap items-center gap-1">
                                        <span class="font-bold text-gray-800" data-segment-id="21" v-html="getHighlightedSegmentById(21)"></span>
                                    </div>

                                    <!-- Q36: • To increase birds' rate of ___ in various ways -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Q37: • To reduce the dangers caused by ___ farms, e.g., colliding with -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                    ...
                                    <!-- Study 2 header -->
                                    <div class="flex flex-wrap items-center gap-1">
                                        <span class="font-bold text-gray-800" data-segment-id="26" v-html="getHighlightedSegmentById(26)"></span>
                                    </div>

                                    <!-- Q38: • Researchers monitored the ___ of birds' nocturnal callings during flight -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                        <span class="text-gray-800" data-segment-id="27" v-html="getHighlightedSegmentById(27)"></span>
                                        <span
                                            id="question-38"
                                            class="group relative inline-flex items-center gap-1"
                                        ...
                                        <span class="text-gray-800" data-segment-id="28" v-html="getHighlightedSegmentById(28)"></span>
                                        <span class="text-gray-800" data-segment-id="29" v-html="getHighlightedSegmentById(29)"></span>
                                    </div>

                                    <!-- Q39: • ___ were taken to listen to birds' sounds -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                        <span class="text-gray-800" data-segment-id="30" v-html="getHighlightedSegmentById(30)"></span>
                                        <span
                                            id="question-39"
                                            class="group relative inline-flex items-center gap-1"
                                        ...
                                        <span class="text-gray-800" data-segment-id="31" v-html="getHighlightedSegmentById(31)"></span>
                                        <span class="text-gray-800" data-segment-id="32" v-html="getHighlightedSegmentById(32)"></span>
                                    </div>

                                    <!-- Q40: • Data could be collected through noise direction devices placed at a great ___ -->
                                    <div class="flex flex-wrap items-center gap-1 pl-4">
                                        <span class="text-gray-800" data-segment-id="33" v-html="getHighlightedSegmentById(33)"></span>
                                        <span
                                            id="question-40"
                                            class="group relative inline-flex items-center gap-1"
