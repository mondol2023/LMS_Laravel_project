...
const questionText = ref(`The diagram below shows the recycling process of aluminum cans.
                ...
                <div class="max-h-screen overflow-y-auto p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text font-bold sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS016.jpg" alt="the recycling process of aluminum cans." class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
