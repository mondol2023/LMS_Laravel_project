...
const textSegments = ref([
    ...
    { id: 'part1-desc', text: 'Questions 1–10', offset: 9 },
    // Instruction section text segments
    { id: 0, text: 'Questions 1–5', offset: 24 },
    { id: 1, text: 'Complete the notes below. Write ', offset: 37 },
    { id: 2, text: 'NO MORE THAN ONE WORD AND/OR A NUMBER', offset: 69 },
    { id: 3, text: 'for each answer.', offset: 107 },
    // Table title
    { id: 4, text: 'Second-hand Bedroom Furniture for Sale', offset: 124 },
    // Example box

    // Bedside tables section
    { id: 9, text: 'Bedside tables', offset: 210 },
    { id: 10, text: 'Construction:', offset: 225 },
    { id: 11, text: 'wood', offset: 239 },
    { id: 12, text: 'Colour:', offset: 244 },
    { id: 13, text: 'Drawers:', offset: 252 },
    { id: 14, text: 'two (in each table)', offset: 261 },
    { id: 15, text: 'handles made of', offset: 281 },
    { id: 16, text: 'Height:', offset: 297 },
    { id: 17, text: 'cm', offset: 305 },
    { id: 18, text: 'Condition:', offset: 308 },
    { id: 19, text: 'Price:', offset: 319 },
    { id: 20, text: '(for both)', offset: 326 },
    // Questions 6-10 header
    { id: 21, text: 'Questions 6–10', offset: 337 },
    { id: 22, text: 'Complete the notes below. Write ', offset: 352 },
    { id: 23, text: 'NO MORE THAN ONE WORD AND/OR A NUMBER', offset: 384 },
    { id: 24, text: 'for each answer.', offset: 422 },
    // Dressing table section
    { id: 25, text: 'Dressing table', offset: 439 },
    { id: 26, text: 'Drawers:', offset: 454 },
    { id: 27, text: 'five (two are', offset: 463 },
    { id: 28, text: ')', offset: 477 },
    { id: 29, text: 'Width:', offset: 479 },
    { id: 30, text: 'Mirrors:', offset: 486 },
    { id: 31, text: 'three: one large, two small (all', offset: 495 },
    { id: 32, text: ')', offset: 527 },
    { id: 33, text: 'Condition:', offset: 529 },
    { id: 34, text: 'good', offset: 540 },
    { id: 35, text: 'Price:', offset: 545 },
    // Seller's details
    { id: 36, text: "Seller's details", offset: 552 },
    { id: 37, text: 'Name:', offset: 569 },
    { id: 38, text: 'Carolyn Kline', offset: 575 },
    { id: 39, text: 'Address:', offset: 589 },
    { id: 40, text: '19', offset: 598 },
    { id: 41, text: 'Road', offset: 601 },
]);
...
<template>
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick"
        ...
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <div class="mb-3 rounded part-header-box border border-gray-200  px-4 py-3" @mouseup="handleContentTextSelect">
            ...
            <div class="shrink-0 px-2 pb-2 sm:px-3" @mouseup="handleContentTextSelect">
                ...
                <p class="text-sm text-gray-700 select-text">
                    <span data-segment-id="1" v-html="getHighlightedSegmentById(1)"></span><span class="font-bold"
                        data-segment-id="2" v-html="getHighlightedSegmentById(2)"></span>
                    <span> </span><span data-segment-id="3" v-html="getHighlightedSegmentById(3)"></span>
                </p>
            </div>
                ...
                <div class="p-2 sm:p-3">
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-6">
                            ...
                            <!-- Bedside Tables Section -->
                            <div>
                                <h3 class="mb-3 text-base font-bold text-gray-900 select-text" data-segment-id="9"
                                    v-html="getHighlightedSegmentById(9)"></h3>

                                <div class="space-y-3 text-base leading-relaxed text-gray-800">

                                    <!-- Construction row (static) -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="10"
                                    ...
                                    <!-- Colour: Q1 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="12"
                                            v-html="getHighlightedSegmentById(12)"></span>
                                        <span id="question-1" class="group relative inline-flex items-center gap-0.5"
                                            ...
                                            <input v-model="answers.q1" type="text" spellcheck="false"
                                                ...
                                                placeholder="1" @focus="hoveredQuestion = 1"
                                    ...
                                    <!-- Drawers row (static + Q2) -->
                                    <div class="flex flex-wrap items-start gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="13"
                                    ...
                                    <!-- Height: Q3 cm -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="16"
                                            v-html="getHighlightedSegmentById(16)"></span>
                                        <span id="question-3" class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Condition: Q4 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="18"
                                            v-html="getHighlightedSegmentById(18)"></span>
                                        <span id="question-4" class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Price: 5£... (for both) -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="19"
                                            v-html="getHighlightedSegmentById(19)"></span>
                                        <span class="text-gray-800">5 £</span>
                                        <span id="question-5" class="group relative inline-flex items-center gap-0.5"
                                            ...
                                            <input v-model="answers.q5" type="text" spellcheck="false"
                                                ...
                                                @blur="hoveredQuestion = null" />
                                                <span class="text-gray-800" data-segment-id="20"
                            ...
                            <!-- Divider + Q6-10 header -->
                            <div class=" pt-4">
                                <div class="shrink-0 pb-2" @mouseup="handleContentTextSelect">
                                    <p class="text-base font-bold text-gray-900 select-text" data-segment-id="21"
                                        v-html="getHighlightedSegmentById(21)"></p>
                                    <p class="text-sm text-gray-700 select-text">
                                        <span data-segment-id="22" v-html="getHighlightedSegmentById(22)"></span><span
                                            class="font-bold" data-segment-id="23"
                                            v-html="getHighlightedSegmentById(23)"></span>
                                        <span> </span><span data-segment-id="24"
                                            v-html="getHighlightedSegmentById(24)"></span>
                                    </p>
                                </div>

                                <!-- Dressing Table Section -->
                                <h3 class="mb-3 mt-2 text-base font-bold text-gray-900 select-text" data-segment-id="25"
                                    v-html="getHighlightedSegmentById(25)"></h3>

                                <div class="space-y-3 text-base leading-relaxed text-gray-800">

                                    <!-- Drawers: five (two are Q6) -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="26"
                                        ...
                                        <span id="question-6" class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Width: Q7 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="29"
                                            v-html="getHighlightedSegmentById(29)"></span>
                                        <span id="question-7" class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Mirrors: three: one large, two small (all Q8) -->
                                    <div class="flex flex-wrap items-start gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="30"
                                            v-html="getHighlightedSegmentById(30)"></span>
                                        <div class="flex flex-col gap-1">
                                            <span class="text-gray-800" data-segment-id="31"
                                            ...
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span id="question-8"
                                                    ...
                                                    <input v-model="answers.q8" type="text" spellcheck="false"
                                                        ...
                                                        @blur="hoveredQuestion = null" />
                                                        <span class="text-gray-800" data-segment-id="32"
                                    ...
                                    <!-- Condition: good (static) -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="33"
                                            v-html="getHighlightedSegmentById(33)"></span>
                                        <span class="text-gray-800" data-segment-id="34"
                                            v-html="getHighlightedSegmentById(34)"></span>
                                    </div>

                                    <!-- Price: Q9 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="w-36 text-gray-800" data-segment-id="35"
                                            v-html="getHighlightedSegmentById(35)"></span>
                                        <span class="text-gray-800">£</span>
                                        <span id="question-9" class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Seller's Details -->
                                    <div class=" pt-3">
                                        <h4 class="mb-2 text-base font-bold text-gray-900 select-text"
                                            data-segment-id="36" v-html="getHighlightedSegmentById(36)"></h4>

                                        <!-- Name: Carolyn Kline (static) -->
                                        <div class="mb-2 flex flex-wrap items-center gap-2">
                                            <span class="w-36 text-gray-800" data-segment-id="37"
                                                v-html="getHighlightedSegmentById(37)"></span>
                                            <span class="text-gray-800" data-segment-id="38"
                                                v-html="getHighlightedSegmentById(38)"></span>
                                        </div>

                                        <!-- Address: 19 Q10 Road -->
                                        <div class="flex flex-wrap items-center gap-2">
                                            <span class="w-36 text-gray-800" data-segment-id="39"
                                                v-html="getHighlightedSegmentById(39)"></span>
                                            <span class="text-gray-800" data-segment-id="40"
                                                v-html="getHighlightedSegmentById(40)"></span>
                                            <span id="question-10"
                                                class="group relative inline-flex items-center gap-0.5"
                                                ...
                                                <input v-model="answers.q10" type="text" spellcheck="false"
                                                    ...
                                                    @blur="hoveredQuestion = null" />
                                                     <span class="text-gray-800" data-segment-id="41"
                                                v-html="getHighlightedSegmentById(41)"></span>
