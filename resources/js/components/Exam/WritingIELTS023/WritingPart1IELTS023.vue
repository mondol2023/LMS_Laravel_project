...
const questionText = ref(`The bar graph illustrates the percentage of adults in various age brackets who used the internet between 2003 and 2006.
Summarize the information by selecting and reporting the main features ,and make comparisons where relevant.`);

// Header text segments for highlighting
const headerTextSegments = ref([
    { id: 'header-title', text: 'Part 1', offset: -100 },
    { id: 'header-instructions', text: 'You should spend about 20 minutes on this task. Write at least 150 words.', offset: -50 },
]);
...
<template>
    <div class="min-h-screen overflow-y-auto pb-20 sm:pb-24 md:pb-32">
        ...
        <div class="mx-4 part-header-box mt-2 border-b-1 border-gray-400 bg-gray-100 px-4 py-3 sm:mx-6 lg:mx-8"
                ...
                <div class="max-h-screen overflow-y-auto p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS023.png" alt="Water usage charts by country" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
            ...
            <div ref="containerRef" class="relative hidden flex-col gap-0 lg:flex lg:flex-row" :class="{ 'select-none': isResizing }">
                ...
                <div class="question-panel mb-4 max-h-screen overflow-y-auto p-4 sm:p-6 lg:mb-0" :style="{ '--panel-width': `${leftPanelWidth}%` }">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS020.png" alt="Water usage charts by country" class="mx-auto h-full" />
                        </div>
