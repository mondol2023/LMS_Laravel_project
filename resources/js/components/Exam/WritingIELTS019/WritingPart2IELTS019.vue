...
const questionText = ref(`Scientists are saying that the earth’s energy resources are running out, but people still do not show much concern about this problem. What can be done to make people more aware of this issue and encourage them to act responsibly ?
