...
The four pie charts below show the proportion of Australians aged 17 to 65 who watched television. The bar chart shows how much time people in different age groups spent watching TV. Summarize the information by selecting and reporting the main features, and making comparisons where relevant.
                ...
                <div class="max-h-screen overflow-y-auto p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS019.png" alt="Water usage charts by country" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
