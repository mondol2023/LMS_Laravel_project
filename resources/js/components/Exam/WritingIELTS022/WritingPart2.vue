...
const questionText = ref(`Some people believe that mental training, such as building self-confidence, is more important for sportspeople than physical training.
