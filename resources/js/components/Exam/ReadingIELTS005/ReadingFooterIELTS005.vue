...
// Question ranges for each part (IELTS005 Reading: 13, 13, 14 questions)
const partQuestions = {
    part1: Array.from({ length: 13 }, (_, i) => i + 1),      // 1-13
    part2: Array.from({ length: 13 }, (_, i) => i + 14),     // 14-26
    part3: Array.from({ length: 14 }, (_, i) => i + 27),     // 27-40
};
