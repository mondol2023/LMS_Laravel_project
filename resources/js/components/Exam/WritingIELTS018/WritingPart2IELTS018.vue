...
const questionText = ref(`Task 2
Some people believe that every society needs public spaces such as parks and squares for relaxation and recreational activities. To what extent do you agree or disagree ?
