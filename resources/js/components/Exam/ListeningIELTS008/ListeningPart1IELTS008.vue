...
const textSegments = ref([
    ...
    { id: 39,text: 'QUESTIONS 1-10', offset: 39 },
    { id: 53,text: 'Choose the correct answer for each question.', offset: 53 },
    { id: 97,text: 'Complete the notes below.', offset: 97 },
    { id: 122,text: 'Write NO MORE THAN TWO WORDS OR A NUMBER for each answer.', offset: 122 },
    { id: 179,text: 'Health club customer research', offset: 179 },
    { id: 208,text: 'Example', offset: 208 },
    { id: 215,text: 'Answer', offset: 215 },
    { id: 221,text: 'Name:', offset: 221 },
    { id: 226,text: 'Selina Thompson', offset: 226 },
    { id: 241,text: 'Occupation:', offset: 241 },
    { id: 252,text: 'Age group:', offset: 252 },
    { id: 262,text: 'Type of membership:', offset: 262 },
    { id: 281,text: 'Length of membership:', offset: 281 },
    { id: 302,text: 'years', offset: 302 },
    { id: 307,text: 'Why joined:', offset: 307 },
    { id: 318,text: 'recommended by a', offset: 318 },
    { id: 334,text: 'Visits to club per month:', offset: 334 },
    { id: 359,text: 'Eight (on average)', offset: 359 },
    { id: 377,text: 'Facility used most:', offset: 377 },
    { id: 396,text: 'Facility not used (if any):', offset: 396 },
    { id: 423,text: 'tennis courts', offset: 423 },
    { id: 436,text: '(because reluctant to', offset: 436 },
    { id: 457,text: ')', offset: 457 },
    { id: 458,text: 'Suggestions for', offset: 458 },
    { id: 473,text: 'improvements:', offset: 473 },
    { id: 486,text: 'have more', offset: 486 },
    { id: 495,text: 'Install', offset: 495 },
    { id: 502,text: 'in the gym', offset: 502 },
    { id: 512,text: 'Open', offset: 512 },
    { id: 516,text: 'later at weekends', offset: 516 },
]);
...
<template>
    ...
    <div class="flex min-h-screen w-full flex-col" >
        ...
        <div class="shrink-0 px-2 pb-3 sm:px-3" @mouseup="handleContentTextSelect">
            <p class="text-base font-bold text-gray-900 select-text" data-segment-id="39" v-html="getHighlightedSegmentById(39)"></p>
            <p class="text-sm text-gray-700 select-text" data-segment-id="53" v-html="getHighlightedSegmentById(53)"></p>
            <p class="text-sm text-gray-700 select-text" data-segment-id="97" v-html="getHighlightedSegmentById(97)"></p>
            <p class="text-sm text-gray-700 select-text" data-segment-id="122" v-html="getHighlightedSegmentById(122)"></p>
        </div>
        ...
        <div class="mb-30 ml-4 bg-white" @mouseup="handleContentTextSelect">
            ...
            <div class="mb-4 border-b border-gray-300 pb-3">
                <p class="text-base font-semibold text-gray-900 select-text" data-segment-id="179" v-html="getHighlightedSegmentById(179)"></p>
            </div>

            <!-- Example / Answer header -->
            <div class="mb-2 flex items-center gap-4 text-sm font-bold text-gray-900 select-text">
                <span class="inline-block w-48" data-segment-id="208" v-html="getHighlightedSegmentById(208)"></span>
                <span data-segment-id="215" v-html="getHighlightedSegmentById(215)"></span>
            </div>

            <!-- Name (example row) -->
            <div class="mb-4 flex items-center gap-2 text-sm text-gray-900">
                <span class="inline-block w-48 font-bold" data-segment-id="221" v-html="getHighlightedSegmentById(221)"></span>
                <span data-segment-id="226" v-html="getHighlightedSegmentById(226)"></span>
            </div>
            ...
            <div class="space-y-4">
                <!-- Q1: Occupation -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="241" v-html="getHighlightedSegmentById(241)"></span>
                    <span class="ml-2">
                        <span
                            id="question-1"
                        ...
                        >
                            <input
                                ...
                                type="text"
                                placeholder="1"
                                class="w-40 border border-gray-400 bg-transparent px-2 py-0.5 text-center placeholder:font-bold placeholder:text-gray-900 focus:border-gray-600 focus:outline-none"
                ...
                <!-- Q2: Age group -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="252" v-html="getHighlightedSegmentById(252)"></span>
                    <span class="ml-2">
                        <span
                            id="question-2"
                            class="group relative inline-flex items-center"
                ...
                <!-- Q3: Type of membership -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="262" v-html="getHighlightedSegmentById(262)"></span>
                    <span class="ml-2">
                        <span
                            id="question-3"
                            class="group relative inline-flex items-center"
                ...
                <!-- Q4: Length of membership -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="281" v-html="getHighlightedSegmentById(281)"></span>
                    <span class="ml-2 inline-flex items-center gap-1">
                        ...
                        <span class="text-gray-900 select-text" data-segment-id="302" v-html="getHighlightedSegmentById(302)"></span>
                    </span>
                </div>

                <!-- Q5: Why joined -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="307" v-html="getHighlightedSegmentById(307)"></span>
                    <div class="mt-1 flex flex-wrap items-center gap-1">
                        <span class="text-gray-900 select-text" data-segment-id="318" v-html="getHighlightedSegmentById(318)"></span>
                        <span
                            id="question-5"
                            class="group relative inline-flex items-center"
                ...
                <!-- Visits to club per month (static) -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="334" v-html="getHighlightedSegmentById(334)"></span>
                    <span class="ml-2 text-gray-900 select-text" data-segment-id="359" v-html="getHighlightedSegmentById(359)"></span>
                </div>

                <!-- Q6: Facility used most -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="377" v-html="getHighlightedSegmentById(377)"></span>
                    <span class="ml-2">
                        <span
                            id="question-6"
                            class="group relative inline-flex items-center"
                ...
                <!-- Facility not used (static) -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="396" v-html="getHighlightedSegmentById(396)"></span>
                    <span class="ml-2 text-gray-900 select-text" data-segment-id="423" v-html="getHighlightedSegmentById(423)"></span>
                </div>

                <!-- Q7: reason (because reluctant to ___) -->
                <div>
                    <div class="mt-1 flex flex-wrap items-center gap-1">
                        <span class="text-gray-900 select-text" data-segment-id="436" v-html="getHighlightedSegmentById(436)"></span>
                        <span
                            id="question-7"
                            class="group relative inline-flex items-center"
                        ...
                        <span class="text-gray-900 select-text" data-segment-id="457" v-html="getHighlightedSegmentById(457)"></span>
                    </div>
                </div>

                <!-- Suggestions for improvements -->
                <div>
                    <span class="text-sm font-medium text-gray-500 select-text" data-segment-id="458" v-html="getHighlightedSegmentById(458)"></span>
                    <span class="ml-1 text-sm font-medium text-gray-500 select-text" data-segment-id="473" v-html="getHighlightedSegmentById(473)"></span>

                    <div class="mt-1 space-y-2">
                        <!-- Q8: have more ___ -->
                        <div class="flex flex-wrap items-center gap-1">
                            <span class="text-gray-900 select-text" data-segment-id="486" v-html="getHighlightedSegmentById(486)"></span>
                            <span
                                id="question-8"
                                class="group relative inline-flex items-center"
                        ...
                        <!-- Q9: Install ___ in the gym -->
                        <div class="flex flex-wrap items-center gap-1">
                            <span class="text-gray-900 select-text" data-segment-id="495" v-html="getHighlightedSegmentById(495)"></span>
                            <span
                                id="question-9"
                                class="group relative inline-flex items-center"
                            ...
                            <span class="text-gray-900 select-text" data-segment-id="502" v-html="getHighlightedSegmentById(502)"></span>
                        </div>

                        <!-- Q10: Open ___ later at weekends -->
                        <div class="flex flex-wrap items-center gap-1">
                            <span class="text-gray-900 select-text" data-segment-id="512" v-html="getHighlightedSegmentById(512)"></span>
                            <span
                                id="question-10"
                                class="group relative inline-flex items-center"
                            ...
                            <span class="text-gray-900 select-text" data-segment-id="516" v-html="getHighlightedSegmentById(516)"></span>
                        </div>
                    </div>
                </div>
            </div>
