...
const textSegments = ref([
    // Part Header
    { id: "part1-title", text: "Part 1: A holiday"  },
    { id: "section1-title", text: "Section 1 – Questions 1–10" },
    // Questions 1–7 Instructions
    { id: "q1-7-title", text: "Questions 1–7" },
    { id: "q1-7-instruction1", text: "Complete the notes below." },
    { id: "q1-7-instruction2", text: "Write NO MORE THAN TWO WORDS AND/OR A NUMBER for each answer." },
    // Table Title
    { id: "holiday-title", text: "Holiday on Jackson Island"},
    // Table Headers
    { id: "table-header-place", text: "PLACE" },
    { id: "table-header-accommodation", text: "ANNA’S ACCOMMODATION" },
    { id: "table-header-things", text: "THINGS ANNA DID" },
    { id: "table-header-recommendation", text: "ANNA’S RECOMMENDATION" },
    // Row 1 (Camford)
    { id: "place-camford", text: "Camford"},
    { id: "camford-accommodation", text: "Example: with cousin" },
    { id: "camford-activity", text: "went shopping in the market" },
    { id: "q1-text", text: "need to take" },
    // Row 2 (Newtown)
    { id: "place-newtown", text: "Newtown" },
    { id: "newtown-accommodation", text: "—" },
    { id: "newtown-activity", text: "bus tour" },
    { id: "q2-text", text: "visit the" },
    // Row 3 (Golden Beach)
    { id: "place-golden-beach", text: "Golden Beach" },
    { id: "q3-text", text: "in a"},
    { id: "q4-text", text: "" },
    { id: "q5-text", text: "Stay for at least" },
    // Row 4 (Question 6 location)
    { id: "q6-place", text: "" },
    { id: "q6-accommodation", text: "in a motel"},
    { id: "q7-text", text: "went" },
    { id: "q7-recommendation", text: "book some lessons in advance" },
    // Questions 8–10 Instructions
    { id: "q8-10-title", text: "Questions 8–10" },
    { id: "q8-10-instruction1", text: "Complete the notes below." },
    { id: "q8-10-instruction2", text: "Write ONE WORD ONLY for each answer." },
    // More Advice Section
    { id: "more-advice-title", text: "More Advice" },
    // Advice Points
    { id: "q8-text", text: "Try the"},
    { id: "q8-rest", text: "at the cafe on the mountain."},
    { id: "q9-text", text: "Hire a"},
    { id: "q10-text", text: "Buy a" },
    { id: "q10-rest", text: "before the holiday"},
]);


const Offsets = computed(() => {
  let cursor = 0;
  return textSegments.value.map(seg => {
    const withOffset = { ...seg, offset: cursor };
...
const getHighlightedSegmentById = (segmentId: number | string) => {
    const segment = Offsets.value.find((s) => s.id === segmentId);
    if (!segment) return '';
    ...
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick" class="px-4 py-2 pb-24 select-text sm:px-6">
        ...
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <div class="mb-3 rounded border border-gray-200 bg-gray-100 px-4 py-3" @mouseup="handleContentTextSelect">
                ...
                ></h3>
                <p class="text-sm text-gray-700 select-text">Listen and answer question 1-10</p>
            </div>
            ...
            <div class="shrink-0 px-2 pb-2 sm:px-3" @mouseup="handleContentTextSelect">
                <p
                    class="text-base font-bold text-gray-900 select-text"
                    data-segment-id="section1-title"
                    v-html="getHighlightedSegmentById('section1-title')"
                ></p>
                <p
                    class="text-base font-bold text-gray-900 select-text"
                    data-segment-id="q1-7-title"
                    v-html="getHighlightedSegmentById('q1-7-title')"
                ></p>
                <p class="text-sm text-gray-700 select-text">
                    <span data-segment-id="q1-7-instruction1" v-html="getHighlightedSegmentById('q1-7-instruction1')"></span>
                </p>
                <p class="text-sm italic text-gray-700 select-text">
                    <span data-segment-id="q1-7-instruction2" v-html="getHighlightedSegmentById('q1-7-instruction2')"></span>
                </p>
            </div>
            ...
            <div class="px-2 sm:px-3">
                <h2
                    ...
                    data-segment-id="holiday-title"
                    v-html="getHighlightedSegmentById('holiday-title')"
                ></h2>
            </div>
                            ...
                            <table class="w-full border-collapse text-sm">
                                ...
                                <thead>
                                    <tr class="border-b border-gray-300">
                                        <th class="py-2 pr-4 text-left text-xs font-bold text-gray-900 select-text" data-segment-id="table-header-place" v-html="getHighlightedSegmentById('table-header-place')"></th>
                                        <th class="py-2 pr-4 text-left text-xs font-bold text-gray-900 select-text" data-segment-id="table-header-accommodation" v-html="getHighlightedSegmentById('table-header-accommodation')"></th>
                                        <th class="py-2 pr-4 text-left text-xs font-bold text-gray-900 select-text" data-segment-id="table-header-things" v-html="getHighlightedSegmentById('table-header-things')"></th>
                                        <th class="py-2 text-left text-xs font-bold text-gray-900 select-text" data-segment-id="table-header-recommendation" v-html="getHighlightedSegmentById('table-header-recommendation')"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- Row 1: Camford -->
                                    <tr class="border-b border-gray-200">
                                        <td class="py-3 pr-4 font-semibold text-gray-900 select-text align-top" data-segment-id="place-camford" v-html="getHighlightedSegmentById('place-camford')"></td>
                                        <td class="py-3 pr-4 text-gray-700 select-text align-top" data-segment-id="camford-accommodation" v-html="getHighlightedSegmentById('camford-accommodation')"></td>
                                        <td class="py-3 pr-4 text-gray-700 select-text align-top" data-segment-id="camford-activity" v-html="getHighlightedSegmentById('camford-activity')"></td>
                                        <td class="py-3 text-gray-800 align-top">
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span data-segment-id="q1-text" v-html="getHighlightedSegmentById('q1-text')"></span>
                                                <span
                                                    id="question-1"
                                    ...
                                    <!-- Row 2: Newtown -->
                                    <tr class="border-b border-gray-200">
                                        <td class="py-3 pr-4 font-semibold text-gray-900 select-text align-top" data-segment-id="place-newtown" v-html="getHighlightedSegmentById('place-newtown')"></td>
                                        <td class="py-3 pr-4 text-gray-700 select-text align-top" data-segment-id="newtown-accommodation" v-html="getHighlightedSegmentById('newtown-accommodation')"></td>
                                        <td class="py-3 pr-4 text-gray-700 select-text align-top" data-segment-id="newtown-activity" v-html="getHighlightedSegmentById('newtown-activity')"></td>
                                        <td class="py-3 text-gray-800 align-top">
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span data-segment-id="q2-text" v-html="getHighlightedSegmentById('q2-text')"></span>
                                                <span
                                                    id="question-2"
                                                    class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Row 3: Golden Beach -->
                                    <tr class="border-b border-gray-200">
                                        <td class="py-3 pr-4 font-semibold text-gray-900 select-text align-top" data-segment-id="place-golden-beach" v-html="getHighlightedSegmentById('place-golden-beach')"></td>
                                        <td class="py-3 pr-4 text-gray-800 align-top">
                                            <!-- Q3: accommodation -->
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span data-segment-id="q3-text" v-html="getHighlightedSegmentById('q3-text')"></span>
                                                <span
                                                    id="question-3"
                                                    class="group relative inline-flex items-center gap-0.5"
                                        ...
                                        <td class="py-3 text-gray-800 align-top">
                                            <!-- Q5: recommendation -->
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span data-segment-id="q5-text" v-html="getHighlightedSegmentById('q5-text')"></span>
                                                <span
                                                    id="question-5"
                                                    class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <!-- Row 4: Question 6 (unknown place) -->
                                    <tr class="border-b border-gray-200">
                                        <td class="py-3 pr-4 text-gray-800 align-top">
                                            <!-- Q6: place name -->
                                            <span
                                        ...
                                        <td class="py-3 pr-4 text-gray-700 select-text align-top" data-segment-id="q6-accommodation" v-html="getHighlightedSegmentById('q6-accommodation')"></td>
                                        <td class="py-3 pr-4 text-gray-800 align-top">
                                            <!-- Q7: things anna did -->
                                            <div class="flex flex-wrap items-center gap-0.5">
                                                <span data-segment-id="q7-text" v-html="getHighlightedSegmentById('q7-text')"></span>
                                                <span
                                                    id="question-7"
                                                    class="group relative inline-flex items-center gap-0.5"
                                        ...
                                        <td class="py-3 text-gray-700 select-text align-top" data-segment-id="q7-recommendation" v-html="getHighlightedSegmentById('q7-recommendation')"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

                        <!-- Section 2: Questions 8-10 -->
                        <div class="border-t pt-4 mt-4">
                            <h3 class="mb-1 text-base font-bold text-gray-900 select-text" data-segment-id="q8-10-title" v-html="getHighlightedSegmentById('q8-10-title')"></h3>
                            <p class="text-sm text-gray-700 select-text" data-segment-id="q8-10-instruction1" v-html="getHighlightedSegmentById('q8-10-instruction1')"></p>
                            <p class="text-sm italic text-gray-700 select-text mb-3" data-segment-id="q8-10-instruction2" v-html="getHighlightedSegmentById('q8-10-instruction2')"></p>

                            <h4 class="text-base font-bold text-gray-900 select-text mb-2" data-segment-id="more-advice-title" v-html="getHighlightedSegmentById('more-advice-title')"></h4>

                            <div class="space-y-3 text-base leading-relaxed text-gray-800">
                                <!-- Q8 -->
                                <div class="flex flex-wrap items-center gap-0.5">
                                    <span class="mr-1">•</span>
                                    <span data-segment-id="q8-text" v-html="getHighlightedSegmentById('q8-text')"></span>
                                    <span
                                        id="question-8"
                                        class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <span data-segment-id="q8-rest" v-html="getHighlightedSegmentById('q8-rest')"></span>
                                </div>

                                <!-- Q9 -->
                                <div class="flex flex-wrap items-center gap-0.5">
                                    <span class="mr-1">•</span>
                                    <span data-segment-id="q9-text" v-html="getHighlightedSegmentById('q9-text')"></span>
                                    <span
                                        id="question-9"
                                        class="group relative inline-flex items-center gap-0.5"
                                ...
                                <div class="flex flex-wrap items-center gap-0.5">
                                    <span class="mr-1">•</span>
                                    <span data-segment-id="q10-text" v-html="getHighlightedSegmentById('q10-text')"></span>
                                    <span
                                        id="question-10"
                                        class="group relative inline-flex items-center gap-0.5"
                                    ...
                                    <span data-segment-id="q10-rest" v-html="getHighlightedSegmentById('q10-rest')"></span>
                                </div>
                            </div>
                        </div>
