...
<template>
    <nav class="sticky top-0 z-50" :class="headerBgClass">
            ...
            <Transition name="fade">
                ...
                >
                    ...
                    <div v-else-if="optionsView === 'instructions'" class="w-full max-w-2xl px-4 py-6">
                        ...
                        <div class="mx-auto max-w-md space-y-4 rounded-lg border p-4" :class="modalBorderClass">
                            <div class="space-y-3 text-sm" :class="modalTextClass">
                                <p class="font-semibold">IELTS Academic Reading Test</p>
                                <p><strong>Time:</strong> 60 minutes</p>
                                <p><strong>Questions:</strong> 40 questions</p>
                                <p class="mt-4"><strong>Part 1:</strong> A text with 13 questions based on factual information.</p>
                                <p><strong>Part 2:</strong> A text with 13 questions testing your ability to understand main ideas and details.</p>
                                <p><strong>Part 3:</strong> A longer, more complex text with 14 questions requiring detailed comprehension.</p>
                                <p class="mt-4 text-gray-600">
                                    Read each passage carefully and answer the questions. You can move between parts at any time. Make sure to manage your
                                    time effectively across all three passages.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <Teleport to="body">
            <Transition name="fade">
                <div v-if="isPaused" class="fixed inset-0 z-[10000] flex items-center justify-center bg-white/95 backdrop-blur-xl">
                    ...
                    <div class="flex-1 overflow-y-auto px-4 py-4 sm:px-6">
                        <div v-if="allNotes.length === 0" class="flex h-full flex-col items-center justify-center py-12 text-center">
                            ...
                            <p class="max-w-xs text-sm text-gray-600">
                                Select text in the reading passages and click "Note" to add notes and reminders.
                            </p>
                        </div>
