...
const multipleAnswers = ref<{ q25_26: string[]; q27_28: string[]; q29_30: string[] }>({
    q25_26: [],
    q27_28: [],
    q29_30: [],
});
...
const textSegments = ref<TextSegment[]>([
    ...
    { id: 2, text: 'Research on web-based crosswords', offset: 97 },                             // 97-129
    // Question 21
    { id: 'q21', text: '21.', offset: 130 },
    { id: 3, text: 'Leela and Jake chose this article because', offset: 134 },
    { id: 4, text: 'it was on a topic familiar to most students.', offset: 177 },
    { id: 5, text: 'it covered both IT and education issues.', offset: 224 },
    { id: 6, text: 'it dealt with a very straightforward concept.', offset: 267 },
    // Question 22
    { id: 'q22', text: '22.', offset: 315 },
    { id: 7, text: 'How did Leela and Jake persuade students to take part in their research?', offset: 319 },
    { id: 8, text: 'They convinced them they would enjoy the experience.', offset: 392 },
    { id: 9, text: 'They said it would help them do a particular test.', offset: 447 },
    { id: 10, text: 'They offered to help them with their own research later on.', offset: 500 },
    // Question 23
    { id: 'q23', text: '23.', offset: 562 },
    { id: 11, text: 'Leela and Jake changed the design of the original questionnaire because', offset: 566 },
    { id: 12, text: 'it was too short for their purposes.', offset: 638 },
    { id: 13, text: 'it asked misleading questions.', offset: 677 },
    { id: 14, text: 'it contained out-of-date points.', offset: 710 },
    // Question 24
    { id: 'q24', text: '24.', offset: 745 },
    { id: 15, text: 'Leela was surprised by the fact that', offset: 749 },
    { id: 16, text: 'it is normal for questionnaire returns to be low.', offset: 787 },
    { id: 17, text: 'so many students sent back their questionnaires.', offset: 839 },
    { id: 18, text: 'the questionnaire responses were of such high quality.', offset: 890 },
    // Questions 25-26
    { id: 'q25-26', text: 'Questions 25 and 26', offset: 948 },
    { id: 'q25-26-inst', text: 'Choose TWO letters, A-E.', offset: 975 },
    { id: 19, text: 'What TWO things did respondents say they liked most about doing the crossword?', offset: 1000 },
    { id: 20, text: 'It helped them spell complex technical terms.', offset: 1079 },
    { id: 21, text: 'It was an enjoyable experience.', offset: 1127 },
    { id: 22, text: 'It helped them concentrate effectively.', offset: 1161 },
    { id: 23, text: 'It increased their general motivation to study.', offset: 1203 },
    { id: 24, text: 'It showed what they still needed to study.', offset: 1253 },
    // Questions 27-28
    { id: 'q27-28', text: 'Questions 27 and 28', offset: 1298 },
    { id: 'q27-28-inst', text: 'Choose TWO letters, A-E.', offset: 1325 },
    { id: 25, text: 'What TWO problems did students identify with the crossword software?', offset: 1350 },
    { id: 26, text: 'The interface was too complicated to use.', offset: 1418 },
    { id: 27, text: 'The loading time was too slow.', offset: 1462 },
    { id: 28, text: 'The grid size was inappropriate.', offset: 1495 },
    { id: 29, text: 'The help function was not useful.', offset: 1530 },
    { id: 30, text: 'The feedback was not immediate enough.', offset: 1566 },
    // Questions 29-30
    { id: 'q29-30', text: 'Questions 29 and 30', offset: 1607 },
    { id: 'q29-30-inst', text: 'Choose TWO letters, A-E.', offset: 1634 },
    { id: 31, text: 'What TWO recommendations did Leela and Jake make for future research?', offset: 1659 },
    { id: 32, text: 'Use a larger sample of students.', offset: 1728 },
    { id: 33, text: 'Test different types of crosswords.', offset: 1763 },
    { id: 34, text: 'Include students from different academic backgrounds.', offset: 1801 },
    { id: 35, text: 'Conduct the research over a longer period.', offset: 1857 },
    { id: 36, text: 'Compare online and paper-based crosswords.', offset: 1902 },
]);
...
const getAnswers = () => {
    ...
    if (multipleAnswers.value.q25_26?.length > 0) {
        allAnswers.q25 = multipleAnswers.value.q25_26[0] || '';
        allAnswers.q26 = multipleAnswers.value.q25_26[1] || '';
    } else {
        allAnswers.q25 = '';
        allAnswers.q26 = '';
    }
            ...
            <div @mouseup="handleContentTextSelect" class="flex-1 overflow-y-auto pb-24 select-text">
                <div class="p-2 sm:p-3">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            <button
                                v-show="hoveredQuestion === 25 || isQuestionFlagged(25) || isQuestionFlagged(26)"
                                @click.stop="
                                    toggleFlag(25);
                                    toggleFlag(26);
                                "
                                class="absolute top-2 right-2 flex h-7 w-7 items-center justify-center rounded border transition-all"
                                :class="
                                    isQuestionFlagged(25) || isQuestionFlagged(26)
                                        ? 'border-gray-400 bg-transparent text-red-500'
                                        : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                "
                                :title="isQuestionFlagged(25) || isQuestionFlagged(26) ? 'Remove bookmark' : 'Bookmark this question'"
                            >
                                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z" />
                                </svg>
                            ...
                            <div class="mb-2">
                                <div class="mb-2">
                                    <h3 class="text-base font-bold text-gray-900 select-text" data-segment-id="q25-26" v-html="getHighlightedSegmentById('q25-26')"></h3>
                                </div>
                                <div class="p-2">
                                    <p class="mb-2 text-base leading-relaxed text-gray-900 select-text" data-segment-id="q25-26-inst" v-html="getHighlightedSegmentById('q25-26-inst')"></p>
                                    <p
                            ...
                            <div class="space-y-1">
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        :checked="isSelected('q25_26', 'A')"
                                        :disabled="isDisabled('q25_26', 'A')"
                                        @change="handleMultipleChoice('q25_26', 'A')"
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        :checked="isSelected('q25_26', 'B')"
                                        :disabled="isDisabled('q25_26', 'B')"
                                        @change="handleMultipleChoice('q25_26', 'B')"
                                        class="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-black focus:ring-black disabled:cursor-not-allowed disabled:opacity-50"
                                    />
                                    <span
                                        class="text-base leading-relaxed text-gray-900 select-text"
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        :checked="isSelected('q25_26', 'C')"
                                        :disabled="isDisabled('q25_26', 'C')"
                                        @change="handleMultipleChoice('q25_26', 'C')"
                                        class="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-black focus:ring-black disabled:cursor-not-allowed disabled:opacity-50"
                                    />
                                    <span
                                        class="text-base leading-relaxed text-gray-900 select-text"
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        :checked="isSelected('q25_26', 'D')"
                                        :disabled="isDisabled('q25_26', 'D')"
                                        @change="handleMultipleChoice('q25_26', 'D')"
                                        class="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-black focus:ring-black disabled:cursor-not-allowed disabled:opacity-50"
                                    />
                                    <span
                                        class="text-base leading-relaxed text-gray-900 select-text"
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        :checked="isSelected('q25_26', 'E')"
                                        :disabled="isDisabled('q25_26', 'E')"
                                        @change="handleMultipleChoice('q25_26', 'E')"
                                        class="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-black focus:ring-black disabled:cursor-not-allowed disabled:opacity-50"
                                    />
                                    <span
                                        class="text-base leading-relaxed text-gray-900 select-text"
                            ...
                            <div class="mt-2 p-2">
                                <p class="text-sm font-medium text-gray-900">Selected: {{ multipleAnswers.q25_26.length }}/2 answers</p>
                            </div>
                        </div>
                        ...
                        >
                            <button
                                ...
                                class="absolute top-2 right-2 flex h-7 w-7 items-center justify-center rounded border transition-all"
                                :class="
                                    isQuestionFlagged(27) || isQuestionFlagged(28)
                                        ? 'border-gray-400 bg-transparent text-red-500'
                                        : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                "
                            ...
                            <div class="mb-2">
                                <div class="mb-2">
                                    <h3 class="text-base font-bold text-gray-900 select-text" data-segment-id="q27-28" v-html="getHighlightedSegmentById('q27-28')"></h3>
                                </div>
                                <div class="p-2">
                                    <p class="mb-2 text-base leading-relaxed text-gray-900 select-text" data-segment-id="q27-28-inst" v-html="getHighlightedSegmentById('q27-28-inst')"></p>
                                    <p
                                        class="text-lg leading-tight font-bold text-gray-900 select-text"
                                        data-segment-id="25"
                            ...
                            <div class="mt-2 p-2">
                                <p class="text-sm font-medium text-gray-900">Selected: {{ multipleAnswers.q27_28.length }}/2 answers</p>
                            </div>
                        </div>
                        ...
                        >
                            <button
                                ...
                                class="absolute top-2 right-2 flex h-7 w-7 items-center justify-center rounded border transition-all"
                                :class="
                                    isQuestionFlagged(29) || isQuestionFlagged(30)
                                        ? 'border-gray-400 bg-transparent text-red-500'
                                        : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                "
                            ...
                            <div class="mb-2">
                                <div class="mb-2">
                                    <h3 class="text-base font-bold text-gray-900 select-text" data-segment-id="q29-30" v-html="getHighlightedSegmentById('q29-30')"></h3>
                                </div>
                                <div class="p-2">
                                    <p class="mb-2 text-base leading-relaxed text-gray-900 select-text" data-segment-id="q29-30-inst" v-html="getHighlightedSegmentById('q29-30-inst')"></p>
                                    <p
                                        class="text-lg leading-tight font-bold text-gray-900 select-text"
                                        data-segment-id="31"
