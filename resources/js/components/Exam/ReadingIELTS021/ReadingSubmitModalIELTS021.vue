            ...
            <div class="w-full max-w-md rounded border border-black bg-white p-6 text-center shadow">
                ...
                <div class="flex gap-2">
                    <button
                        v-if="!isTimeUp"
                        @click="handleClose"
                        class="flex-1 rounded border border-black py-2 text-sm font-semibold text-black transition-all duration-200 hover:bg-gray-100 hover:scale-[1.02] active:scale-100"
                    >
                        Go Back
                    </button>
                    <button
                        @click="handleSubmit"
                        :class="[
                            'rounded bg-black py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-gray-800 hover:scale-[1.02] active:scale-100',
