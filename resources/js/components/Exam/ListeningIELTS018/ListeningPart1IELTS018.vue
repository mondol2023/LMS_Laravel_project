...
const textSegments = ref([
    ...
    { id: 2, text: 'ONE WORD AND/OR A NUMBER', offset: 94 },
    { id: 3, text: 'for each answer.', offset: 118 },
    // Main content text segments
    { id: 4, text: 'Call taken by: Natasha', offset: 134 },
    { id: 5, text: "Customer's full name: Michael", offset: 158 },
    { id: 6, text: 'Date of birth: 27 March 1988', offset: 188 },
    { id: 7, text: 'Previous address: 319', offset: 218 },
    { id: 8, text: 'East providence', offset: 238 },
    { id: 9, text: 'Phone number: 049248002', offset: 253 },
    { id: 10, text: 'Data allowance:', offset: 278 },
    { id: 11, text: 'Current plan:', offset: 293 },
    { id: 12, text: "Mother's maiden name:", offset: 306 },
    { id: 13, text: 'First pet:', offset: 327 },
    { id: 14, text: 'New password sent on:', offset: 337 },
    { id: 15, text: 'Extra services required: new', offset: 359 },
    { id: 16, text: 'Cancel', offset: 388 },
    { id: 17, text: 'pack', offset: 395 },
]);
            ...
            <div class="flex-1 overflow-y-auto pb-24">
                <div class="p-2 sm:p-3">
                    ...
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-2">
                            <!-- Call details lines with input fields -->
