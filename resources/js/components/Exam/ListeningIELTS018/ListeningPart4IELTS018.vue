...
const textSegments = ref([
    ...
    { id: 0, text: 'Questions 31–40', offset: 40 },
    { id: 1, text: 'Complete the notes below. Write ', offset: 58 },
    { id: 2, text: 'NO MORE THAN TWO WORDS', offset: 94 },
    { id: 3, text: 'for each answer.', offset: 118 },
    // Title
    { id: 4, text: 'Research on a Chain Store in the UK', offset: 134 },
    // Initial expansion section
    { id: 5, text: 'Initial expansion', offset: 172 },
    { id: 6, text: '• The company expanded by opening more', offset: 190 },
    { id: 7, text: 'to increase market share in England.', offset: 235 },
    { id: 8, text: '• They could raise capital by reducing the number of branches in southern', offset: 274 },
    // Consultation section
    { id: 9, text: 'Consultation', offset: 355 },
    { id: 10, text: '• They shut down the', offset: 369 },
    { id: 11, text: 'of the convenience stores in Oxford.', offset: 392 },
    { id: 12, text: '• Over 200 staff had to be transferred and', offset: 435 },
    { id: 13, text: '• A new brand image was established to focus on selling', offset: 485 },
    // The future way section
    { id: 14, text: 'The future way', offset: 547 },
    { id: 15, text: '• A', offset: 561 },
    { id: 16, text: 'was assigned to hold each discussion.', offset: 565 },
    { id: 17, text: '• Retail stores should be flexible in making', offset: 608 },
    { id: 18, text: '• Changes should be introduced in', offset: 658 },
    { id: 19, text: 'so that staff can become accustomed to the new rules.', offset: 698 },
    // Conclusion section
    { id: 20, text: 'Conclusion', offset: 758 },
    { id: 21, text: '• Be open-minded about the', offset: 770 },
    { id: 22, text: 'for expansion they choose.', offset: 802 },
    { id: 23, text: '• Companies have saved costs by changing the structure of the', offset: 834 },
    { id: 24, text: 'department.', offset: 905 },
]);
                ...
                <div class="p-2 sm:p-3">
                    ...
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-6">
                            <!-- Initial expansion section -->
                            <div>
                                <h3 class="text-base font-bold text-gray-900 mb-2" data-segment-id="5" v-html="getHighlightedSegmentById(5)"></h3>
                            ...
                            <!-- Consultation section -->
                            <div class="mt-6">
                                <h3 class="text-base font-bold text-gray-900 mb-2" data-segment-id="9" v-html="getHighlightedSegmentById(9)"></h3>
                                <div class="space-y-3 text-base leading-relaxed text-gray-800">
                                    <!-- Question 33 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="font-bold text-gray-900"></span>
                            ...
                            <!-- The future way section -->
                            <div class="mt-6">
                                <h3 class="text-base font-bold text-gray-900 mb-2" data-segment-id="14" v-html="getHighlightedSegmentById(14)"></h3>
                                <div class="space-y-3 text-base leading-relaxed text-gray-800">
                                    <!-- Question 36 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="font-bold text-gray-900"></span>
                            ...
                            <!-- Conclusion section -->
                            <div class="mt-6">
                                <h3 class="text-base font-bold text-gray-900 mb-2" data-segment-id="20" v-html="getHighlightedSegmentById(20)"></h3>
                                <div class="space-y-3 text-base leading-relaxed text-gray-800">
                                    <!-- Question 39 -->
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="font-bold text-gray-900"></span>
