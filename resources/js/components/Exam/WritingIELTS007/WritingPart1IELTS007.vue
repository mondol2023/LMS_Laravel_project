...
const questionText = ref(`The graph below compares figures for the production and consumption of energy in the US
from 1950 to 2000. It also predicts figures for 2025.Summarise the information by selecting and reporting the main features, and make
comaprisons where relevant.
                ...
                <div class="max-h-screen overflow-y-auto  p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/writing07.png" alt="Village development diagrams" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
