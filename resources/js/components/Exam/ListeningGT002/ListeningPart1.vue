...
// NEW QUESTIONS: "New Password" form
const textSegments = ref([
    ...
    { id: 1, text: 'Complete the form below. Write ', offset: 54 },
    { id: 2, text: 'NO MORE THAN TWO WORDS AND/OR A NUMBER', offset: 85 },
    { id: 3, text: 'New Password', offset: 124 },
    // Form fields
    { id: 4, text: "Customer's full name:", offset: 137 },
    { id: 5, text: 'Michael', offset: 159 },
    { id: 6, text: 'Date of birth:', offset: 167 },
    { id: 7, text: '27 March 1988', offset: 182 },
    { id: 8, text: 'Previous address:', offset: 196 },
    { id: 9, text: '319', offset: 214 },
    { id: 10, text: 'East Providence', offset: 218 },
    { id: 11, text: 'Phone number:', offset: 234 },
    { id: 12, text: '0492 48002', offset: 248 },
    { id: 13, text: 'Data allowance:', offset: 259 },
    { id: 14, text: 'Current plan:', offset: 275 },
    { id: 15, text: "Mother's maiden name:", offset: 289 },
    { id: 16, text: 'First pet:', offset: 311 },
    { id: 17, text: 'New password sent on:', offset: 322 },
    { id: 18, text: 'Extra services requested:', offset: 344 },
    { id: 19, text: 'New', offset: 370 },
    { id: 20, text: 'Cancel', offset: 374 },
    { id: 21, text: 'pack', offset: 381 },
]);
                    ...
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="4" v-html="getHighlightedSegmentById(4)"></span>
                                <span data-segment-id="5" class="text-gray-800" v-html="getHighlightedSegmentById(5)"></span>
                                <div
                                    id="question-1"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            :class="[
                                                (hoveredQuestion === 1 || isQuestionFlagged(1))
                                                    ? 'opacity-100'
                            ...
                            <!-- Date of birth -->
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="6" v-html="getHighlightedSegmentById(6)"></span>
                                <span class="text-gray-800" data-segment-id="7" v-html="getHighlightedSegmentById(7)"></span>
                            </div>

                            <!-- Previous address -->
                            <div class="space-y-1">
                                <span class="text-gray-800 font-medium" data-segment-id="8" v-html="getHighlightedSegmentById(8)"></span>
                                <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                    ...
                                    >
                                        ...
                                        <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                            <button
                                                ...
                                                class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                                :class="[
                                                    (hoveredQuestion === 2 || isQuestionFlagged(2))
                                                        ? 'opacity-100'
                                                        : 'opacity-0 pointer-events-none',
                                                    isQuestionFlagged(2)
                                                        ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <!-- Phone number -->
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="11" v-html="getHighlightedSegmentById(11)"></span>
                                <span class="text-gray-800" data-segment-id="12" v-html="getHighlightedSegmentById(12)"></span>
                            </div>

                            <!-- Data allowance -->
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="13" v-html="getHighlightedSegmentById(13)"></span>
                                <div
                                    id="question-3"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                            :class="[
                                                (hoveredQuestion === 3 || isQuestionFlagged(3))
                                                    ? 'opacity-100'
                                                    : 'opacity-0 pointer-events-none',
                                                isQuestionFlagged(3)
                                                    ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <!-- Current plan -->
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="14" v-html="getHighlightedSegmentById(14)"></span>
                                <div
                                    id="question-4"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                            :class="[
                                                (hoveredQuestion === 4 || isQuestionFlagged(4))
                                                    ? 'opacity-100'
                                                    : 'opacity-0 pointer-events-none',
                                                isQuestionFlagged(4)
                                                    ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="15" v-html="getHighlightedSegmentById(15)"></span>
                                <div
                                    id="question-5"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                            :class="[
                                                (hoveredQuestion === 5 || isQuestionFlagged(5))
                                                    ? 'opacity-100'
                                                    : 'opacity-0 pointer-events-none',
                                                isQuestionFlagged(5)
                                                    ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <!-- First pet -->
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="16" v-html="getHighlightedSegmentById(16)"></span>
                                <div
                                    id="question-6"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                            :class="[
                                                (hoveredQuestion === 6 || isQuestionFlagged(6))
                                                    ? 'opacity-100'
                                                    : 'opacity-0 pointer-events-none',
                                                isQuestionFlagged(6)
                                                    ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <div class="flex flex-wrap items-center gap-0.5">
                                <span class="text-gray-800 font-medium mr-2" data-segment-id="17" v-html="getHighlightedSegmentById(17)"></span>
                                <div
                                    id="question-7"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    ...
                                    <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                        <button
                                            ...
                                            class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                            :class="[
                                                (hoveredQuestion === 7 || isQuestionFlagged(7))
                                                    ? 'opacity-100'
                                                    : 'opacity-0 pointer-events-none',
                                                isQuestionFlagged(7)
                                                    ? 'border-gray-400 bg-transparent text-red-500'
                            ...
                            <div class="border-t pt-3 space-y-2">
                                <span class="text-gray-800 font-medium" data-segment-id="18" v-html="getHighlightedSegmentById(18)"></span>
                                    ...
                                    >
                                        ...
                                        <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                            <button
                                                ...
                                                class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                                :class="[
                                                    (hoveredQuestion === 8 || isQuestionFlagged(8))
                                                        ? 'opacity-100'
                                                        : 'opacity-0 pointer-events-none',
                                                    isQuestionFlagged(8)
                                                        ? 'border-gray-400 bg-transparent text-red-500'
                                    ...
                                    >
                                        ...
                                        <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                            <button
                                                ...
                                                class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                                :class="[
                                                    (hoveredQuestion === 9 || isQuestionFlagged(9))
                                                        ? 'opacity-100'
                                                        : 'opacity-0 pointer-events-none',
                                                    isQuestionFlagged(9)
                                                        ? 'border-gray-400 bg-transparent text-red-500'
                                    ...
                                    >
                                        ...
                                        <div class="relative inline-flex h-7 w-7 items-center justify-center shrink-0">
                                            <button
                                                ...
                                                class="absolute inset-0 flex items-center justify-center rounded border transition-all duration-200"
                                                :class="[
                                                    (hoveredQuestion === 10 || isQuestionFlagged(10))
                                                        ? 'opacity-100'
                                                        : 'opacity-0 pointer-events-none',
