...
// Answers for Q21-Q25 (short answer / sentence completion)
const answers = ref({
    q21: '',
    q22: '',
    q23: '',
...
// Multiple choice answers for Q29 & Q30 (choose TWO from A-E)
...
const textSegments = ref([
    // Part header
    { id: 'part-title', text: 'Part 3', offset: 0 },
    { id: 'part-desc', text: 'Listen and answer questions 21–30.', offset: 7 },

    // Section 1 - Sentence Completion Q21-Q25
    { id: 'sec1-heading', text: 'Questions 21–25', offset: 42 },
    { id: 'sec1-inst1', text: 'Complete the sentences below.', offset: 58 },
    { id: 'sec1-inst2', text: 'Write NO MORE THAN TWO WORDS for each answer.', offset: 88 },

    // Q21
    { id: 'q21-prefix', text: '21.  Students must follow', offset: 134 },
    { id: 'q21-suffix', text: 'to prevent accidents in the lab.', offset: 118 },

    // Q22
    { id: 'q22-prefix', text: '22.  The students have not been using', offset: 151 },
    { id: 'q22-suffix', text: 'while in the lab.', offset: 189 },

    // Q23
    { id: 'q23-prefix', text: '23.  Students cannot eat or drink until', offset: 207 },
    { id: 'q23-suffix', text: 'is finished and they have washed their hands.', offset: 246 },

    // Q24
    { id: 'q24-prefix', text: '24.  Tessa should tie her hair back to avoid danger when she is working with a', offset: 292 },
    { id: 'q24-suffix', text: 'or chemicals.', offset: 369 },

    // Q25
    { id: 'q25-prefix', text: '25.  Students must wear long sleeves and shoes made of', offset: 383 },
    { id: 'q25-suffix', text: 'in the lab.', offset: 437 },

    // Section 2 - MCQ Q26-Q28
    { id: 'sec2-heading', text: 'Questions 26–28', offset: 449 },
    { id: 'sec2-inst', text: 'Choose the correct letter A, B or C.', offset: 465 },

    // Q26
    { id: 'q26-stem', text: '26.  Which student is currently using an appropriate notebook?', offset: 502 },
    { id: 'q26-A', text: 'A  Vincent', offset: 564 },
    { id: 'q26-B', text: 'B  Tessa', offset: 575 },
    { id: 'q26-C', text: 'C  Neither student', offset: 584 },

    // Q27
    { id: 'q27-stem', text: '27.  The tutor says that writing observations in complete sentences', offset: 603 },
    { id: 'q27-A', text: 'A  is often not a good use of time', offset: 669 },
    { id: 'q27-B', text: 'B  makes them easier to interpret later', offset: 704 },
    { id: 'q27-C', text: 'C  means that others can understand them', offset: 743 },

    // Q28
    { id: 'q28-stem', text: '28.  The students must write dates', offset: 784 },
    { id: 'q28-A', text: 'A  next to each drawing', offset: 818 },
    { id: 'q28-B', text: 'B  next to each written section', offset: 842 },
    { id: 'q28-C', text: 'C  next to each drawing and written section', offset: 874 },

    // Section 3 - MCQ Q29-Q30
    { id: 'sec3-heading', text: 'Questions 29 and 30', offset: 918 },
    { id: 'sec3-inst', text: 'Choose TWO letters, A–E.', offset: 938 },
    { id: 'sec3-question', text: 'Which TWO things must be included in the conclusion to the experiment?', offset: 963 },
    { id: 'opt-A', text: 'A  the questions investigated', offset: 1034 },
    { id: 'opt-B', text: 'B  the solutions to the questions', offset: 1064 },
    { id: 'opt-C', text: "C  the student's own thoughts about the experiment", offset: 1097 },
    { id: 'opt-D', text: 'D  the length of time spent on the experiment', offset: 1148 },
    { id: 'opt-E', text: "E  the student's signature", offset: 1194 },
]);
        ...
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <div class="mb-3 part-header-box rounded border border-gray-200 bg-gray-100 px-4 py-3" @mouseup="handleContentTextSelect">
                <h3
                    ...
                    data-segment-id="part-title"
                    v-html="getHighlightedSegmentById('part-title')"
                ></h3>
                <p
                    class="text-sm text-gray-700 select-text"
                    data-segment-id="part-desc"
                    v-html="getHighlightedSegmentById('part-desc')"
                ></p>
            </div>
                ...
                <div class="p-2 sm:p-3">
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                >
                                    <span
                                        ...
                                        data-segment-id="q21-prefix"
                                        v-html="getHighlightedSegmentById('q21-prefix')"
                                    ></span>
                                    <span id="question-21" class="inline-flex items-center">
                                        <input
                                            v-model="answers.q21"
                                            type="text"
                                            spellcheck="false"
                                            autocomplete="off"
                                            class="question-input min-w-[80px] border border-gray-900 px-1.5 py-0.5 text-center text-base focus:border-black focus:outline-none sm:min-w-[120px]"
                                            placeholder="21"
                                    ...
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q21-suffix"
                                        v-html="getHighlightedSegmentById('q21-suffix')"
                                    ></span>
                                    <button
                                ...
                                >
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q22-prefix"
                                        v-html="getHighlightedSegmentById('q22-prefix')"
                                    ></span>
                                    <span id="question-22" class="inline-flex items-center">
                                        <input
                                            v-model="answers.q22"
                                            type="text"
                                            spellcheck="false"
                                    ...
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q22-suffix"
                                        v-html="getHighlightedSegmentById('q22-suffix')"
                                    ></span>
                                    <button
                                ...
                                >
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q23-prefix"
                                        v-html="getHighlightedSegmentById('q23-prefix')"
                                    ></span>
                                    <span id="question-23" class="inline-flex items-center">
                                        <input
                                            v-model="answers.q23"
                                            type="text"
                                            spellcheck="false"
                                    ...
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q23-suffix"
                                        v-html="getHighlightedSegmentById('q23-suffix')"
                                    ></span>
                                    <button
                                ...
                                >
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q24-prefix"
                                        v-html="getHighlightedSegmentById('q24-prefix')"
                                    ></span>
                                    <span id="question-24" class="inline-flex items-center">
                                        <input
                                            v-model="answers.q24"
                                            type="text"
                                            spellcheck="false"
                                    ...
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q24-suffix"
                                        v-html="getHighlightedSegmentById('q24-suffix')"
                                    ></span>
                                    <button
                                ...
                                >
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q25-prefix"
                                        v-html="getHighlightedSegmentById('q25-prefix')"
                                    ></span>
                                    <span id="question-25" class="inline-flex items-center">
                                        <input
                                            v-model="answers.q25"
                                            type="text"
                                            spellcheck="false"
                                    ...
                                    <span
                                        class="text-base text-gray-800"
                                        data-segment-id="q25-suffix"
                                        v-html="getHighlightedSegmentById('q25-suffix')"
                                    ></span>
                                    <button
                            ...
                            <!-- ===== SECTION 2: Single Choice Q26-Q28 ===== -->
                            <div class="border-t pt-4 space-y-5">
                                ...
                                >
                                    ...
                                    <p
                                        class="mb-2 text-base font-medium text-gray-900 select-text pr-8"
                                        data-segment-id="q26-stem"
                                        v-html="getHighlightedSegmentById('q26-stem')"
                                    ></p>
                                    <div class="space-y-1">
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            ...
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q26-A" v-html="getHighlightedSegmentById('q26-A')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q26-B" v-html="getHighlightedSegmentById('q26-B')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q26-C" v-html="getHighlightedSegmentById('q26-C')"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <p
                                        class="mb-2 text-base font-medium text-gray-900 select-text pr-8"
                                        data-segment-id="q27-stem"
                                        v-html="getHighlightedSegmentById('q27-stem')"
                                    ></p>
                                    <div class="space-y-1">
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q27-A" v-html="getHighlightedSegmentById('q27-A')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q27-B" v-html="getHighlightedSegmentById('q27-B')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q27-C" v-html="getHighlightedSegmentById('q27-C')"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <p
                                        class="mb-2 text-base font-medium text-gray-900 select-text pr-8"
                                        data-segment-id="q28-stem"
                                        v-html="getHighlightedSegmentById('q28-stem')"
                                    ></p>
                                    <div class="space-y-1">
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q28-A" v-html="getHighlightedSegmentById('q28-A')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q28-B" v-html="getHighlightedSegmentById('q28-B')"></span>
                                        </label>
                                        <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                            <input
                                                type="radio"
                                                ...
                                                class="mt-0.5 h-4 w-4 shrink-0 border-gray-300 text-black focus:ring-black"
                                            />
                                            <span class="text-base leading-relaxed text-gray-900 select-text" data-segment-id="q28-C" v-html="getHighlightedSegmentById('q28-C')"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>

                            <!-- ===== SECTION 3: Choose TWO Q29 & Q30 ===== -->
                            <div
                                id="question-29-30"
                                class="relative border-t pt-4 p-2 sm:p-3"
                            ...
                            >
                                ...
                                <button
                                    ...
                                    class="absolute top-6 right-2 flex h-7 w-7 items-center justify-center rounded border transition-all"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="p-2">
                                        <p
                                            ...
                                            data-segment-id="sec3-inst"
                                            v-html="getHighlightedSegmentById('sec3-inst')"
                                        ></p>
                                        <p
                                            class="text-base leading-tight font-bold text-gray-900 select-text"
                                            data-segment-id="sec3-question"
                                            v-html="getHighlightedSegmentById('sec3-question')"
                                        ></p>
                                    </div>
                                </div>

                                <!-- Checkbox options A–E -->
                                <div class="space-y-1">
                                    <label class="flex cursor-pointer items-start gap-1 rounded p-1 transition-colors hover:bg-gray-50">
                                        <input
                                            type="checkbox"
                                ...
                                <!-- Selected counter -->
                                <div class="mt-2 p-2">
                                    <p class="text-base font-medium text-gray-900">Selected: {{ multipleAnswers.q29_30.length }}/2 answers</p>
                                </div>
                            </div>
