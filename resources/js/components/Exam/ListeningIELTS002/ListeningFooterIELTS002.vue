...
const isGroupFlagged = (questionNumber: number): boolean => {
    // Questions 28-30 share flag with question 28
    if (questionNumber === 28 || questionNumber === 29 || questionNumber === 30) {
        return props.flaggedQuestions.has(28);
    }
    // Questions 31-32 share flag with question 31
    if (questionNumber === 31 || questionNumber === 32) {
        return props.flaggedQuestions.has(31);
    }
    // Questions 33-34 share flag with question 33
    if (questionNumber === 33 || questionNumber === 34) {
        return props.flaggedQuestions.has(33);
    }
