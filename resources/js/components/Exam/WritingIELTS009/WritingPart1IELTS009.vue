...
const questionText = ref(`You should spend about 20 minutes on this task
...
const PANEL_WIDTH_KEY = 'writing-part1-ielts002-panel-width';
            ...
            <div ref="containerRef" class="relative flex flex-col gap-0 lg:flex-row" :class="{ 'select-none': isResizing }">
                ...
                >
                    ...
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" class="space-y-3 select-text sm:space-y-4">
                        <div class="text-sm leading-relaxed whitespace-pre-wrap text-gray-800 sm:text-base" v-html="highlightedQuestionText"></div>

                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS009.png" alt="Village development diagrams" class="mx-auto h-full rounded-lg shadow-md" />
                        </div>
                    </div>
                ...
                >
                    ...
                    <div class="absolute flex flex-col gap-1 opacity-40 transition-opacity group-hover:opacity-100">
                        <div class="h-1 w-1 rounded-full bg-gray-400 group-hover:bg-blue-600"></div>
                        <div class="h-1 w-1 rounded-full bg-gray-400 group-hover:bg-blue-600"></div>
                        <div class="h-1 w-1 rounded-full bg-gray-400 group-hover:bg-blue-600"></div>
                    </div>
                </div>
                ...
                >
                    <textarea
                        v-model="answer"
                        class="h-[40vh] w-full resize-none rounded-lg border-2 border-gray-300 bg-white p-3 text-sm text-gray-900 transition-all duration-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none sm:h-[50vh] sm:p-4 sm:text-base lg:h-[70vh]"
