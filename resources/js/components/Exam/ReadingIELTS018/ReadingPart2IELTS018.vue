...
const allStaticTexts = [
  ...
  // Index 2: Title
  'Fears',
  // Index 3: empty (no subtitle)
  '',
  // Index 4: Passage
  passageText.value,

  // Index 5-6: Questions section headers
  'QUESTIONS',
  'Answer all questions based on Reading Passage 2',

  // Index 7-11: Q14-18 block headers
  'Questions 14-18',
  ...
  // Index 12-16: Q14-18 statement texts
  ...
  // Index 17-20: Q19-22 block headers
  'Questions 19-22',
  'Choose words from the passage to answer the questions 19–22.',
  'Write NO MORE THAN THREE WORDS for each answer.',
  '',

  // Index 21-24: Q19-22 question texts
  'What do humans and animals differ while they share similar physiological and psychological developmental stages?',
  'What reaction did the monkey start with when they were gazed at expressionless?',
  'How many preadolescent monkeys became aggressive when they were facing domination from another member of their own species?',
  'According to the passage, what determines social behavior in both humans and monkeys?',

  // Index 25-28: Q23-27 block headers
  'Questions 23-27',
  'Complete the summary.',
  'Choose NO MORE THAN THREE WORDS from the passage for each answer.',
  '',

  // Index 29-35: Summary sentence parts for Q23-27
  'In order to understand the brain processes that cause',                                         // 29
  'in people, and how genetic variation might influence social behavior, scientists first conducted three experiments to gain more insight into fear in monkeys. For both humans and monkeys,',  // 30
  'can convey social information. It was found that monkeys with one copy of the short gene were less likely to look at the face of a',  // 31
  'and to take a risk. The monkey without a',                                                      // 32
  'would sight on dominant males if they were rewarded, while the',                               // 33
  'monkeys waived the reward.',                                                                    // 34

  // Index 35-39: Question number labels for Q14-18
  '<b>14.</b>',
  '<b>15.</b>',
  '<b>16.</b>',
  '<b>17.</b>',
          ...
          <div class="flex-1 overflow-y-auto pb-32">
            <div class="space-y-8 p-4" :style="contentZoom">
              ...
              <div class="p-6">
                ...
                <div class="space-y-5">
                  <!-- Question 19 -->
                  <div id="question-19" class="relative flex items-start gap-3 pr-10"
                    ...
                    <div class="flex-1">
                      ...
                      <input v-model="answers.q19" type="text" placeholder="19"
                        class="w-full font-bold text-center border border-gray-900 px-3 py-1 text-base transition-colors placeholder:text-gray-400 focus:border-black focus:outline-none sm:text-base" />
                    </div>
                  ...
                  <div id="question-20" class="relative flex items-start gap-3 pr-10"
                    ...
                    <div class="flex-1">
                      ...
                      <input v-model="answers.q20" type="text" placeholder="20"
                        class="w-full font-bold text-center border border-gray-900 px-3 py-1 text-base transition-colors placeholder:text-gray-400 focus:border-black focus:outline-none sm:text-base" />
                    </div>
              ...
              <div class="p-6">
                ...
                <div class="text-base leading-relaxed text-gray-800 sm:text-base">
                  <p class="leading-loose">
                    ...
                    <!-- Q23 input -->
                    <span id="question-23" class="relative inline-flex items-center mx-1"
                      @mouseenter="hoveredQuestion = 23" @mouseleave="hoveredQuestion = null">
                      <input v-model="answers.q23" type="text" placeholder="23"
                        class="w-36 border border-gray-900 px-2 py-0.5 text-center text-base font-medium transition-colors placeholder:font-bold placeholder:text-gray-500 focus:border-black focus:outline-none sm:text-base" />
                    ...
                    <!-- Q24 input -->
                    <span id="question-24" class="relative inline-flex items-center mx-1"
                    ...
                    <!-- Q25 input -->
                    <span id="question-25" class="relative inline-flex items-center mx-1"
                      @mouseenter="hoveredQuestion = 25" @mouseleave="hoveredQuestion = null">
                      <input v-model="answers.q25" type="text" placeholder="25"
                        class="w-36 border border-gray-900 px-2 py-0.5 text-center text-base font-medium transition-colors placeholder:font-bold placeholder:text-gray-500 focus:border-black focus:outline-none sm:text-base" />
                      <button v-show="hoveredQuestion === 25 || isQuestionFlagged(25)" @click.stop="toggleFlag(25)"
                        class="absolute -top-1 -right-8 flex h-7 w-7 items-center justify-center rounded border transition-all"
                    ...
                    <!-- Q26 input -->
                    <span id="question-26" class="relative inline-flex items-center mx-1"
                    ...
                    <!-- Q27 input -->
                    <span id="question-27" class="relative inline-flex items-center mx-1"
