...
const getButtonClasses = (questionRef: number | string) => {
    ...
    if (isAnswered) {
        if (props.activePart === 'part1') {
            return `${baseClasses} bg-gradient-to-r from-cyan-500 to-teal-600 text-white shadow-md`;
        } else if (props.activePart === 'part2') {
            ...
            return `${baseClasses} bg-gradient-to-r from-orange-500 to-amber-600 text-white shadow-md`;
        }
    } else {
...
const getDesktopButtonClasses = (questionRef: number | string) => {
    ...
    if (isAnswered) {
        if (props.activePart === 'part1') {
            return `${baseClasses} bg-gradient-to-r from-cyan-500 to-teal-600 text-white hover:from-cyan-600 hover:to-teal-700 focus:ring-cyan-500 shadow-md`;
        } else if (props.activePart === 'part2') {
            ...
            return `${baseClasses} bg-gradient-to-r from-emerald-500 to-green-600 text-white hover:from-emerald-600 hover:to-green-700 focus:ring-emerald-500 shadow-md`;
        } else {
            return `${baseClasses} bg-gradient-to-r from-orange-500 to-amber-600 text-white hover:from-orange-600 hover:to-amber-700 focus:ring-orange-500 shadow-md`;
        }
    } else {
                    ...
                    <div class="flex items-center justify-center gap-2 xl:justify-start">
                        ...
                        >
                            <div
                                ...
                                :class="activePart === 'part1' ? 'bg-white/20' : 'bg-cyan-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part1' ? 'text-white' : 'text-cyan-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div
                                class="flex h-6 w-6 items-center justify-center rounded-md"
                                :class="activePart === 'part2' ? 'bg-white/20' : 'bg-blue-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part2' ? 'text-white' : 'text-blue-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div
                                class="flex h-6 w-6 items-center justify-center rounded-md"
                                :class="activePart === 'part3' ? 'bg-white/20' : 'bg-emerald-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part3' ? 'text-white' : 'text-emerald-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
