...
const PANEL_WIDTH_KEY = 'reading-c19t3-part1-panel-width';
...
const textSegments = ref([
    ...
    { text: 'Archaeologists discover evidence of prehistoric island settlers', offset: 5114 },
    { text: 'Questions 1-7', offset: 5177 },
    { text: 'Do the following statements agree with the information given in Reading Passage 1?', offset: 5191 },
    { text: 'In boxes 1-7 on your answer sheet, write', offset: 5273 },
    { text: 'TRUE', offset: 5315 },
    { text: 'if the statement agrees with the information', offset: 5320 },
    { text: 'FALSE', offset: 5365 },
    { text: 'if the statement contradicts the information', offset: 5371 },
    { text: 'NOT GIVEN', offset: 5416 },
    { text: 'if there is no information on this', offset: 5426 },
    { text: 'Archaeological research had taken place on the island of Obi before the arrival of Ceri Shipton and his colleagues.', offset: 5460 },
    { text: 'At the Kelo sites, the researchers found the first clam shell axes ever to be discovered in the region.', offset: 5575 },
    { text: 'The size of Obi today is less than it was 18,000 years ago.', offset: 5678 },
    { text: 'A change in the climate around 11,700 years ago had a greater impact on Obi than on the surrounding islands.', offset: 5738 },
    {
    ...
    { text: 'Shipton\u2019s team were surprised to find evidence of the Obi islanders\u2019 hunting practices.', offset: 5972 },
    { text: 'It is thought that the Kelo shelters were occupied continuously until about 1,000 years ago.', offset: 6061 },
    { text: 'Questions 8-13', offset: 6154 },
    { text: 'Complete the notes below.', offset: 6169 },
    { text: 'Choose ONE WORD ONLY from the passage for each answer.', offset: 6195 },
    { text: 'Write your answers in boxes 8-13 on your answer sheet.', offset: 6250 },
    { text: 'Archaeological findings on Obi', offset: 6305 },
    { text: 'Excavations of rock shelters inside ', offset: 6336 },
    { text: ' near the village of Kelo revealed:', offset: 6372 },
    { text: 'axes from around 14,000 years ago, probably used to make canoes', offset: 6407 },
    { text: 'axes made out of ', offset: 6470 },
    { text: ', dating from around 11,700 years ago', offset: 6488 },
    { text: ' of an animal: evidence of what ancient islanders ate', offset: 6526 },
    { text: 'evidence of travel between islands:', offset: 6579 },
    { text: 'obsidian: a material that is not found naturally on Obi', offset: 6614 },
    { text: ' which resembled ones found on other islands.', offset: 6669 },
    { text: 'It is thought that from 8,000 years ago, Obi islanders:', offset: 6714 },
    { text: 'may have switched from hunting to fishing', offset: 6774 },
    { text: 'had ', offset: 6815 },
    { text: ' as well as items made out of metal', offset: 6820 },
    { text: 'probably took part in the production and sale of ', offset: 6855 },
]);
                        ...
                        <div class="flex-shrink-0 border-b border-gray-200 bg-white p-6">
                            ...
                            <div class="flex items-center justify-between gap-2">
                                <div>
                                    ...
                                    >
                                        <span
                                            :data-segment-text="'Archaeologists discover evidence of prehistoric island settlers'"
                                            v-html="getHighlightedSegment('Archaeologists discover evidence of prehistoric island settlers')"
                                        ></span>
                                    </h2>
                                </div>
                                <button
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        ...
                                                        :data-segment-text="'Archaeological research had taken place on the island of Obi before the arrival of Ceri Shipton and his colleagues.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'At the Kelo sites, the researchers found the first clam shell axes ever to be discovered in the region.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'The size of Obi today is less than it was 18,000 years ago.'"
                                                        v-html="getHighlightedSegment('The size of Obi today is less than it was 18,000 years ago.')"
                                                    ></p>
                                                    <div class="flex flex-wrap justify-start gap-4 sm:gap-6">
                                                        <label
                                                            v-for="option in ['TRUE', 'FALSE', 'NOT GIVEN']"
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'A change in the climate around 11,700 years ago had a greater impact on Obi than on the surrounding islands.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'The researchers believe there is a connection between warmer, wetter weather and a change in the material used to make axes.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'Shipton\u2019s team were surprised to find evidence of the Obi islanders\u2019 hunting practices.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                            ...
                                            >
                                                ...
                                                <div class="flex-1">
                                                    <p
                                                        class="mb-3 text-gray-800"
                                                        :data-segment-text="'It is thought that the Kelo shelters were occupied continuously until about 1,000 years ago.'"
                                                        v-html="
                                                            getHighlightedSegment(
                                    ...
                                    <section id="question-8-13" class="space-y-4">
                                        ...
                                        <div class="space-y-3 rounded-lg bg-white/50 p-4">
                                            <h4
                                                ...
                                                :data-segment-text="'Archaeological findings on Obi'"
                                                v-html="getHighlightedSegment('Archaeological findings on Obi')"
                                            ></h4>
                                            ...
                                            <div id="question-8" class="flex items-center gap-3 rounded-lg p-3">
                                                ...
                                                <p class="flex-1 text-gray-700">
                                                    <span
                                                        :data-segment-text="'Excavations of rock shelters inside '"
                                                        v-html="getHighlightedSegment('Excavations of rock shelters inside ')"
                                                    ></span>
                                                    <input
                                                        v-model="answers.q8"
                                                        type="text"
                                                    ...
                                                    />
                                                    <span
                                                        :data-segment-text="' near the village of Kelo revealed:'"
                                                        v-html="getHighlightedSegment(' near the village of Kelo revealed:')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="ml-11 rounded-lg p-3">
                                                <p class="text-gray-700">
                                                    ...
                                                    <span
                                                        :data-segment-text="'axes from around 14,000 years ago, probably used to make canoes'"
                                                        v-html="
                                                            getHighlightedSegment('axes from around 14,000 years ago, probably used to make canoes')
                                                        "
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div id="question-9" class="flex items-center gap-3 rounded-lg p-3">
                                                ...
                                                <p class="flex-1 text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span
                                                        :data-segment-text="'axes made out of '"
                                                        v-html="getHighlightedSegment('axes made out of ')"
                                                    ></span>
                                                    <input
                                                        v-model="answers.q9"
                                                        type="text"
                                                    ...
                                                    />
                                                    <span
                                                        :data-segment-text="', dating from around 11,700 years ago'"
                                                        v-html="getHighlightedSegment(', dating from around 11,700 years ago')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div id="question-10" class="flex items-center gap-3 rounded-lg p-3">
                                                ...
                                                <p class="flex-1 text-gray-700">
                                                    ...
                                                    />
                                                    <span
                                                        :data-segment-text="' of an animal: evidence of what ancient islanders ate'"
                                                        v-html="getHighlightedSegment(' of an animal: evidence of what ancient islanders ate')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="ml-11 rounded-lg p-3">
                                                <p class="text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span
                                                        :data-segment-text="'evidence of travel between islands:'"
                                                        v-html="getHighlightedSegment('evidence of travel between islands:')"
                                                    ></span>
                                                </p>
                                            </div>

                                            <div class="ml-16 rounded-lg p-3">
                                                <p class="text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span
                                                        :data-segment-text="'obsidian: a material that is not found naturally on Obi'"
                                                        v-html="getHighlightedSegment('obsidian: a material that is not found naturally on Obi')"
                                                    ></span>
                                                </p>
                                            </div>

                                            <!-- Q11 -->
                                            <div id="question-11" class="ml-5 flex items-center gap-3 rounded-lg p-3">
                                                <span
                                                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-blue-600 font-bold text-white shadow-md"
                                                    >11</span
                                                >
                                                <p class="flex-1 text-gray-700">
                                                    ...
                                                    />
                                                    <span
                                                        :data-segment-text="' which resembled ones found on other islands.'"
                                                        v-html="getHighlightedSegment(' which resembled ones found on other islands.')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="mt-4 rounded-lg p-3">
                                                <p class="font-semibold text-gray-700">
                                                    <span
                                                        :data-segment-text="'It is thought that from 8,000 years ago, Obi islanders:'"
                                                        v-html="getHighlightedSegment('It is thought that from 8,000 years ago, Obi islanders:')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="ml-11 rounded-lg p-3">
                                                <p class="text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span
                                                        :data-segment-text="'may have switched from hunting to fishing'"
                                                        v-html="getHighlightedSegment('may have switched from hunting to fishing')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div id="question-12" class="flex items-center gap-3 rounded-lg p-3">
                                                ...
                                                <p class="flex-1 text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span :data-segment-text="'had '" v-html="getHighlightedSegment('had ')"></span>
                                                    <input
                                                        v-model="answers.q12"
                                                        type="text"
                                                        class="mx-1 inline-block w-32 rounded-lg border border-blue-300 bg-white p-1 text-sm shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                                    />
                                                    <span
                                                        :data-segment-text="' as well as items made out of metal'"
                                                        v-html="getHighlightedSegment(' as well as items made out of metal')"
                                                    ></span>
                                                </p>
                                            </div>
                                            ...
                                            <div id="question-13" class="flex items-center gap-3 rounded-lg p-3">
                                                ...
                                                <p class="flex-1 text-gray-700">
                                                    <span class="mr-2">-</span>
                                                    <span
                                                        :data-segment-text="'probably took part in the production and sale of '"
                                                        v-html="getHighlightedSegment('probably took part in the production and sale of ')"
                                                    ></span>
                                                    <input
                                                        v-model="answers.q13"
                                                        type="text"
