...
const getButtonClasses = (questionRef: number) => {
    ...
    if (isAnswered) {
        if (props.activePart === 'part1') {
            ...
            return `${baseClasses} bg-gradient-to-r from-sky-500 to-blue-600 text-white shadow-md`;
        } else {
            return `${baseClasses} bg-gradient-to-r from-lime-500 to-green-600 text-white shadow-md`;
        }
    } else {
...
const getDesktopButtonClasses = (questionRef: number) => {
    ...
    if (isAnswered) {
        if (props.activePart === 'part1') {
            ...
            return `${baseClasses} bg-gradient-to-r from-sky-500 to-blue-600 text-white hover:from-sky-600 hover:to-blue-700 shadow-md`;
        } else {
            return `${baseClasses} bg-gradient-to-r from-lime-500 to-green-600 text-white hover:from-lime-600 hover:to-green-700 shadow-md`;
        }
    } else {
                    ...
                    <div class="flex items-center justify-center gap-2 xl:justify-start">
                        ...
                        >
                            <div
                                ...
                                :class="activePart === 'part1' ? 'bg-white/20' : 'bg-rose-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part1' ? 'text-white' : 'text-rose-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div
                                class="flex h-6 w-6 items-center justify-center rounded-md"
                                :class="activePart === 'part2' ? 'bg-white/20' : 'bg-violet-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part2' ? 'text-white' : 'text-violet-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div
                                class="flex h-6 w-6 items-center justify-center rounded-md"
                                :class="activePart === 'part3' ? 'bg-white/20' : 'bg-sky-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part3' ? 'text-white' : 'text-sky-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div
                                class="flex h-6 w-6 items-center justify-center rounded-md"
                                :class="activePart === 'part4' ? 'bg-white/20' : 'bg-lime-100'"
                            >
                                <svg
                                    class="h-3 w-3"
                                    :class="activePart === 'part4' ? 'text-white' : 'text-lime-600'"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
