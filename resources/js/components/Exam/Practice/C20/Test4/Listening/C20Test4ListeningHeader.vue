...
const loadAudio = () => {
    if (audioRef.value) {
        audioRef.value.src = '/audio/listening14.mp3';
        audioRef.value.load();
    }
};
...
const onAudioError = () => {
    console.error('Audio failed to load. Please check if the audio file exists at /audio/listening14.mp3');
};
            ...
            <div class="hidden h-20 items-center justify-between gap-6 md:flex">
                ...
                <div class="flex min-w-fit items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Cambridge 20 - Listening</p>
                    </div>
                </div>
