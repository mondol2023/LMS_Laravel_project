...
const textSegments = ref<TextSegment[]>([
    ...
    { id: 2, text: 'Self-Access Centre', offset: 97 },
    // Question 21
    { id: 'q21', text: '21.', offset: 116 },
    { id: 3, text: 'Students want to keep the Self-Access Centre because', offset: 120 },
    { id: 4, text: 'they enjoy the variety of equipment', offset: 173 },
    { id: 5, text: 'they like being able to work on their own', offset: 211 },
    { id: 6, text: 'it is an important part of their studies', offset: 255 },
    // Question 22
    { id: 'q22', text: '22.', offset: 297 },
    { id: 7, text: 'Some teachers would prefer to', offset: 301 },
    { id: 8, text: 'close the Self-Access Centre', offset: 331 },
    { id: 9, text: 'move the Self-Access Centre elsewhere', offset: 362 },
    { id: 10, text: 'restrict access to the Self-Access Centre', offset: 402 },
    // Question 23
    { id: 'q23', text: '23.', offset: 446 },
    { id: 11, text: "The students' main concern about using the library would be", offset: 450 },
    { id: 12, text: 'the size of the library', offset: 511 },
    { id: 13, text: 'difficulty in getting help', offset: 537 },
    { id: 14, text: 'the lack of materials', offset: 566 },
    // Question 24
    { id: 'q24', text: '24.', offset: 590 },
    { id: 15, text: 'The Director of Studies is concerned about', offset: 594 },
    { id: 16, text: 'the cost of upgrading the centre', offset: 638 },
    { id: 17, text: 'the lack of space in the centre', offset: 673 },
    { id: 18, text: 'the difficulty in supervising the centre', offset: 707 },
    // Questions 25-30 section
    { id: 'q25-30-heading', text: 'Questions 25–30', offset: 749 },
    { id: 'q25-30-inst1', text: 'Complete the notes below.', offset: 765 },
    { id: 'q25-30-inst2', text: 'Write NO MORE THAN TWO WORDS for each answer.', offset: 791 },
    { id: 'q25-30-title', text: 'Necessary improvements to the existing Self-Access Centre', offset: 838 },
    { id: 'equip-heading', text: 'Equipment', offset: 897 },
    { id: 19, text: 'Replace computers to create more space', offset: 907 },
    { id: 'resources-heading', text: 'Resources', offset: 946 },
    // Question 25
    { id: 'q25-pre', text: 'The level of the', offset: 956 },
    { id: 'q25-post', text: 'materials, in particular, should be more clearly shown.', offset: 990 },
    // Question 26
    { id: 'q26-pre', text: 'Update the', offset: 1047 },
    { id: 'q26-post', text: 'collection.', offset: 1068 },
    // Question 27
    { id: 'q27-pre', text: 'Buy some', offset: 1080 },
    { id: 'q27-post', text: 'and divide them up.', offset: 1098 },
    { id: 'room-heading', text: 'Use of the room', offset: 1118 },
    // Question 28
    { id: 'q28-pre', text: 'Speak to the teachers and organize a', offset: 1134 },
    { id: 'q28-post', text: 'for supervising the centre.', offset: 1181 },
    // Question 29
    { id: 'q29-pre', text: 'Install an', offset: 1209 },
    // Question 30
    { id: 'q30-pre', text: 'Restrict personal use of', offset: 1233 },
    { id: 'q30-post', text: 'on computers.', offset: 1266 },
]);
            ...
            <div @mouseup="handleContentTextSelect" class="flex-1 overflow-y-auto pb-24 select-text">
                <div class="p-2 sm:p-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <!-- Questions 25-30: Fill in the blank (notes completion) -->
                        <div id="question-25-30" class="relative p-2 sm:p-3">
                            ...
                            <div class="">
                                ...
                                <p class="mb-1 text-sm font-bold text-gray-700 select-text underline"
                                    data-segment-id="equip-heading" v-html="getHighlightedSegmentById('equip-heading')">
                                </p>
                                <ul class="mb-3 list-disc pl-5">
                                    <li class="text-base text-gray-900 select-text" data-segment-id="19"
                                        v-html="getHighlightedSegmentById(19)"></li>
                                </ul>

                                <!-- Resources sub-section -->
                                <p class="mb-1 text-sm font-bold text-gray-700 select-text underline"
                                    data-segment-id="resources-heading"
                                    v-html="getHighlightedSegmentById('resources-heading')"></p>
                                <ul class="mb-3 space-y-2 list-disc pl-5">
                                    <!-- Q25 -->
<li class="relative text-base text-gray-900 group">
    <div class="inline-flex items-center gap-2">
        <span class="select-text font-medium" data-segment-id="q25-pre"
            v-html="getHighlightedSegmentById('q25-pre')"></span>
        <div class="inline-flex items-center gap-2">
            <div class="inline-flex items-center border border-gray-400 rounded bg-white">
                <input v-model="fillAnswers.q25" type="text" placeholder="25"
                    class="w-32 px-2 py-1 text-base text-gray-900 focus:border-black focus:outline-none rounded text-center" />
            </div>
...
<li class="relative text-base text-gray-900 group">
    <div class="inline-flex items-center gap-2">
        <span class="select-text font-medium" data-segment-id="q26-pre"
        ...
        <div class="inline-flex items-center gap-2">
            ...
            <span class="select-text" data-segment-id="q26-post"
                v-html="getHighlightedSegmentById('q26-post')"></span>
...
<li class="relative text-base text-gray-900 group">
    <div class="inline-flex items-center gap-2">
        <span class="select-text font-medium" data-segment-id="q27-pre"
...
<!-- Use of the room sub-section -->
<p class="mb-1 text-sm font-bold text-gray-700 select-text underline"
    data-segment-id="room-heading" v-html="getHighlightedSegmentById('room-heading')">
</p>
<ul class="space-y-2 list-disc pl-5">
    <!-- Q28 -->
    <li class="relative text-base text-gray-900 group">
        <div class="inline-flex items-center gap-2">
            <span class="select-text font-medium" data-segment-id="q28-pre"
    ...
    <li class="relative text-base text-gray-900 group">
        <div class="inline-flex items-center gap-2">
            <span class="select-text font-medium" data-segment-id="q29-pre"
                v-html="getHighlightedSegmentById('q29-pre')"></span>
            <div class="inline-flex items-center gap-2">
                <div class="inline-flex items-center border border-gray-400 rounded bg-white">
    ...
    <li class="relative text-base text-gray-900 group">
        <div class="inline-flex items-center gap-2">
            <span class="select-text font-medium" data-segment-id="q30-pre"
