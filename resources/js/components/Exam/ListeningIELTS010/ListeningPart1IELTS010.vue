...
const textSegments = ref([
    ...
    { id: 2, text: 'ONE WORD AND/OR A NUMBER', offset: 84 },
    // Form title
    { id: 3, text: 'ACCOMMODATION FORM – STUDENT INFORMATION', offset: 109 },
    // Form rows static text
    { id: 4, text: 'Type of accommodation:', offset: 150 },
    { id: 5, text: 'hall of residence', offset: 173 },
    { id: 6, text: 'Name: Anu', offset: 191 },
    { id: 7, text: 'Date of birth:', offset: 201 },
    { id: 8, text: 'Country of origin:', offset: 216 },
    { id: 9, text: 'India', offset: 235 },
    { id: 10, text: 'Course of study:', offset: 241 },
    { id: 11, text: 'Number of years planned in hall:', offset: 258 },
    { id: 12, text: 'Preferred catering arrangement:', offset: 291 },
    { id: 13, text: 'half board', offset: 323 },
    { id: 14, text: 'Special dietary requirements: no', offset: 334 },
    { id: 15, text: '(red)', offset: 367 },
    { id: 16, text: 'Preferred room type: a single', offset: 373 },
    { id: 17, text: 'Interests: the', offset: 403 },
    { id: 18, text: 'badminton', offset: 418 },
    { id: 19, text: 'Priorities in choice of hall: to be with other students who are', offset: 428 },
    { id: 20, text: 'To live outside the', offset: 492 },
    { id: 21, text: 'To have a', offset: 512 },
    { id: 22, text: 'area for socializing', offset: 522 },
    { id: 23, text: 'Contact phone number', offset: 543 },
    { id: 24, text: '667549', offset: 564 },
]);
                ...
                <div class="p-2 sm:p-3">
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-3">
                            ...
                            <!-- Row: Type of accommodation -->
                            <div class="flex flex-wrap items-center gap-1">
                                <span class="text-gray-800" data-segment-id="4" v-html="getHighlightedSegmentById(4)"></span>
                                <span class="text-gray-800" data-segment-id="5" v-html="getHighlightedSegmentById(5)"></span>
                            </div>
                            ...
                            <!-- Row: Number of years planned in hall -->
                            <div class="flex flex-wrap items-center gap-0.5 group">
                            ...
                            <!-- Row: Preferred catering arrangement -->
                            <div class="flex flex-wrap items-center gap-1">
                            ...
                            <!-- Row: Special dietary requirements -->
                            <div class="flex flex-wrap items-center gap-0.5 group">
                            ...
                            <div class="border-t pt-3">
                                <!-- Row: Priorities - to be with other students who are -->
                                <div class="flex flex-wrap items-center gap-0.5 mb-2 group">
                                ...
                                <!-- Row: To have a [10] area for socializing -->
                                <div class="flex flex-wrap items-center gap-0.5 mb-2 group">
