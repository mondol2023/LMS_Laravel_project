...
const questionText = ref(`The bar shows the percentage of people going to cinemas in one European country on different days.
                ...
                <div class="max-h-screen overflow-y-auto  p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img src="/images/writing/IELTS011.png" alt="Village development diagrams" class="mx-auto h-full" />
                        </div>
                    </div>
                </div>
