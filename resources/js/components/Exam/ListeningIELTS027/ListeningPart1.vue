...
const textSegments = ref([
    // Part header
    { id: 'part1-title', text: 'Part 1: Building work', offset: 0 },

    // Question header
    { id: 0, text: 'QUESTION 1–10', offset: 22 },
    { id: 1, text: 'Complete the notes below.', offset: 36 },

    // Section title
    { id: 2, text: 'Building Work', offset: 62 },

    // Address
    { id: 3, text: 'Address: 15 Hill Street', offset: 76 },

    // Contact info
    { id: 4, text: 'Contact Information', offset: 100 },
    { id: 5, text: 'Name: Sally', offset: 120 },
    { id: 6, text: 'Phone: 027 584 6613', offset: 132 },

    // Kitchen section
    { id: 7, text: 'Kitchen', offset: 153 },
    { id: 8, text: 'Needs a bigger window', offset: 160 },
    { id: 9, text: 'The kitchen is too hot – fit a', offset: 183 },

    // Bathroom
    { id: 10, text: 'Bathroom', offset: 214 },
    { id: 11, text: 'Put a', offset: 223 },
    { id: 12, text: 'on the back wall', offset: 229 },
    { id: 13, text: 'Decide the', offset: 246 },
    { id: 14, text: 'of the small tiles later', offset: 257 },

    // Outside
    { id: 15, text: 'Outside', offset: 281 },
    { id: 16, text: 'Put a higher', offset: 289 },
    { id: 17, text: 'in the garden', offset: 302 },
    { id: 18, text: 'Put a new', offset: 316 },
    { id: 19, text: 'on the garage door', offset: 326 },
    { id: 20, text: 'Fix the roof – it was damaged by a', offset: 345 },
    { id: 21, text: 'Fit a new rain gutter made of', offset: 379 },

    // Other info
    { id: 22, text: 'Other information', offset: 410 },
    { id: 23, text: 'Start date:', offset: 428 },
    { id: 24, text: 'Security code:', offset: 440 },
]);
                            ...
                            <div>
                                ...
                                <div class="space-y-2 text-base leading-relaxed text-gray-800">
                                    ...
                                    <div class="flex flex-wrap items-center gap-0.5">
                                        <span class="text-gray-800" data-segment-id="3" v-html="getHighlightedSegmentById(3)"></span>
                                    </div>

                                    <!-- Contact Information -->
                                    <div>
                                        <h4 class="font-bold text-gray-900 mt-2"
                                            data-segment-id="4"
                                    ...
                                    <div>
                                        ...
                                        <!-- The kitchen is too hot – fit a Q2 -->
                                        <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                            <span class="text-gray-500 mr-1">•</span>
                                    ...
                                    <div>
                                        ...
                                        <!-- Decide the Q4 of the small tiles later -->
                                        <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                            <span class="text-gray-500 mr-1">•</span>
                                    ...
                                    <div>
                                        ...
                                        <!-- Put a new Q6 on the garage door -->
                                        <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                            <span class="text-gray-500 mr-1">•</span>
                                        ...
                                        <!-- Fix the roof – it was damaged by a Q7 -->
                                        <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                            <span class="text-gray-500 mr-1">•</span>
                                        ...
                                        <!-- Fit a new rain gutter made of Q8 -->
                                        <div class="flex flex-wrap items-center gap-0.5 ml-4">
                                            <span class="text-gray-500 mr-1">•</span>
