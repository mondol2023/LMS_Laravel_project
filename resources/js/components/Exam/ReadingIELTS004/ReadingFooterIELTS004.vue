...
// Question ranges for each part (IELTS002 Reading: 14, 13, 13 questions)
const partQuestions = {
    part1: Array.from({ length: 13 }, (_, i) => i + 1),      // 1-14
    part2: Array.from({ length: 14 }, (_, i) => i + 14),     // 15-27
    part3: Array.from({ length: 13 }, (_, i) => i + 28),     // 28-40
};

// Count answered questions for each part (IELTS002: 14, 13, 13)
                ...
                <div class="flex items-center gap-1">
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="text-gray-500">{{ part2AnsweredCount }} of 14</span>
                        </button>
                    </template>
                </div>
                ...
                <div class="mr-6 flex items-center gap-1">
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="text-gray-500">{{ part3AnsweredCount }} of 13</span>
                        </button>
                    </template>
                </div>
            </div>
