...
const textSegments = ref([
    ...
    // Section A instruction segments
    { id: 'secA-title', text: 'Questions 1–3', offset: 40 },
    { id: 'secA-inst1', text: 'Complete the form below.', offset: 54 },
    { id: 'secA-inst2', text: 'Write ', offset: 79 },
    { id: 'secA-inst3', text: 'NO MORE THAN THREE WORDS AND/OR A NUMBER', offset: 85 },
    { id: 'secA-inst4', text: ' for each answer.', offset: 125 },
    // Form header
    { id: 'form-title', text: 'TOTAL INSURANCE INCIDENT REPORT', offset: 143 },
    // Form rows static text
    { id: 'form-name', text: 'Name: Michael Alexander', offset: 175 },
    { id: 'form-addr-pre', text: 'Address: 24 Mainly Street,', offset: 199 },
    { id: 'form-addr-post', text: ', Sydney', offset: 226 },
    { id: 'form-agent-pre', text: 'Shipping agent:', offset: 235 },
    { id: 'form-origin', text: 'Place of origin: China', offset: 251 },
    { id: 'form-date-pre', text: 'Date of arrival:', offset: 274 },
    { id: 'form-ref', text: 'Reference number: 601ACK', offset: 291 },
    // Section B instruction segments
    { id: 'secB-title', text: 'Questions 4–10', offset: 316 },
    { id: 'secB-inst1', text: 'Complete the table below. Write ', offset: 331 },
    { id: 'secB-inst2', text: 'ONE WORD OR A NUMBER', offset: 363 },
    { id: 'secB-inst3', text: ' for each answer.', offset: 383 },
    // Table headers
    { id: 'th-item', text: 'Item', offset: 401 },
    { id: 'th-damage', text: 'Damage', offset: 406 },
    { id: 'th-cost', text: 'Cost to repair/ replace', offset: 413 },
    // Row 1 – Television
    { id: 'r1-item', text: 'Television', offset: 437 },
    { id: 'r1-dmg-pre', text: 'the', offset: 448 },
    { id: 'r1-dmg-post', text: 'needs to be replaced', offset: 452 },
    { id: 'r1-cost', text: 'not known', offset: 473 },
    // Row 2 – Cabinet
    { id: 'r2-item-pre', text: 'The', offset: 483 },
    { id: 'r2-item-post', text: 'cabinet', offset: 487 },
    { id: 'r2-dmg-pre', text: 'the', offset: 495 },
    { id: 'r2-dmg-post', text: 'of the cabinet is damaged', offset: 499 },
    { id: 'r2-cost-pre', text: '$', offset: 525 },
    // Row 3 – Dining room table
    { id: 'r3-item', text: 'Dining room table', offset: 527 },
    { id: 'r3-dmg-pre', text: 'a', offset: 545 },
    { id: 'r3-dmg-post', text: 'is split', offset: 547 },
    { id: 'r3-cost', text: '$ 200', offset: 556 },
    // Row 4 – Set of china
    { id: 'r4-item', text: 'Set of china', offset: 562 },
    { id: 'r4-dmg-pre', text: 'six', offset: 575 },
    { id: 'r4-dmg-post', text: 'were broken', offset: 579 },
    { id: 'r4-cost-pre', text: 'about $', offset: 591 },
    { id: 'r4-cost-post', text: 'in total', offset: 599 },
]);
...
<template>
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick"
        ...
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <div class="mb-3 rounded part-header-box border border-gray-200 bg-[#F1F2EC] px-4 py-3"
            ...
            <div class="shrink-0 px-2 pb-2 sm:px-3" @mouseup="handleContentTextSelect">
                <p class="text-base font-bold text-gray-900 select-text" data-segment-id="secA-title"
                    v-html="getHighlightedSegmentById('secA-title')"></p>
                <p class="text-sm text-gray-700 select-text">
                    <span data-segment-id="secA-inst1" v-html="getHighlightedSegmentById('secA-inst1')"></span>
                </p>
                <p class="text-sm text-gray-700 select-text">
                    <span data-segment-id="secA-inst2" v-html="getHighlightedSegmentById('secA-inst2')"></span>
                    <span class="font-bold" data-segment-id="secA-inst3"
                        v-html="getHighlightedSegmentById('secA-inst3')"></span>
                    <span data-segment-id="secA-inst4" v-html="getHighlightedSegmentById('secA-inst4')"></span>
                </p>
            </div>
                ...
                <div class="p-2 sm:p-3">
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        ...
                        <div class="mb-3  px-4 py-2 ">
                            <span class="text-base font-bold text-gray-900 uppercase tracking-wide select-text"
                                data-segment-id="form-title" v-html="getHighlightedSegmentById('form-title')"></span>
                        </div>

                        <!-- Form Fields -->
                        <div class="space-y-3  px-4 py-3 text-base text-gray-800">
                            <!-- Name -->
                            <div class="flex flex-wrap items-center gap-1">
                                <span class="select-text" data-segment-id="form-name"
                                    v-html="getHighlightedSegmentById('form-name')"></span>
                            </div>

                            <!-- Address – Q1 -->
                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                @mouseenter="hoveredQuestion = 1" @mouseleave="hoveredQuestion = null">
                                <span class="select-text" data-segment-id="form-addr-pre"
                                    v-html="getHighlightedSegmentById('form-addr-pre')"></span>
                                <span id="question-1" class="inline-flex items-center">
                                    <input v-model="answers.q1" type="text" spellcheck="false" autocomplete="off"
                                        class="question-input mx-1 min-w-24 border border-gray-900 px-1.5 py-0.5 text-center text-sm focus:border-black focus:outline-none sm:min-w-32"
                                        placeholder="1" @focus="hoveredQuestion = 1" @blur="hoveredQuestion = null" />
                                </span>
                                <span class="select-text" data-segment-id="form-addr-post"
                                    v-html="getHighlightedSegmentById('form-addr-post')"></span>
                                <button v-show="hoveredQuestion === 1 || isQuestionFlagged(1)"
                                    @click.stop="toggleFlag(1)"
                                    class="bookmark-btn ml-2 flex h-6 w-6 shrink-0 items-center justify-center rounded border transition-all"
                            ...
                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                ...
                                <span class="select-text" data-segment-id="form-agent-pre"
                                    v-html="getHighlightedSegmentById('form-agent-pre')"></span>
                                <span id="question-2" class="inline-flex items-center">
                                    <input v-model="answers.q2" type="text" spellcheck="false" autocomplete="off"
                                        class="question-input mx-1 min-w-24 border border-gray-900 px-1.5 py-0.5 text-center text-sm focus:border-black focus:outline-none sm:min-w-32"
                                        placeholder="2" @focus="hoveredQuestion = 2" @blur="hoveredQuestion = null" />
                                </span>
                            ...
                            <!-- Place of origin -->
                            <div class="flex flex-wrap items-center gap-1">
                                <span class="select-text" data-segment-id="form-origin"
                                    v-html="getHighlightedSegmentById('form-origin')"></span>
                            </div>

                            <!-- Date of arrival – Q3 -->
                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                @mouseenter="hoveredQuestion = 3" @mouseleave="hoveredQuestion = null">
                                <span class="select-text" data-segment-id="form-date-pre"
                                    v-html="getHighlightedSegmentById('form-date-pre')"></span>
                                <span id="question-3" class="inline-flex items-center">
                                    <input v-model="answers.q3" type="text" spellcheck="false" autocomplete="off"
                                        class="question-input mx-1 min-w-32 border border-gray-900 px-1.5 py-0.5 text-center text-sm focus:border-black focus:outline-none sm:min-w-40"
                                        placeholder="3" @focus="hoveredQuestion = 3" @blur="hoveredQuestion = null" />
                                </span>
                            ...
                            <!-- Reference number -->
                            <div class="flex flex-wrap items-center gap-1">
                                <span class="select-text" data-segment-id="form-ref"
                                    v-html="getHighlightedSegmentById('form-ref')"></span>
                            </div>
                        </div>

                        <!-- ── SECTION B: Questions 4–10 ── -->
                        <div class="mt-6 shrink-0" @mouseup="handleContentTextSelect">
                            <p class="text-base font-bold text-gray-900 select-text" data-segment-id="secB-title"
                                v-html="getHighlightedSegmentById('secB-title')"></p>
                            <p class="text-sm text-gray-700 select-text">
                                <span data-segment-id="secB-inst1"
                                    v-html="getHighlightedSegmentById('secB-inst1')"></span>
                                <span class="font-bold" data-segment-id="secB-inst2"
                                    v-html="getHighlightedSegmentById('secB-inst2')"></span>
                                <span data-segment-id="secB-inst3"
                                    v-html="getHighlightedSegmentById('secB-inst3')"></span>
                            </p>
                        </div>
                            ...
                            <table class="w-full border-collapse border border-gray-300 text-sm text-gray-800">
                                <thead>
                                    <tr class="bg-gray-100">
                                        <th class="border border-gray-300 px-3 py-2 text-left font-bold">
                                            <span data-segment-id="th-item"
                                                v-html="getHighlightedSegmentById('th-item')"></span>
                                        </th>
                                        <th class="border border-gray-300 px-3 py-2 text-left font-bold">
                                            <span data-segment-id="th-damage"
                                                v-html="getHighlightedSegmentById('th-damage')"></span>
                                        </th>
                                        <th class="border border-gray-300 px-3 py-2 text-left font-bold">
                                            <span data-segment-id="th-cost"
                                                v-html="getHighlightedSegmentById('th-cost')"></span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="border border-gray-300 px-3 py-2 align-top">
                                            <span data-segment-id="r1-item"
                                                v-html="getHighlightedSegmentById('r1-item')"></span>
                                        </td>
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                @mouseenter="hoveredQuestion = 4" @mouseleave="hoveredQuestion = null">
                                                <span class="select-text" data-segment-id="r1-dmg-pre"
                                                    v-html="getHighlightedSegmentById('r1-dmg-pre')"></span>
                                                ...
                                                <span class="select-text" data-segment-id="r1-dmg-post"
                                                    v-html="getHighlightedSegmentById('r1-dmg-post')"></span>
                                                <!-- Fixed width container for bookmark button -->
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(4)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 4 || isQuestionFlagged(4)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(4) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                        ...
                                        <td class="border border-gray-300 px-3 py-2">
                                            <span data-segment-id="r1-cost"
                                                v-html="getHighlightedSegmentById('r1-cost')"></span>
                                        </td>
                                    </tr>

                                    <!-- Row 2: Cabinet – Q5, Q6, Q7 -->
                                    <tr>
                                        <td class="border border-gray-300 px-3 py-2 align-top">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                @mouseenter="hoveredQuestion = 5" @mouseleave="hoveredQuestion = null">
                                                <span class="select-text" data-segment-id="r2-item-pre"
                                                    v-html="getHighlightedSegmentById('r2-item-pre')"></span>
                                                ...
                                                <span class="select-text" data-segment-id="r2-item-post"
                                                    v-html="getHighlightedSegmentById('r2-item-post')"></span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(5)"
                                                        ...
                                                        :class="[
                                                            ...
                                                            isQuestionFlagged(5) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                        ...
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                ...
                                                <span class="select-text" data-segment-id="r2-dmg-pre"
                                                    v-html="getHighlightedSegmentById('r2-dmg-pre')"></span>
                                                ...
                                                <span class="select-text" data-segment-id="r2-dmg-post"
                                                    v-html="getHighlightedSegmentById('r2-dmg-post')"></span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(6)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 6 || isQuestionFlagged(6)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(6) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                        ...
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                ...
                                                <span class="select-text" data-segment-id="r2-cost-pre"
                                                    v-html="getHighlightedSegmentById('r2-cost-pre')"></span>
                                                <span id="question-7" class="inline-flex items-center">
                                                    <input v-model="answers.q7" type="text" spellcheck="false"
                                                        autocomplete="off"
                                                        class="question-input mx-1 min-w-11 border border-gray-900 px-1.5 py-0.5 text-center text-sm focus:border-black focus:outline-none sm:min-w-15"
                                                        placeholder="7" @focus="hoveredQuestion = 7"
                                                        @blur="hoveredQuestion = null" />
                                                </span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(7)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 7 || isQuestionFlagged(7)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(7) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                    ...
                                    <!-- Row 3: Dining room table – Q8 -->
                                    <tr>
                                        <td class="border border-gray-300 px-3 py-2 align-top">
                                            <span data-segment-id="r3-item"
                                                v-html="getHighlightedSegmentById('r3-item')"></span>
                                        </td>
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                @mouseenter="hoveredQuestion = 8" @mouseleave="hoveredQuestion = null">
                                                <span class="select-text" data-segment-id="r3-dmg-pre"
                                                    v-html="getHighlightedSegmentById('r3-dmg-pre')"></span>
                                                <span id="question-8" class="inline-flex items-center">
                                                    <input v-model="answers.q8" type="text" spellcheck="false"
                                                        autocomplete="off"
                                                        class="question-input mx-1 min-w-11 border border-gray-900 px-1.5 py-0.5 text-center text-sm focus:border-black focus:outline-none sm:min-w-15"
                                                        placeholder="8" @focus="hoveredQuestion = 8"
                                                        @blur="hoveredQuestion = null" />
                                                </span>
                                                <span class="select-text" data-segment-id="r3-dmg-post"
                                                    v-html="getHighlightedSegmentById('r3-dmg-post')"></span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(8)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 8 || isQuestionFlagged(8)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(8) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                        ...
                                        <td class="border border-gray-300 px-3 py-2">
                                            <span data-segment-id="r3-cost"
                                                v-html="getHighlightedSegmentById('r3-cost')"></span>
                                        </td>
                                    </tr>

                                    <!-- Row 4: Set of china – Q9, Q10 -->
                                    <tr>
                                        <td class="border border-gray-300 px-3 py-2 align-top">
                                            <span data-segment-id="r4-item"
                                                v-html="getHighlightedSegmentById('r4-item')"></span>
                                        </td>
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                @mouseenter="hoveredQuestion = 9" @mouseleave="hoveredQuestion = null">
                                                <span class="select-text" data-segment-id="r4-dmg-pre"
                                                    v-html="getHighlightedSegmentById('r4-dmg-pre')"></span>
                                                ...
                                                <span class="select-text" data-segment-id="r4-dmg-post"
                                                    v-html="getHighlightedSegmentById('r4-dmg-post')"></span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(9)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 9 || isQuestionFlagged(9)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(9) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
                                        ...
                                        <td class="border border-gray-300 px-3 py-2">
                                            <div class="question-row flex flex-wrap items-center gap-0.5"
                                                ...
                                                <span class="select-text" data-segment-id="r4-cost-pre"
                                                    v-html="getHighlightedSegmentById('r4-cost-pre')"></span>
                                                ...
                                                <span class="select-text" data-segment-id="r4-cost-post"
                                                    v-html="getHighlightedSegmentById('r4-cost-post')"></span>
                                                <div
                                                    class="bookmark-container ml-2 inline-flex h-6 w-6 shrink-0 items-center justify-center">
                                                    <button @click.stop="toggleFlag(10)"
                                                        class="bookmark-btn flex h-6 w-6 items-center justify-center rounded border transition-all"
                                                        :class="[
                                                            (hoveredQuestion === 10 || isQuestionFlagged(10)) ? 'opacity-100' : 'opacity-0',
                                                            isQuestionFlagged(10) ? 'border-gray-400 bg-transparent text-red-500' : 'border-gray-300 bg-transparent text-gray-400 hover:border-gray-400 hover:text-gray-600'
