...
const questionText =
    ref(`The charts below show the percentage of monthly household income spent on various items by two different groups in one European country.
...
<template>
    <div class="min-h-screen overflow-y-auto pb-20 sm:pb-24 md:pb-32">
        ...
        <div class="mx-4 mt-2 part-header-box   border-gray-400 px-4 py-3 sm:mx-6 lg:mx-8">
                ...
                <div class="max-h-screen overflow-y-auto p-4 sm:p-6">
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        ...
                        <div class="p-2 text-center sm:p-4">
                            <img
                                src="/images/writing/IELTS003.1.jpg"
                                alt="Expenditure charts by household income groups"
                                class="mx-auto h-full shadow-md"
                            />
                        </div>
                        <div class="p-2 text-center sm:p-4">
                            <img
                                src="/images/writing/IELTS003.2.jpg"
                                alt="Expenditure charts by household income groups"
                                class="mx-auto h-full shadow-md"
                            />
                        </div>
