...
const questionText = ref(`Modern technology has made it easier for individuals to download copyrighted music and books from the internet for no charge.
...
<template>
    <div class="min-h-screen overflow-y-auto pb-20 sm:pb-24 md:pb-32">
        ...
        <div class="mx-2 mt-2 part-header-box    border-gray-400 bpx-4 py-3 sm:mx-6 lg:mx-8">
