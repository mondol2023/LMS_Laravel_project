...
// Each offset = previous offset + previous text length + gap (5-10)
const textSegments = ref([
    // Part header
    { id: 'part1-title', text: 'Part 1', offset: 0 },                                      // len=6, ends=6
    { id: 'part1-desc', text: 'Listen and answer questions 1–10.', offset: 15 },           // len=34, ends=49
    // Instruction section
    { id: 0, text: 'Questions 1–7', offset: 55 },                                          // len=13, ends=68
    { id: 1, text: 'Complete the notes below. Write ', offset: 75 },                       // len=32, ends=107
    { id: 2, text: 'ONE WORD ONLY', offset: 115 },                                         // len=13, ends=128
    // Main title
    { id: 3, text: 'Taking children to the Lionbridge Music Festival', offset: 140 },     // len=48, ends=188
    // Planning
    { id: 4, text: 'Planning', offset: 195 },                                              // len=8, ends=203
    { id: 5, text: "Pack children's clothes that are easy to", offset: 210 },              // len=40, ends=250
    { id: 6, text: 'Pack extra', offset: 260 },                                            // len=10, ends=270
    { id: 7, text: 'in case of wet weather.', offset: 280 },                               // len=23, ends=303
    { id: 8, text: 'Take a picnic to eat in the', offset: 315 },                           // len=27, ends=342
    { id: 9, text: 'on the way.', offset: 350 },                                           // len=11, ends=361
    // Camping area
    { id: 10, text: 'Camping area', offset: 370 },                                         // len=12, ends=382
    { id: 11, text: 'There are two fields just for families.', offset: 390 },              // len=39, ends=429
    { id: 12, text: 'There are lots of toilet facilities.', offset: 440 },                 // len=36, ends=476
    { id: 13, text: 'No', offset: 485 },                                                   // len=2, ends=487
    { id: 14, text: 'are allowed in the camping area.', offset: 495 },                     // len=32, ends=527
    { id: 15, text: "Write your phone number on your child's", offset: 540 },              // len=39, ends=579
    // Food and drink
    { id: 16, text: 'Food and drink', offset: 590 },                                       // len=14, ends=604
    { id: 17, text: 'Try the food stall that specializes in', offset: 615 },               // len=38, ends=653
    { id: 18, text: 'food.', offset: 665 },                                                // len=5, ends=670
    { id: 19, text: 'Bring a', offset: 680 },                                              // len=7, ends=687
    { id: 20, text: 'that you can reuse.', offset: 695 },                                  // len=19, ends=714
    // Questions 8–10
    { id: 21, text: 'Questions 8–10', offset: 725 },                                       // len=14, ends=739
    { id: 22, text: 'Complete the table below. Write ', offset: 750 },                     // len=32, ends=782
    { id: 23, text: 'ONE WORD ONLY for each answer.', offset: 790 },                        // len=13, ends=803
    // Table header
    { id: 24, text: 'Family activities', offset: 830 },                                    // len=17, ends=832
    { id: 25, text: 'Notes', offset: 860 },                                                // len=5, ends=850
    // Drumming
    { id: 26, text: 'Drumming', offset: 875 },                                             // len=8, ends=868
    { id: 27, text: 'Three sessions a day - try the session in the', offset: 890 },       // len=45, ends=925
    { id: 28, text: 'The teacher is from Zambia.', offset: 950 },                          // len=27, ends=962
    // Circus
    { id: 29, text: 'A circus', offset: 990 },                                             // len=8, ends=983
    { id: 30, text: 'Arrive early for children to meet the performers.', offset: 1010 },   // len=49, ends=1044
    { id: 31, text: 'To find it, look for the red and yellow', offset: 1070 },             // len=40, ends=1095
    // Final activity
    { id: 32, text: 'Every morning - for adults and children', offset: 1125 },             // len=39, ends=1149
    { id: 33, text: 'Located near the lake.', offset: 1175 },                              // len=22, ends=1182
]);
...
<template>
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick" class="px-4 py-2 pb-24 select-text sm:px-6">
        ...
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <!-- Instructions Section Q1-7 -->


            <!-- Main Title -->
            <div class="px-2 sm:px-3 mb-1 ">
                <h2
                    ...
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <ul class="space-y-2 text-base leading-relaxed text-gray-800 list-disc pl-5">
                                        ...
                                        <div class="flex flex-wrap items-center gap-0.5">
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    :class="isQuestionFlagged(1) ? 'border-gray-400 bg-transparent text-red-500'
                                    ...
                                    <!-- Q2: Pack extra _____ in case of wet weather -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                                    ...
                                    <!-- Q3: Take a picnic to eat in the _____ on the way -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                            ...
                            <div class="border-t pt-3">
                                ...
                                <ul class="space-y-2 text-base leading-relaxed text-gray-800 list-disc pl-5">
                                    ...
                                    <!-- Static bullet: There are two fields just for families -->
                                    <li>
                                        <span data-segment-id="11" v-html="getHighlightedSegmentById(11)"></span>
                                    </li>

                                    <!-- Static bullet: There are lots of toilet facilities -->
                                    <li>
                                        <span data-segment-id="12" v-html="getHighlightedSegmentById(12)"></span>
                                    </li>

                                    <!-- Q4: No _____ are allowed in the camping area -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                                    ...
                                    <!-- Q5: Write your phone number on your child's _____ -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                                            <span data-segment-id="15" v-html="getHighlightedSegmentById(15)"></span>
                                            <span
                                                id="question-5"
                                                class="group relative inline-flex items-center gap-0.5"
                            ...
                            <div class="border-t pt-3">
                                ...
                                <ul class="space-y-2 text-base leading-relaxed text-gray-800 list-disc pl-5">
                                    ...
                                    <!-- Q6: Try the food stall that specializes in _____ food -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    @blur="hoveredQuestion = null"
                                                />
                                                 <span data-segment-id="18" v-html="getHighlightedSegmentById(18)"></span>
                                    ...
                                    <!-- Q7: Bring a _____ that you can reuse -->
                                    <li>
                                        <div class="flex flex-wrap items-center gap-0.5">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    @blur="hoveredQuestion = null"
                                                />
                                                 <span data-segment-id="20" v-html="getHighlightedSegmentById(20)"></span>
                            ...
                            <div class="border-t pt-4">
                                ...
                                <div class="shrink-0 pb-2" @mouseup="handleContentTextSelect">
                                    ...
                                    <p class="text-sm text-gray-700 select-text">
                                        ...
                                        <span class="font-bold" data-segment-id="23" v-html="getHighlightedSegmentById(23)"></span>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full border-collapse border border-gray-400 text-base">
                                        <thead>
                                            <tr class="bg-gray-100">
                                                <th class="border border-gray-400 px-3 py-2 text-left font-bold text-gray-900 w-1/3"
                                                    data-segment-id="24"
                                                    v-html="getHighlightedSegmentById(24)">
                                                </th>
                                                <th class="border border-gray-400 px-3 py-2 text-left font-bold text-gray-900"
                                                    data-segment-id="25"
                                        ...
                                        <tbody>
                                            <!-- Drumming row: Q8 -->
                                            <tr>
                                                <td class="border border-gray-400 px-3 py-2 font-semibold text-gray-900 align-top"
                                                    data-segment-id="26"
                                                    ...
                                                    <div class="flex flex-wrap items-center gap-0.5 mb-1">
                                                        ...
                                                        >
                                                            <input
                                                                ...
                                                                @blur="hoveredQuestion = null"
                                                            />
                                                            <span data-segment-id="28" v-html="getHighlightedSegmentById(28)"></span>
                                                            <button
                                            ...
                                            <tr>
                                                ...
                                                <td class="border border-gray-400 px-3 py-2 text-gray-800">
                                                    <div class="mb-1">
                                                        <span data-segment-id="30" v-html="getHighlightedSegmentById(30)"></span>
                                                    </div>
                                                    <div class="flex flex-wrap items-center gap-0.5">
                                            ...
                                            <!-- Final activity row: Q10 (activity name is the answer) -->
                                            <tr>
                                                <td class="border border-gray-400 px-3 py-2 font-semibold text-gray-900 align-top">
                                                    <span
                                                        id="question-10"
                                                ...
                                                <td class="border border-gray-400 px-3 py-2 text-gray-800">
                                                    <div class="mb-1">
                                                        <span data-segment-id="32" v-html="getHighlightedSegmentById(32)"></span>
                                                    </div>
                                                    <div>
