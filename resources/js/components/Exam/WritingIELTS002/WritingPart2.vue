...
const questionText = ref(`Music is played in every society and culture in the world today. Some people think that music brings only benefits to the individuals and societies. Others, however, think that music can have a negative influence on both.
...
<template>
    <div class="min-h-screen overflow-y-auto pb-20 sm:pb-24 md:pb-32">
        ...
        <div class="mx-4 mt-2 border-gray-400 part-header-box px-4 py-3 sm:mx-6 lg:mx-8">
            ...
            <div ref="containerRef" class="relative flex flex-col gap-0 lg:flex-row" :class="{ 'select-none': isResizing }">
                ...
                >
                    <div ref="questionTextRef" @mouseup="handleQuestionTextSelect" @click="handleContentClick" class="noted-content space-y-3 select-text sm:space-y-4">
                        <div class="whitespace-pre-wrap font-bold text-black" :style="textStyle" v-html="highlightedQuestionText"></div>
                    </div>
                </div>
