...
<b></b>
From the beginning, Tench stood out as different from the other convicts. During his initial time in Australia, he quickly rose in his rank, and was given extra power and responsibility over the convicted crew members. However, he was also still very different from the upper-class rulers who came to rule over the crew. He showed humanity towards the convicted workers. He didn’t want to treat them as commoncriminals,butastrainedmilitarymen.UnderTench’sauthority,hereleasedtheconvicts’chains whichwereusedtocontrolthemduringthevoyage.TenchalsoshowedmercytowardstheAboriginal

people. 
<b></b>Governor Philip often pursued violent solutions to conflicts with the Aboriginal peoples. Tench disagreed strongly with this method. At one point, he was unable to follow the order given by the Governor Philip to punish the ten Aboriginals.
<b></b>
...
const textSegments = ref([
    // Part 1 header text segments (UNCHANGED)
    { id: 'part1-title', text: 'Part 1', offset: 5000 },
    { id: 'part1-desc', text: 'Read the text and answer questions 1–13.', offset: 5007 },
    { id: 'part1-passage-title', text: 'The Extraordinary Watkin Tench', offset: 5048 },

    // Single passage text segment
    { id: 'passage', text: passageText, offset: 0 },

    // Questions 1-6
    { id: 'q1-6-title', text: 'Questions 1-6', offset: 5086 },

    { id: 'q1-6-inst1', text: 'Do the following statements agree with the information given in Reading Passage 1?', offset: 5100 },
    { id: 'q1-6-inst2', text: 'In boxes 1-6 on your answer sheet, write', offset: 5175 },

    { id: 'q1-6-true', text: 'TRUE', offset: 5215 },
    { id: 'q1-6-true-desc', text: 'if the statement is true', offset: 5220 },

    { id: 'q1-6-false', text: 'FALSE', offset: 5250 },
    { id: 'q1-6-false-desc', text: 'if the statement is false', offset: 5256 },

    { id: 'q1-6-notgiven', text: 'NOT GIVEN', offset: 5285 },
    { id: 'q1-6-notgiven-desc', text: 'if the information is not given in the passage', offset: 5296 },

    { id: 'q1-num', text: '1.', offset: 5355 },
    { id: 'q1-text', text: 'There was a great deal of information available about the life of Tench before he arrived in Australia.', offset: 5358 },

    { id: 'q2-num', text: '2.', offset: 5470 },
    { id: 'q2-text', text: 'Tench drew pictures to illustrate different places during the voyage.', offset: 5473 },

    { id: 'q3-num', text: '3.', offset: 5555 },
    { id: 'q3-text', text: 'Other military personnel in New South Wales did not treat convicts in the same way as Tench did.', offset: 5558 },

    { id: 'q4-num', text: '4.', offset: 5665 },
    { id: 'q4-text', text: 'Tench’s view towards the Aboriginals remained unchanged during his time in Australia.', offset: 5668 },

    { id: 'q5-num', text: '5.', offset: 5775 },
    { id: 'q5-text', text: 'An Aboriginal gave him gifts of food at the first time they met.', offset: 5778 },

    { id: 'q6-num', text: '6.', offset: 5865 },
    { id: 'q6-text', text: 'The convicts had a good knowledge of Australian geography.', offset: 5868 },


    // Questions 7-13
    { id: 'q7-13-title', text: 'Questions 7-13', offset: 5950 },

    { id: 'q7-13-inst1', text: 'Answer the questions below.', offset: 5965 },

    { id: 'q7-13-inst2', text: 'Choose NO MORE THAN TWO WORDS AND/OR A NUMBER from the passage for each answer.', offset: 5995 },

    { id: 'q7-num', text: '7.', offset: 6075 },
    { id: 'q7-text', text: 'What could be a concrete proof of Tench’s good education?', offset: 6078 },

    { id: 'q8-num', text: '8.', offset: 6155 },
    { id: 'q8-text', text: 'How many years did Tench sign the contract to the First Fleet?', offset: 6158 },

    { id: 'q9-num', text: '9.', offset: 6235 },
    { id: 'q9-text', text: 'What was used to control convicts during the voyage?', offset: 6238 },

    { id: 'q10-num', text: '10.', offset: 6310 },
    { id: 'q10-text', text: 'Who gave the order to punish the Aboriginals?', offset: 6314 },

    { id: 'q11-num', text: '11.', offset: 6385 },
    { id: 'q11-text', text: 'When did the name of Hawkesbury River come into being?', offset: 6390 },

    { id: 'q12-num', text: '12.', offset: 6465 },
    { id: 'q12-text', text: 'Where did the escaped convicts plan to go?', offset: 6469 },

    { id: 'q13-num', text: '13.', offset: 6540 },
    { id: 'q13-text', text: 'In which place did Tench feel unaccustomed?', offset: 6544 },
]);
                        ...
                        <div class="space-y-6 text-sm leading-relaxed select-text">
                            <div class="p-4">
                                <div class="text-justify leading-relaxed text-gray-700">
                                    <span class="text-lg text-gray-700" v-html="getHighlightedSegmentById('passage')"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="answer-panel flex max-h-screen flex-col overflow-y-auto" :style="{ '--panel-width': `${leftPanelWidth}%` }">
                    <div class="flex-1 overflow-y-auto pb-32">
                        <div class="space-y-8 p-4" :style="contentZoom">
                                ...
                                <div class="mb-6">
                                    <div class="mb-4 flex items-center space-x-2">
                                        <h3 class="text-lg font-bold text-gray-900">
                                            <span class="text-gray-700" v-html="getHighlightedSegmentById('q1-6-title')"></span>
                                        </h3>
                                    </div>
                                    <p class="mb-2 text-sm leading-relaxed text-gray-700">
                                        <span v-html="getHighlightedSegmentById('q1-6-inst1')"></span>
                                    </p>
                                    <p class="mb-4 text-sm leading-relaxed text-gray-700">
                                        <span v-html="getHighlightedSegmentById('q1-6-inst2')"></span>
                                    </p>
                                    <p class="mb-4 text-sm leading-relaxed text-gray-700">
                                        <span class="font-bold mx-0.5 text-gray-900" v-html="getHighlightedSegmentById('q1-6-true')"></span>
                                        <span class="text-gray-700" v-html="getHighlightedSegmentById('q1-6-true-desc')"></span><br/>
                                        <span class="font-bold mx-0.5 text-gray-900" v-html="getHighlightedSegmentById('q1-6-false')"></span>
                                        <span class="text-gray-700" v-html="getHighlightedSegmentById('q1-6-false-desc')"></span><br/>
                                        <span class="font-bold mx-0.5 text-gray-900" v-html="getHighlightedSegmentById('q1-6-notgiven')"></span>
                                        <span class="text-gray-700" v-html="getHighlightedSegmentById('q1-6-notgiven-desc')"></span>
                                    </p>
                                </div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q1-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q1-text')"></span>
                                        </div>
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q2-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q2-text')"></span>
                                        </div>
                                        <div class="ml-6 space-y-2 select-none">
                                            <label class="flex cursor-pointer items-center gap-2">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q3-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q3-text')"></span>
                                        </div>
                                        <div class="ml-6 space-y-2 select-none">
                                            <label class="flex cursor-pointer items-center gap-2">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q4-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q4-text')"></span>
                                        </div>
                                        <div class="ml-6 space-y-2 select-none">
                                            <label class="flex cursor-pointer items-center gap-2">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q5-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q5-text')"></span>
                                        </div>
                                        <div class="ml-6 space-y-2 select-none">
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q5" value="TRUE" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">TRUE</span>
                                            </label>
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q5" value="FALSE" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">FALSE</span>
                                            </label>
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q5" value="NOT GIVEN" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">NOT GIVEN</span>
                                            </label>
                                        </div>
                                        <button
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900" v-html="getHighlightedSegmentById('q6-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q6-text')"></span>
                                        </div>
                                        <div class="ml-6 space-y-2 select-none">
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q6" value="TRUE" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">TRUE</span>
                                            </label>
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q6" value="FALSE" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">FALSE</span>
                                            </label>
                                            <label class="flex cursor-pointer items-center gap-2">
                                                <input type="radio" v-model="answers.q6" value="NOT GIVEN" class="h-4 w-4 border-gray-300 text-black focus:ring-black" />
                                                <span class="text-base text-gray-900">NOT GIVEN</span>
                                            </label>
                                        </div>
                                        <button
                            ...
                            <!-- Questions 7-13 (Input boxes) -->
                            <div class="p-6">
                                <div class="mb-6">
                                    <div class="mb-4 flex items-center space-x-2">
                                        <h3 class="text-lg font-bold text-gray-900">
                                            <span class="text-gray-700" v-html="getHighlightedSegmentById('q7-13-title')"></span>
                                        </h3>
                                    </div>
                                    <p class="mb-2 text-sm text-gray-700">
                                        <span v-html="getHighlightedSegmentById('q7-13-inst1')"></span>
                                    </p>
                                    <p class="mb-4 text-sm text-gray-700">
                                        <span v-html="getHighlightedSegmentById('q7-13-inst2')"></span>
                                    </p>
                                </div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q7-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q7-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q7"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q8-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q8-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q8"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q9-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q9-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q9"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q10-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q10-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q10"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q11-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q11-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q11"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q12-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q12-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q12"
                                    ...
                                    >
                                        <div class="mb-2 flex items-start gap-2">
                                            <span class="text-base font-bold text-gray-900 whitespace-nowrap" v-html="getHighlightedSegmentById('q13-num')"></span>
                                            <span class="text-base text-gray-900" v-html="getHighlightedSegmentById('q13-text')"></span>
                                        </div>
                                        <div class="ml-6">
                                            <input
                                                v-model="answers.q13"
