...
const rawTextSegments = [
    { id: 'part1-title', text: 'Part 1'},
    { id: 'part1-desc', text: 'Listen and answer questions 1–10.'},
    { id: 0, text: 'Questions 1-10' },
    { id: 1, text: 'Complete the form below.' },
    { id: 2, text: 'Write NO MORE THAN TWO WORDS AND/OR A NUMBER for each answer.' },
    { id: 3, text: 'Phone interview' },
    { id: 6, text: 'Position applying for:' },
    { id: 7, text: 'lifeguard' },
    { id: 8, text: 'Street Address:' },
    { id: 9, text: '45' },
    { id: 10, text: 'Court' },
    { id: 11, text: 'Contact phone number:' },
    { id: 12, text: 'Current part-time job:' },
    { id: 13, text: 'Previous job at Ridgemont High School:' },
    { id: 14, text: 'Additional relevant work experience:' },
    { id: 15, text: 'Relevant skills/qualifications:' },
    { id: 16, text: 'CPR certification &' },
    { id: 17, text: 'CPR certification expiration date:' },
    { id: 18, text: 'Preferred weekly shift:' },
    { id: 19, text: 'Time available to start work:' },
    { id: 20, text: 'Advertisement source:' },
];
...
<template>
    <div ref="contentTextRef" @mouseup="handleContentTextSelect" @click="handleContentClick" class="px-4 py-2 pb-24 select-text sm:px-6">
        <div class="flex min-h-screen w-full flex-col" :style="contentZoom">
            ...
            <!-- Header -->
            <div class="flex-shrink-0 p-2 sm:p-2" @mouseup="handleContentTextSelect">
                <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex space-x-2">

                        <div>
                           <p class="text-sm font-semibold text-gray-900 select-text" data-segment-id="1" v-html="getHighlightedSegmentById(1)"></p>
            ...
            <div class="flex-1 overflow-y-auto pb-24">
                <div class="p-2 sm:p-3">
                    <div @mouseup="handleContentTextSelect" class="p-3 select-text sm:p-4">
                        <h3 class="mb-4  text-lg font-bold text-gray-900 select-text" data-segment-id="3" v-html="getHighlightedSegmentById(3)"></h3>

                        <div class="space-y-3 border border-gray-300 p-4">

                            <!-- Position applying for -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="6" v-html="getHighlightedSegmentById(6)"></span>
                                <span class="text-gray-800 select-text" data-segment-id="7" v-html="getHighlightedSegmentById(7)"></span>
                            </div>

                            <!-- Street Address - Q1 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="8" v-html="getHighlightedSegmentById(8)"></span>
                                <span class="text-gray-800 select-text" data-segment-id="9" v-html="getHighlightedSegmentById(9)"></span>
                                <span
                                    id="question-1"
                                ...
                                >
                                    <input
                                        ...
                                        spellcheck="false"
                                        autocomplete="off"
                                        class="question-input mx-1 min-w-[100px] border border-gray-900 px-2 py-1 text-center text-base focus:border-black focus:outline-none"
                                        placeholder="1"
                                        @focus="hoveredQuestion = 1"
                                        @blur="hoveredQuestion = null"
                                    />
                                    <span class="text-gray-800 select-text" data-segment-id="10" v-html="getHighlightedSegmentById(10)"></span>
                                    <button
                            ...
                            <!-- Contact phone number - Q2 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="11" v-html="getHighlightedSegmentById(11)"></span>
                                <span
                                    id="question-2"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    <input
                                        ...
                                        spellcheck="false"
                                        autocomplete="off"
                                        class="question-input mx-1 min-w-[120px] border border-gray-900 px-2 py-1 text-center text-base focus:border-black focus:outline-none"
                                        placeholder="2"
                            ...
                            <!-- Current part-time job - Q3 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="12" v-html="getHighlightedSegmentById(12)"></span>
                                <span
                                    id="question-3"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    <input
                                        ...
                                        spellcheck="false"
                                        autocomplete="off"
                                        class="question-input mx-1 min-w-[150px] border border-gray-900 px-2 py-1 text-center text-base focus:border-black focus:outline-none"
                                        placeholder="3"
                            ...
                            <!-- Previous job at Ridgemont High School - Q4 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="13" v-html="getHighlightedSegmentById(13)"></span>
                                <span
                                    id="question-4"
                                    class="group relative inline-flex items-center gap-0.5"
                            ...
                            <!-- Additional relevant work experience - Q5 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="14" v-html="getHighlightedSegmentById(14)"></span>
                                <span
                                    id="question-5"
                                    class="group relative inline-flex items-center gap-0.5"
                                ...
                                >
                                    <input
                                        ...
                                        spellcheck="false"
                                        autocomplete="off"
                                        class="question-input mx-1 min-w-[180px] border border-gray-900 px-2 py-1 text-center text-base focus:border-black focus:outline-none"
                                        placeholder="5"
                            ...
                            <!-- Relevant skills/qualifications: CPR certification & - Q6 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="15" v-html="getHighlightedSegmentById(15)"></span>
                            ...
                            <!-- CPR certification expiration date - Q7 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="17" v-html="getHighlightedSegmentById(17)"></span>
                                <span
                                    id="question-7"
                                    class="group relative inline-flex items-center gap-0.5"
                            ...
                            <!-- Preferred weekly shift - Q8 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="18" v-html="getHighlightedSegmentById(18)"></span>
                                <span
                                    id="question-8"
                                    class="group relative inline-flex items-center gap-0.5"
                            ...
                            <!-- Time available to start work - Q9 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="19" v-html="getHighlightedSegmentById(19)"></span>
                                <span
                                    id="question-9"
                                    class="group relative inline-flex items-center gap-0.5"
                            ...
                            <!-- Advertisement source - Q10 -->
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="min-w-[180px] font-semibold text-gray-900 select-text" data-segment-id="20" v-html="getHighlightedSegmentById(20)"></span>
                                <span
                                    id="question-10"
                                    class="group relative inline-flex items-center gap-0.5"
