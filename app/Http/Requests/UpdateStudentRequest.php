...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'roll_number' => ['required', 'string', 'max:255', Rule::unique('users', 'roll_number')->ignore($studentId)],
            'email' => ['required', 'email', 'max:255', Rule::unique('users', 'email')->ignore($studentId)],
            'phone' => ['nullable', 'string', 'max:20', Rule::unique('users', 'phone')->ignore($studentId)],
